CREATE TABLE [Prototype].[ForecastingBudgetTracking_Import] (
...
GO
GRANT UPDATE
    ON OBJECT::[Prototype].[ForecastingBudgetTracking_Import] TO [VitaliiV]
    AS [conord];


GO
GRANT UPDATE
    ON OBJECT::[Prototype].[ForecastingBudgetTracking_Import] TO [SamW]
    AS [conord];
