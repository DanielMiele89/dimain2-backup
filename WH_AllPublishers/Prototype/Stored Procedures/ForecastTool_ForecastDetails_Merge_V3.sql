...
******************************************************************************/
CREATE PROCEDURE [Prototype].[ForecastTool_ForecastDetails_Merge_V3]
--WITH EXECUTE AS 'Rory'
AS
	BEGIN

			MERGE [WH_AllPublishers].[Prototype].[ForecastingBudgetTracking] target			-- Destination table
			USING [WH_AllPublishers].[Prototype].[ForecastingBudgetTracking_Import] source	-- Source table
