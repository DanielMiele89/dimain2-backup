...
CREATE PROCEDURE [Prototype].[ForecastTool_ForecastDetails_Import_V3] (				@PublisherID VARCHAR(50)
																			,	@BrandID VARCHAR(50)
...
AS
	...
	DECLARE	@RetailerName VARCHAR(50)
		...
		INSERT INTO [Prototype].[ForecastingBudgetTracking_Import] (	PublisherID
															,	BrandID
															,	RetailerName
															,	PublisherName
															,	Segment
