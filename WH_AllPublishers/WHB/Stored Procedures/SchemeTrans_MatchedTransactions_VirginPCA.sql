...
CREATE PROCEDURE [WHB].[SchemeTrans_MatchedTransactions_VirginPCA]
AS
BEGIN
	...
	*******************************************************************************************************************************************/
		...
		FROM [WH_VirginPCA].[Inbound].[MatchedTransactions] mt
		INNER JOIN [WH_VirginPCA].[WHB].[Inbound_Files] ibf
