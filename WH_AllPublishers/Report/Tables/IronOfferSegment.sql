CREATE TABLE [Report].[IronOfferSegment] (
...
CREATE NONCLUSTERED INDEX [NCIX_IronOfferSegment]
    ON [Report].[IronOfferSegment]([OfferTypeForReports] ASC);


GO
CREATE NONCLUSTERED INDEX [NCIX2_IronOfferSegment]
    ON [Report].[IronOfferSegment]([RetailerID] ASC, [PublisherID] ASC, [OfferStartDate] ASC, [OfferEndDate] ASC);
