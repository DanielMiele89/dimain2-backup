...
******************************************************************************/
CREATE PROCEDURE [Report].[OfferReport_Refresh_PublisherExclude] 
...
BEGIN
    ...
    TRUNCATE TABLE [Report].[OfferReport_PublisherExclude]

    INSERT INTO [Report].[OfferReport_PublisherExclude]
    SELECT	PartnerID
		,	ClubID
		,	StartDate
		,	ISNULL(EndDate, '2050-01-01') EndDate
    FROM [Warehouse].[Relational].[nFI_Partner_Deals] np
    INNER JOIN [Warehouse].[Relational].[nFIPartnerDeals_Relationship_V2] nr
