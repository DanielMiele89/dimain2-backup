...
WHERE BrandShopper = 1
	  ...
	  AND Transactions >= 55
GROUP BY F.CINID
If Object_ID('WH_Visa.Selections.MOR111_PreSelection') Is Not Null Drop Table WH_Visa.Selections.MOR111_PreSelectionSelect FanIDInto WH_Visa.Selections.MOR111_PreSelectionFROM  #FB fbWHERE EXISTS (	SELECT 1				FROM Sandbox.rukank.Morrisons_LoW_SoW_17082021 st				WHERE fb.CINID = st.CINID)END
