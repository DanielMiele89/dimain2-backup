...
GROUP BY F.CINID
If Object_ID('[WH_VirginPCA].Selections.BTS018_PreSelection') Is Not Null Drop Table [WH_VirginPCA].Selections.BTS018_PreSelectionSelect FanIDInto [WH_VirginPCA].Selections.BTS018_PreSelection
from #FB 
