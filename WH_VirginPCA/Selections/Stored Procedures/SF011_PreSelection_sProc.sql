CREATE PROCEDURE [Selections].[SF011_PreSelection_sProc] AS BEGIN IF OBJECT_ID('[WH_VirginPCA].[Selections].[SF011_PreSelection]') IS NOT NULL DROP TABLE [WH_VirginPCA].[Selections].[SF011_PreSelection] 
--SELECT CONVERT(INT, 0) AS FanID INTO [WH_VirginPCA].[Selections].[SF011_PreSelection] WHERE 1 = 2 END
