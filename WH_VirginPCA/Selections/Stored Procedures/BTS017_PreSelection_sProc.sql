...
and cinid not in (select cinid from #Trans_shoppers)If Object_ID('[WH_VirginPCA].Selections.BTS017_PreSelection') Is Not Null Drop Table [WH_VirginPCA].Selections.BTS017_PreSelectionSelect FanIDInto [WH_VirginPCA].Selections.BTS017_PreSelectionFROM  #SegmentAssignmentEND
