...
*******************************************************************************************************************************************/
	...
	***************************************************************************************************************************************/
		...
		FROM [Email].[Actito_Deltas] ad
		WHERE ad.FirstEarn_Date > '1900-01-01'
		AND ad.Email LIKE 'VirginPCASample%@rewardinsight.com'
...
*******************************************************************************************************************************************/
		...
		Exec msdb..sp_send_dbmail 
			...
			@recipients= 'DataOperations@rewardinsight.com',	--	'Peter.Carson@rewardinsight.com;Operations@rewardinsight.com;DataOperations@rewardinsight.com',
			@subject = 'Actito File Count - Virgin PCA',
			@execute_query_database = 'WH_VirginPCA',
			@body= @body,
			@body_format = 'HTML', 
			@importance = 'HIGH'
