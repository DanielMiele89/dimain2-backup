CREATE PROCEDURE [MIDI].[ManualModule_20220427]
...
*******************************************************************************************************************************************/
	...
	INSERT INTO [MIDI].[CTLoad_MIDINewCombo] (	MID
											...
											,	MatchCount)
	SELECT	MID
		,	OriginalNarrative =	CASE
									WHEN MerchantName LIKE '[0-9][0-9], %' THEN SUBSTRING(MerchantName, 5, 999)
									WHEN MerchantName LIKE '[0-9], %' THEN SUBSTRING(MerchantName, 4, 999)
									ELSE MerchantName
								END
		,	Narrative_Cleaned =	CASE
									WHEN MerchantName LIKE '[0-9][0-9], %' THEN SUBSTRING(MerchantName, 5, 999)
									WHEN MerchantName LIKE '[0-9], %' THEN SUBSTRING(MerchantName, 4, 999)
									ELSE MerchantName
								END
...
*******************************************************************************************************************************************/
	...
	ALTER INDEX [IX_MCCIDLocCounBrandID] ON [MIDI].[CTLoad_MIDINewCombo] REBUILD WITH (SORT_IN_TEMPDB = ON)
...
*******************************************************************************************************************************************/
		...
		CREATE NONCLUSTERED INDEX IX_MCCIDLocCounBrandID ON #Combinations (MCCID, LocationCountry, BrandID)
...
*******************************************************************************************************************************************/
	...
	ORDER BY	bsc.MatchTypeID
			...
			SELECT * FROM [MIDI].[CTLoad_BrandSuggestConfidence]
