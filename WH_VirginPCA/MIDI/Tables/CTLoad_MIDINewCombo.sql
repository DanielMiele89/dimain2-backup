CREATE TABLE [MIDI].[CTLoad_MIDINewCombo] (
    ...
    [OriginalNarrative]                   VARCHAR (150)   NULL,
...
CREATE NONCLUSTERED INDEX [ix_Stuff3]
    ON [MIDI].[CTLoad_MIDINewCombo]([MID] ASC, [MCCID] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_MCCIDLocCounBrandID]
    ON [MIDI].[CTLoad_MIDINewCombo]([MCCID] ASC, [LocationCountry] ASC, [Narrative_Cleaned] ASC);
