...
CREATE NONCLUSTERED INDEX [IX_CardID]
    ON [MIDI].[CTLoad_InitialStage]([CardID] ASC) WITH (FILLFACTOR = 90);


GO
CREATE NONCLUSTERED INDEX [IX_CardIDBankCIN]
    ON [MIDI].[CTLoad_InitialStage]([CardID] ASC, [BankID] ASC, [CIN] ASC, [CINID] ASC) WITH (FILLFACTOR = 90);


GO
CREATE NONCLUSTERED INDEX [IX_CardInputMode]
    ON [MIDI].[CTLoad_InitialStage]([CardInputMode] ASC) WITH (FILLFACTOR = 90);


GO
CREATE NONCLUSTERED INDEX [IX_CCID]
    ON [MIDI].[CTLoad_InitialStage]([ConsumerCombinationID] ASC) WITH (FILLFACTOR = 90);


GO
CREATE NONCLUSTERED INDEX [IX_CIN]
    ON [MIDI].[CTLoad_InitialStage]([CIN] ASC, [CINID] ASC) WITH (FILLFACTOR = 90);


GO
CREATE NONCLUSTERED INDEX [IX_MCC]
    ON [MIDI].[CTLoad_InitialStage]([MCC] ASC, [MCCID] ASC) WITH (FILLFACTOR = 90);


GO
CREATE NONCLUSTERED INDEX [IX_MerchantCountry]
    ON [MIDI].[CTLoad_InitialStage]([MerchantCountry] ASC) WITH (FILLFACTOR = 90);


GO
CREATE NONCLUSTERED INDEX [IX_MID]
    ON [MIDI].[CTLoad_InitialStage]([MID] ASC) WITH (FILLFACTOR = 90);


GO
CREATE NONCLUSTERED INDEX [IX_MIDCountryMCCIDMerchantName]
    ON [MIDI].[CTLoad_InitialStage]([MID] ASC, [MerchantCountry] ASC, [MCCID] ASC, [MerchantName] ASC) WITH (FILLFACTOR = 90);
