...
SELECT	[FanID] = cu.[FanID]	-- Earn Offer
	...
	,	[EarnOfferID_Hero] =	COALESCE((SELECT CONVERT(VARCHAR(255), iof.[HydraOfferID]) FROM [Derived].[IronOffer] iof WHERE iof.[IronOfferID] = osd.[OfferID_Hero]), '1D14DB9A-C4F3-4090-94AA-C782003743D8')
	,	[EarnOfferID_1] =		COALESCE((SELECT CONVERT(VARCHAR(255), iof.[HydraOfferID]) FROM [Derived].[IronOffer] iof WHERE iof.[IronOfferID] = osd.[OfferID_1]), '1D14DB9A-C4F3-4090-94AA-C782003743D8')
	,	[EarnOfferID_2] =		COALESCE((SELECT CONVERT(VARCHAR(255), iof.[HydraOfferID]) FROM [Derived].[IronOffer] iof WHERE iof.[IronOfferID] = osd.[OfferID_2]), '1D14DB9A-C4F3-4090-94AA-C782003743D8')
	,	[EarnOfferID_3] =		COALESCE((SELECT CONVERT(VARCHAR(255), iof.[HydraOfferID]) FROM [Derived].[IronOffer] iof WHERE iof.[IronOfferID] = osd.[OfferID_3]), '1D14DB9A-C4F3-4090-94AA-C782003743D8')
	,	[EarnOfferID_4] =		COALESCE((SELECT CONVERT(VARCHAR(255), iof.[HydraOfferID]) FROM [Derived].[IronOffer] iof WHERE iof.[IronOfferID] = osd.[OfferID_4]), '1D14DB9A-C4F3-4090-94AA-C782003743D8')
	,	[EarnOfferID_5] =		COALESCE((SELECT CONVERT(VARCHAR(255), iof.[HydraOfferID]) FROM [Derived].[IronOffer] iof WHERE iof.[IronOfferID] = osd.[OfferID_5]), '1D14DB9A-C4F3-4090-94AA-C782003743D8')
	,	[EarnOfferID_6] =		COALESCE((SELECT CONVERT(VARCHAR(255), iof.[HydraOfferID]) FROM [Derived].[IronOffer] iof WHERE iof.[IronOfferID] = osd.[OfferID_6]), '1D14DB9A-C4F3-4090-94AA-C782003743D8')
	,	[EarnOfferID_7] =		COALESCE((SELECT CONVERT(VARCHAR(255), iof.[HydraOfferID]) FROM [Derived].[IronOffer] iof WHERE iof.[IronOfferID] = osd.[OfferID_7]), '1D14DB9A-C4F3-4090-94AA-C782003743D8')
	,	[EarnOfferID_8] =		COALESCE((SELECT CONVERT(VARCHAR(255), iof.[HydraOfferID]) FROM [Derived].[IronOffer] iof WHERE iof.[IronOfferID] = osd.[OfferID_8]), '1D14DB9A-C4F3-4090-94AA-C782003743D8')
...
SELECT	[FanID] = sa.[FanID]	-- Earn Offer
	...
	,	[EarnOfferID_7] =		CONVERT(VARCHAR(255), COALESCE((SELECT iof.[HydraOfferID] FROM [Derived].[IronOffer] iof WHERE iof.[IronOfferID] = osd.[OfferID_7]),	(SELECT HydraOfferID FROM OPE WHERE sa.ID % 7 = OPE.CustomerNum AND ope.RowNum = 7), (SELECT HydraOfferID FROM OPE WHERE 0 = OPE.CustomerNum AND ope.RowNum = 7)))
	,	[EarnOfferID_8] =		CONVERT(VARCHAR(255), COALESCE((SELECT iof.[HydraOfferID] FROM [Derived].[IronOffer] iof WHERE iof.[IronOfferID] = osd.[OfferID_8]),	(SELECT HydraOfferID FROM OPE WHERE sa.ID % 7 = OPE.CustomerNum AND ope.RowNum = 7), (SELECT HydraOfferID FROM OPE WHERE 0 = OPE.CustomerNum AND ope.RowNum = 7)))
