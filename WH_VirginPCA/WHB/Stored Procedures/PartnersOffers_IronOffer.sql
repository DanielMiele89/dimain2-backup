	...
	--			AND iof.PublisherGUID = ppl.HydraPublisherID
		...
		*******************************************************************************************************************************************/
			...
			AND EXISTS (SELECT	iof2.OfferGUID
						...
						HAVING iof.PublishedDate = MAX(iof2.PublishedDate))

			AND CONVERT(INT, oi.IronOfferID) NOT IN (-5339, -5333, -5292, -5291, -5289)
