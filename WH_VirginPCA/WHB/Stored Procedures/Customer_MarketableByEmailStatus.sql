		...
		*******************************************************************************************************************************************/
			...
			SELECT	FanID
				...
				,	CASE
						...
						WHEN MarketableByEmail = 1 AND EmailTracking = 1	THEN 'Marketable'
			...
			WHERE NOT EXISTS (	SELECT 1
								...
								AND cus.EmailTracking = cud.EmailTracking
