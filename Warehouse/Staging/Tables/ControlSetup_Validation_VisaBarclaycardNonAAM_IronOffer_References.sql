CREATE TABLE [Staging].[ControlSetup_Validation_VisaBarclaycardNonAAM_IronOffer_References] (
    ...
    CONSTRAINT [PK_ControlSetup_Validation_VisaBarclaycardNonAAM_IronOffer_References] PRIMARY KEY CLUSTERED ([IronOfferID] ASC, [StartDate] ASC, [EndDate] ASC)
);
