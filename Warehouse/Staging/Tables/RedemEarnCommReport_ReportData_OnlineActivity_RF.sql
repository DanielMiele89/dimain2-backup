CREATE TABLE [Staging].[RedemEarnCommReport_ReportData_OnlineActivity_RF] (
    ...
    CONSTRAINT [PK_RedemEarnCommReport_ReportData_OnlineActivity_RF] PRIMARY KEY CLUSTERED ([ID] ASC)
);
