CREATE TABLE [Staging].[ControlSetup_Validation_nFINonAAM_IronOffer_References] (
    ...
    CONSTRAINT [PK_ControlSetup_Validation_nFINonAAM_IronOffer_References] PRIMARY KEY CLUSTERED ([IronOfferID] ASC, [StartDate] ASC, [EndDate] ASC)
);
