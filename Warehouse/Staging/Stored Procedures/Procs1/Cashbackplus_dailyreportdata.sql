CREATE Procedure [Staging].[Cashbackplus_dailyreportdata] (@Date date)
AS
---------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------
...
Delete from Warehouse.Staging.DailyCashBackPlusReport_Data
Where DataDate = @Date
---------------------------------------------------------------------------------------------------
...
Insert into Warehouse.Staging.DailyCashBackPlusReport_Data
