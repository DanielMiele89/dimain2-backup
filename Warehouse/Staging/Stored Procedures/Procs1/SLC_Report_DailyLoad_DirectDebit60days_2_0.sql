...
CREATE Procedure [Staging].[SLC_Report_DailyLoad_DirectDebit60days_2_0] 
...
Set		@Date = Dateadd(day,DATEDIFF(dd, 0, GETDATE())-60,0)
...
where	StoredProcedureName = 'SLC_Report_DailyLoad_DirectDebit60days_2_0' and
