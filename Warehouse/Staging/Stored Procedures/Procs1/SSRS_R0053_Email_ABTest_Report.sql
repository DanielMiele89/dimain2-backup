...
-- *********************************************
CREATE PROCEDURE [Staging].[SSRS_R0053_Email_ABTest_Report] (
			@CampaignID INT)
...
WHERE	ck.CampaignID IN (@CampaignID)
...
GROUP BY a.CampaignName,a.ClubID,abt.Test_Description,	a.SendDate
ORDER BY a.SendDate
