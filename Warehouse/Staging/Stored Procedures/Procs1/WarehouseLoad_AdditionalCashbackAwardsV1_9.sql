...
*/
CREATE Procedure [Staging].[WarehouseLoad_AdditionalCashbackAwardsV1_9]
As
/*--------------------------------------------------------------------------------------------------
...
Select	StoredProcedureName = 'WarehouseLoad_AdditionalCashbackAwardsV1_9',
...
Truncate table Relational.AdditionalCashbackAward -- --**********************NEEDS CHANGING
...
Set		EndDate = GETDATE()
where	StoredProcedureName = 'WarehouseLoad_AdditionalCashbackAwardsV1_9' and
