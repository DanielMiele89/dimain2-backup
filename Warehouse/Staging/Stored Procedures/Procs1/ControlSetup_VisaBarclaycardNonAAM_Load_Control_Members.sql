...
******************************************************************************/
CREATE PROCEDURE [Staging].[ControlSetup_VisaBarclaycardNonAAM_Load_Control_Members]
AS
BEGIN
	...
	******************************************************************************/
		...
		FROM (	SELECT	ioc.ControlGroupID
				...
				FROM [Warehouse].[Staging].[ControlSetup_PartnersToSeg_VisaBarclaycard] pts
				INNER JOIN [Warehouse].[Staging].[ControlSetup_OffersSegment_VisaBarclaycard] os
...
SELECT	TOP (950000)
	...
	******************************************************************************/
		...
		FROM (	SELECT	pts.ControlGroupID
					,	pts.PartnerID
					,	pts.Segment
					,	'VisaBarclaycardControl' + CONVERT(VARCHAR(5), pts.PartnerID) + CONVERT(VARCHAR(10), pts.StartDate, 112) AS TableName
