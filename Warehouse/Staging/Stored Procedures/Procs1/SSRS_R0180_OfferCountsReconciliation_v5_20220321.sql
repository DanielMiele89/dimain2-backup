...
CREATE PROCEDURE [Staging].[SSRS_R0180_OfferCountsReconciliation_v5_20220321]
...
SET NOCOUNT ON	
	...
	*******************************************************************************************************************************************/
		...
		SELECT cc.EmailDate
			 ...
			 , cc.Throttling
			 , CASE
					WHEN EXISTS (SELECT 1 FROM SelectedPartners sp WHERE cc.ClientServicesRef = sp.ClientServicesRef) THEN 1
					ELSE 0
