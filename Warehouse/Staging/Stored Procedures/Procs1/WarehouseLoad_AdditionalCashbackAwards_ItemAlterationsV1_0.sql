...
/*
		...
		Notes:		
*/
CREATE Procedure [Staging].[WarehouseLoad_AdditionalCashbackAwards_ItemAlterationsV1_0]
as
...
BEGIN TRY
	...
	Select	StoredProcedureName = 'WarehouseLoad_AdditionalCashbackAwards_ItemAlterationsV1_0',
	...
	Set		EndDate = GETDATE()
	where	StoredProcedureName = 'WarehouseLoad_AdditionalCashbackAwards_ItemAlterationsV1_0' and
