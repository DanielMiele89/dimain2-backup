CREATE Procedure [Staging].[RBSG_MonthlyRep_MonthByMonthComms] (@StartDate Date, @EndDate Date)
as
...
(select	ec.CampaignKey,ec.senddate,ec.CampaignName,Reference,EmailType,EmailName,FanID,
		max(Case When ee.EmailEventCodeID = 901 then 1 else 0 end) as EmailSentOK,
