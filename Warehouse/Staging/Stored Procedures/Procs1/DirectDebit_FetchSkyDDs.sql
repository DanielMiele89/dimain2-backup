...
-- Description: Fetch the most recent Direct Debit transactions for Sky 
--				from Archive_Light.dbo.CBP_DirectDebit_TransactionHistory
--				and insert them into the Sky Direct Debit table
-- ***************************************************************************
CREATE PROCEDURE [Staging].[DirectDebit_FetchSkyDDs]
...
SELECT	StoredProcedureName = OBJECT_NAME(@@PROCID),
	...
	TableName = 'CBP_DirectDebit_TransactionHistory_Sky_DD',
	StartDate = GETDATE(),
	EndDate = NULL,
	TableRowCount  = NULL,
	AppendReload = 'A'
...
*******************************************************************************************************************************************/
	...
	INSERT INTO Staging.CBP_DirectDebit_TransactionHistory_Sky_DD_FileIDsAlreadyProcessed (FileID
																						 , DateProcessed
																						 , InsertCompleted)
	SELECT ID as FileID
	...
	AND NOT EXISTS (SELECT 1
					FROM Staging.CBP_DirectDebit_TransactionHistory_Sky_DD_FileIDsAlreadyProcessed fap
...
/*******************************************************************************************************************************************
	2. Find all Sky Service User Numbers (oins / OINs)
*******************************************************************************************************************************************/
...
*******************************************************************************************************************************************/
	...
	TRUNCATE TABLE Staging.CBP_DirectDebit_TransactionHistory_Sky_DD_Holding
	
	WHILE EXISTS (SELECT 1 FROM Staging.CBP_DirectDebit_TransactionHistory_Sky_DD_FileIDsAlreadyProcessed WHERE InsertCompleted = 0)
	BEGIN
	
		SET @FileID = (SELECT MIN(FileID) FROM Staging.CBP_DirectDebit_TransactionHistory_Sky_DD_FileIDsAlreadyProcessed WHERE InsertCompleted = 0)

		INSERT INTO Staging.CBP_DirectDebit_TransactionHistory_Sky_DD_Holding (FileID
																			 , RowNum
																			 , OIN
																			 , Narrative
																			 , TranDate
		...
		UPDATE Staging.CBP_DirectDebit_TransactionHistory_Sky_DD_FileIDsAlreadyProcessed
...
*******************************************************************************************************************************************/
	...
	***********************************************************************************************************************/
		...
		SELECT DISTINCT
			   BankAccountID
		INTO #BankAccount
		FROM Staging.CBP_DirectDebit_TransactionHistory_Sky_DD_Holding
	...
	***********************************************************************************************************************/
		...
		FROM Staging.CBP_DirectDebit_TransactionHistory_Sky_DD_Holding dd
...
*******************************************************************************************************************************************/
	...
	INSERT INTO Staging.CBP_DirectDebit_TransactionHistory_Sky_DD
