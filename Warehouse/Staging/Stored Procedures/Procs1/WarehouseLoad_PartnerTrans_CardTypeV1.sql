...
*/
CREATE Procedure [Staging].[WarehouseLoad_PartnerTrans_CardTypeV1]
as
BEGIN
...
BEGIN TRY
	...
	Select	StoredProcedureName = 'WarehouseLoad_PartnerTrans_CardTypeV1',
	...
	Set		EndDate = GETDATE()
	where	StoredProcedureName = 'WarehouseLoad_PartnerTrans_CardTypeV1' and
