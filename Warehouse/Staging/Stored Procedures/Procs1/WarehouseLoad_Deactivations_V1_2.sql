...
*/
CREATE PROCEDURE [Staging].[WarehouseLoad_Deactivations_V1_2]
AS
BEGIN
...
BEGIN TRY
	...
	Select	StoredProcedureName = 'WarehouseLoad_Deactivations_V1_2',
	...
	*/
	...
	Set		EndDate = GETDATE()
	where	StoredProcedureName = 'WarehouseLoad_Deactivations_V1_2' and
