...
CREATE procedure [Staging].[SSRS_R0149_nFICustomersvsCustomersonOffersv1_1] (@Date Date,@Type int)
...
Left Outer join Warehouse.InsightArchive.QuidcoR4GCustomers R4G 
		on cu.CompositeID = r4g.CompositeID
Where --cl.clubid <> 12
		R4G.CompositeID is null
