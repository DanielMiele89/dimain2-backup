...
*/
CREATE Procedure [Staging].[WarehouseLoad_DirectDebit_OINs]
...
BEGIN TRY
	...
	Select	StoredProcedureName = 'WarehouseLoad_DirectDebit_OINs',
	...
	Set		EndDate = GETDATE()
	where	StoredProcedureName = 'WarehouseLoad_DirectDebit_OINs' and
