Create Procedure [Staging].[ShareOfWallet_SegmentAssignment_04_V1]
				@Partner int --nvarchar(40)

AS
Declare @PartnerS varchar(5)
Set @PartnerS = Cast(@Partner as Varchar(5))
--Set @Partner = '2365'
---------------------------------------------------------------------------------------------------------------------
