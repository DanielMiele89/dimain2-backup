...
-- Description: Easy Fundraising Daily Report (Code written by Lloyd Green)
-- ***************************************************************************
CREATE PROCEDURE [Staging].[SSRS_R0085_EasyFundraising_DailyReport]
...
BEGIN
	...
	WHERE	ClubID = 143  ---- (12 - Quidco, 143 - Easyfundraising, 144 - Karrot, 145 - NextJump)
