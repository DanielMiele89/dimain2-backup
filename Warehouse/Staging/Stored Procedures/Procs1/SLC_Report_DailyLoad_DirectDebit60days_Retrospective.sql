/*
		Update: 3rd July 2017 - Needed amending to include new DD Entries
*/
CREATE Procedure [Staging].[SLC_Report_DailyLoad_DirectDebit60days_Retrospective] (@daysback int,@TableName varchar(100))
with Execute as owner
as

Insert into staging.JobLog_Temp
Select	StoredProcedureName = 'SLC_Report_DailyLoad_DirectDebit60days',
...
Where /*Title*/[Description] Like '%MyRewards%' or 
		Title Like '%Credit Card%' --** SB 2017-07-03 : Change Made to counter Title no longer containing the word MyRewards
...
Set @EndDate = Dateadd(day,DATEDIFF(dd, 0, GETDATE())-(60+@daysback),0)
Set @StartDate = (Case
...
where	StoredProcedureName = 'SLC_Report_DailyLoad_DirectDebit60days' and
