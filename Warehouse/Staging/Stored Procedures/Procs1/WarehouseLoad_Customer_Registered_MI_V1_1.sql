...
CREATE Procedure [Staging].[WarehouseLoad_Customer_Registered_MI_V1_1]
As
...
BEGIN TRY
	...
	Select	StoredProcedureName = 'WarehouseLoad_Customer_Registered_MI_V1_1',
	...
	Set		EndDate = GETDATE()
	where	StoredProcedureName = 'WarehouseLoad_Customer_Registered_MI_V1_1' and
