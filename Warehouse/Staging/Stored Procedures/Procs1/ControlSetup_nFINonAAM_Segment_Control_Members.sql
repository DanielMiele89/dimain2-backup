...
******************************************************************************/
CREATE PROCEDURE [Staging].[ControlSetup_nFINonAAM_Segment_Control_Members]
...
BEGIN
	...
	******************************************************************************/
	...
	DECLARE @CLOSegmentStoredProcedure varchar(100) = '[WH_AllPublishers].[Segmentation].[ControlSetup_Segmentation_POS]';
	DECLARE @MFDDSegmentStoredProcedure varchar(100) = '[WH_AllPublishers].[Segmentation].[ControlSetup_Segmentation_DD]';
	...
	******************************************************************************/
	...
	FROM (	SELECT	DISTINCT -- The below code creates paramater values for this stored procedure
			...
			FROM [Warehouse].[Staging].[ControlSetup_PartnersToSeg_nFI] pts) pts
