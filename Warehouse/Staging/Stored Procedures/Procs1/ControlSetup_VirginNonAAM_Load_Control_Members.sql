...
******************************************************************************/
CREATE PROCEDURE [Staging].[ControlSetup_VirginNonAAM_Load_Control_Members]
AS
BEGIN
	...
	******************************************************************************/
		...
		FROM (	SELECT	ioc.ControlGroupID
				...
				INNER JOIN [Warehouse].[Staging].[ControlSetup_OffersSegment_Virgin] os
...
SELECT	TOP (950000)
	...
	******************************************************************************/
		...
		FROM (	SELECT	pts.ControlGroupID
					,	pts.PartnerID
					,	pts.Segment
					,	'VirginControl' + CONVERT(VARCHAR(5), pts.PartnerID) + CONVERT(VARCHAR(10), pts.StartDate, 112) AS TableName
