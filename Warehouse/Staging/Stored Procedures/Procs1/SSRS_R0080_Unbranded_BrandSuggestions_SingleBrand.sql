...
-- Description: Used for populating [Staging].[SSRS_R0080_Unbranded_BrandSuggestionsV3]
-- *****************************************************************************************************
CREATE PROCEDURE  [Staging].[SSRS_R0080_Unbranded_BrandSuggestions_SingleBrand](
			@BrandIDs INT)
...
INSERT INTO [Staging].[R_0080_Unbranded_BrandSuggestionsV3]	
...
LEFT OUTER JOIN [Staging].[BrandSuggestionRejected] u
