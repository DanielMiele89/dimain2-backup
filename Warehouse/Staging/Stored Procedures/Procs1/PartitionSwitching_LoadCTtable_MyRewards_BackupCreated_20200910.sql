...
*/
CREATE PROCEDURE [Staging].[PartitionSwitching_LoadCTtable_MyRewards_BackupCreated_20200910]
...
SELECT BatchID = 1, ct.FileID, ct.RowNum, ct.ConsumerCombinationID, ct.CardholderPresentData, ct.TranDate, ct.CINID, ct.Amount, ct.IsOnline, PaymentTypeID = 1 
INTO #MR_holding
...
-----------------------------------------------------------------------------------------------------------------
INSERT INTO #MR_holding 
	(BatchID, FileID, RowNum, ConsumerCombinationID, CardholderPresentData, TranDate, CINID, Amount, IsOnline, PaymentTypeID)
SELECT 
	BatchID = 3, FileID, RowNum, ConsumerCombinationID, CardholderPresentData, TranDate, cth.CINID, Amount, IsOnline, PaymentTypeID = 1 
...
INSERT INTO #MR_holding  
	(BatchID, FileID, RowNum, ConsumerCombinationID, CardholderPresentData, TranDate, CINID, Amount, IsOnline, PaymentTypeID)
SELECT BatchID = 4, FileID, RowNum, ConsumerCombinationID, CardholderPresentData, TranDate, CINID, Amount, IsOnline, PaymentTypeID = 2 
