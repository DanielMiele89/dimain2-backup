...
-- ***************************************************************************
CREATE PROCEDURE [Staging].[SSRS_R0051_OfferSelectionCountsReport_V1_2]
...
Left Outer join Warehouse.iron.NominatedOfferMember as iom
...
INNER JOIN Warehouse.Relational.IronOffer io
	ON io.IronOfferID = os.OfferID
INNER JOIN Warehouse.Relational.Partner p
	ON io.PartnerID = p.PartnerID
ORDER BY p.PartnerName,ClientServicesRef,HTMID
