...
Update:		N/A
*/
CREATE Procedure [Staging].[WarehouseLoad_Customer_Marketable_ButDeceased]
...
BEGIN TRY
	...
	Select	StoredProcedureName = 'WarehouseLoad_Customer_Marketable_ButDeceased',
	...
	Set		EndDate = GETDATE()
	where	StoredProcedureName = 'WarehouseLoad_Customer_Marketable_ButDeceased' and
