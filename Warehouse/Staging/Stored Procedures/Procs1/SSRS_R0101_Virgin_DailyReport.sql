...
-- ***************************************************************************
CREATE PROCEDURE [Staging].[SSRS_R0101_Virgin_DailyReport]
...
BEGIN
	...
	WHERE	ClubID = 147  ---- (12 - Quidco, 143 - Easyfundraising, 144 - Karrot, 145 - NextJump, 147 - Virgin)
