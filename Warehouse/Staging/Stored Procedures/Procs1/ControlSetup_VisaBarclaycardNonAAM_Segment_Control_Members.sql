...
******************************************************************************/
CREATE PROCEDURE [Staging].[ControlSetup_VisaBarclaycardNonAAM_Segment_Control_Members]
...
BEGIN
	...
	******************************************************************************/
	...
	FROM (	SELECT	DISTINCT -- The below code creates paramater values for this stored procedure
			...
			FROM [Warehouse].[Staging].[ControlSetup_PartnersToSeg_VisaBarclaycard] pts) pts
