...
CREATE Procedure [Staging].[WarehouseLoad_DailyLoadChecks_Table]
As
...
DECLARE @ERROR_NUMBER INT, @ERROR_SEVERITY INT, @ERROR_STATE INT, @ERROR_PROCEDURE VARCHAR(100), @ERROR_LINE INT, @ERROR_MESSAGE VARCHAR(200);
	...
	Select	StoredProcedureName = 'WarehouseLoad_DailyLoadChecks_Table',
	...
	Set		EndDate = GETDATE()
	where	StoredProcedureName = 'WarehouseLoad_DailyLoadChecks_Table' and
