...
******************************************************************************/
CREATE PROCEDURE [Staging].[OfferReport_Fetch_ThresholdMetrics_V3_20220329] (
    @ID INT = NULL
)
AS
...
BEGIN
	...
	WHERE EXISTS (	SELECT 1
					...
					WHERE COALESCE(cu.CINID_Warehouse, cu.CINID_Virgin, cu.CINID_VisaBarclaycard) = ct.CINID
