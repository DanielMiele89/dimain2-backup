...
*/
CREATE PROCEDURE [Staging].[WarehouseLoad_Corrections_V1_7]
AS 
BEGIN
...
BEGIN TRY
	...
	Select	StoredProcedureName = 'WarehouseLoad_Corrections_V1_7',
	...
	where	StoredProcedureName = 'WarehouseLoad_Corrections_V1_7' and
	...
	*/
	...
	Update Relational.Partnertrans
	Set AboveBase = 0
	Where	AboveBase is null and 
			Cast(CashbackEarned as real) / TransactionAmount Between -.0125 and .0125
