Create Procedure [Staging].[SSRS_R0075_PrelaunchCheck_MIDsAlreadyInGasV1_1] 
...
if @NotInGas = 0
Begin
		Select b.*,a.MerchantID as OriginalMID
		from #MatchedMIds as b
		inner join Staging.MIDs_TempTable as a
			on b.RowNo = a.RowNo
		Where Original = 1
End
...
Begin
		Set @Qry = '
					...
					inner join '+@TableName+' as c
						on a.MerchantID = c.'+@MID_Name+'
		left outer join #MatchedMIds as b
			on a.RowNo = b.RowNo
		Where a.Original = 1 and
				b.RowNo is null
		'
