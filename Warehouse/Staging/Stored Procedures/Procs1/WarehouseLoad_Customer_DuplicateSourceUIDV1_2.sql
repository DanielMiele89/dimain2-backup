--Use Warehouse
CREATE Procedure [Staging].[WarehouseLoad_Customer_DuplicateSourceUIDV1_2]
As
Begin
...
BEGIN TRY
	...
	Select	StoredProcedureName = 'WarehouseLoad_Customer_DuplicateSourceUIDV1_2',
	...
	Set		EndDate = GETDATE()
	where	StoredProcedureName = 'WarehouseLoad_Customer_DuplicateSourceUIDV1_2' and
