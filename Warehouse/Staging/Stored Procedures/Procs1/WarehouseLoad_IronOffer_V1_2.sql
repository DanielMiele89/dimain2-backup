...
*/
CREATE Procedure [Staging].[WarehouseLoad_IronOffer_V1_2]
...
BEGIN TRY
	...
	Select	StoredProcedureName = 'WarehouseLoad_IronOffer_V1_2',
	...
	Set		EndDate = GETDATE()
	where	StoredProcedureName = 'WarehouseLoad_IronOffer_V1_2' and
