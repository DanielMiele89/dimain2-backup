...
******************************************************************************/
CREATE PROCEDURE [Staging].[ControlSetup_RBS_Segment_Control_Members_20211201]
...
BEGIN
	...
	******************************************************************************/
	...
	From (
		...
		From Warehouse.Staging.ControlSetup_PartnersToSeg_Warehouse a
		) a
	Left join sys.schemas s
		on a.SchemaName = s.name
	Left join sys.Tables t
		on a.TableName = t.Name
	Where
		t.Name is null; -- Exclude calls run as part of nFI segmentation
