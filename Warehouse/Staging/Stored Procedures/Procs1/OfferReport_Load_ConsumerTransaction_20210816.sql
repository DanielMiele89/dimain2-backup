...
******************************************************************************/
CREATE PROCEDURE [Staging].[OfferReport_Load_ConsumerTransaction_20210816]
...
BEGIN
	...
	CREATE NONCLUSTERED COLUMNSTORE INDEX CSI_All ON [Warehouse].[Staging].[OfferReport_ConsumerTransaction] (CINID, ConsumerCombinationID, Amount, TranDate, IsOnline, IsWarehouse, IsVirgin) ON Warehouse_Columnstores
