...
******************************************************************************/
CREATE PROCEDURE [Staging].[ControlSetup_VirginPCANonAAM_Load_Exposed_Members]
...
BEGIN
	...
	******************************************************************************/
	...
	-- Declare iteration variables
		...
		FROM [WH_VirginPCA].[Report].[CampaignHistory]
		...
		WHERE NOT EXISTS (	SELECT 1
							FROM [WH_VirginPCA].[Report].[CampaignHistory] ch
