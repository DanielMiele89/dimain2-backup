...
*/
CREATE PROCEDURE [Staging].[WarehouseLoad_CustomerDeactivations_V1_2]
AS
BEGIN
...
Select	StoredProcedureName = 'WarehouseLoad_CustomerDeactivations_V1_2',
...
Set		EndDate = GETDATE()
where	StoredProcedureName = 'WarehouseLoad_CustomerDeactivations_V1_2' and
