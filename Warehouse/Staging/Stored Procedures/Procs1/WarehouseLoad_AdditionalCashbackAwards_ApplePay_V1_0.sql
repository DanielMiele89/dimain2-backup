...
Create Procedure [Staging].[WarehouseLoad_AdditionalCashbackAwards_ApplePay_V1_0]
As
/*--------------------------------------------------------------------------------------------------
...
Select	StoredProcedureName = 'WarehouseLoad_AdditionalCashbackAwards_ApplePay_V1_0',
...
Set		EndDate = GETDATE()
where	StoredProcedureName = 'WarehouseLoad_AdditionalCashbackAwards_ApplePay_V1_0' and
