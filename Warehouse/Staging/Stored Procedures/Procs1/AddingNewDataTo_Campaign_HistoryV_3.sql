...
Update:		This was checking campaign history that was caousing a problem, because of multiple waves with the
			same ClientServicesRef

*/

CREATE PROCEDURE [Staging].[AddingNewDataTo_Campaign_HistoryV_3]
