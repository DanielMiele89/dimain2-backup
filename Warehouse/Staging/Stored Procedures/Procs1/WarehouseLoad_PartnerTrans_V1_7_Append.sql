...
CREATE PROCEDURE [Staging].[WarehouseLoad_PartnerTrans_V1_7_Append]
AS
BEGIN
...
BEGIN TRY
	...
	Select	StoredProcedureName = 'WarehouseLoad_PartnerTrans_V1_7_Append',
	...
	Set		EndDate = GETDATE()
	where	StoredProcedureName = 'WarehouseLoad_PartnerTrans_V1_7_Append' and
	...
	*/	
	...
	--Rebuild Indexes
	ALTER INDEX i_FanID ON Relational.PartnerTrans  REBUILD WITH (SORT_IN_TEMPDB = ON, DATA_COMPRESSION = PAGE) -- CJM 20190212
	ALTER INDEX i_TranAssessment ON Relational.PartnerTrans  REBUILD WITH (SORT_IN_TEMPDB = ON, DATA_COMPRESSION = PAGE) -- CJM 20190212
	ALTER INDEX i_TransactionWeekStarting ON Relational.PartnerTrans  REBUILD WITH (SORT_IN_TEMPDB = ON, DATA_COMPRESSION = PAGE) -- CJM 20190212 
