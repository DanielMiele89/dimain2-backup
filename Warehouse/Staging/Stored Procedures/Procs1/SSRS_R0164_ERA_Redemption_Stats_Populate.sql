...
CREATE Procedure [Staging].[SSRS_R0164_ERA_Redemption_Stats_Populate]
...
BEGIN TRY
	...
	Select	StoredProcedureName = 'SSRS_0164_ERA_Redemption_Stats_Populate',
	...
	where	StoredProcedureName = 'SSRS_0164_ERA_Redemption_Stats_Populate' and
