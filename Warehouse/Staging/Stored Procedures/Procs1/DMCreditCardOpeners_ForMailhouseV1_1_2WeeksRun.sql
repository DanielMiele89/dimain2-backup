...
*/
CREATE Procedure [Staging].[DMCreditCardOpeners_ForMailhouseV1_1_2WeeksRun]
as
...
----------------------------------------------------------------------------------
set Datefirst 1
Set @StartDate = DateAdd(day,-18,(select [Staging].[fnGetStartOfWeek](@Date)))
...
Left Outer join (Select [FanID] from Warehouse.[Staging].[CreditCardOpeners] Where SendDate > dateadd(day,-35,@Date)) as a
	on c.FanID = a.FanID
