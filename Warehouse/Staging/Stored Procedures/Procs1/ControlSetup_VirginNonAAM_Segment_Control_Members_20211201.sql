...
******************************************************************************/
CREATE PROCEDURE [Staging].[ControlSetup_VirginNonAAM_Segment_Control_Members_20211201]
...
BEGIN
	...
	******************************************************************************/
		...
		DECLARE @CLOSegmentStoredProcedure VARCHAR(100) = 'Warehouse.Segmentation.ControlGroupSegmentation_Virgin';
	...
	******************************************************************************/
		...
		FROM (	SELECT	DISTINCT -- The below code creates paramater values for this stored procedure
				...
				FROM [Warehouse].[Staging].[ControlSetup_PartnersToSeg_Virgin] pts) a;
