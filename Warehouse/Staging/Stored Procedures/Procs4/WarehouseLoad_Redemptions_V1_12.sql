...
CREATE PROCEDURE [Staging].[WarehouseLoad_Redemptions_V1_12]
AS
BEGIN
...
BEGIN TRY
	...
	Select	StoredProcedureName = 'WarehouseLoad_Redemptions_V1_12',
	...
	*/
	...
	where	StoredProcedureName = 'WarehouseLoad_Redemptions_V1_12' and
