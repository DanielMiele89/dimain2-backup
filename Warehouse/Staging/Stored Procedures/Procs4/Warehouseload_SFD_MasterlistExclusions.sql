...
CREATE Procedure [Staging].[Warehouseload_SFD_MasterlistExclusions] 
...
BEGIN TRY
	...
	Select    StoredProcedureName = 'Warehouseload_SFD_MasterlistExclusions',
	...
	Set EndDate = GETDATE()
	where    StoredProcedureName = 'Warehouseload_SFD_MasterlistExclusions' and
