...
*/
CREATE PROCEDURE [Staging].[WarehouseLoad_WebLoginsV1_1]
AS
BEGIN
...
BEGIN TRY
	...
	Select	StoredProcedureName = 'WarehouseLoad_WebLogins',
	...
	Set		EndDate = GETDATE()
	where	StoredProcedureName = 'WarehouseLoad_WebLogins' and
