...
*/
CREATE PROCEDURE [Staging].[WarehouseLoad_SmartFocusEmailData_V1_6]
AS
BEGIN
...
Select	StoredProcedureName = 'WarehouseLoad_SmartFocusEmailData_V1_6',
...
Set		EndDate = GETDATE()
where	StoredProcedureName = 'WarehouseLoad_SmartFocusEmailData_V1_6' and
