...
CREATE Procedure [Staging].[WarehouseLoad_WGUpdate_V1_0]
...
BEGIN TRY
	...
	Select	StoredProcedureName = 'WarehouseLoad_WGUpdate_V1_0',
	...
	Set		EndDate = GETDATE()
	where	StoredProcedureName = 'WarehouseLoad_WGUpdate_V1_0' and
