...
CREATE PROCEDURE [Staging].[__CampaignCode_AutoGeneration_ROC_SS_V1_4_Archived]
		(	@PartnerID CHAR(4),
			@StartDate DATE, 
			@EndDate DATE,
...
Select	ch.FanID
Into #Members
From Warehouse.Relational.Campaign_History as ch
inner join #Offers as o
	on ch.IronOfferID = o.IronOfferID
Where  GRP = ''Mail'' and
		ch.SDate = '''+@CustomerBaseOfferDate+'''						
'
	Else ''					
End
+'
