...
-- ***********************************************************
CREATE PROCEDURE [Staging].[SSRS_R0097_Quidco_HalfordsWeeklyReport]
...
FROM Warehouse.Staging.SSRS_R0097_HalfordsWeeklyReport a
INNER JOIN Warehouse.InsightArchive.Halfords_Volumes_By_Week b 
