...
-- ***************************************************************************
CREATE PROCEDURE [Staging].[SSRS_R0108_MitchellsAndButlers_FinancialReport_V2]
			(
			@StartDate DATE,
			@EndDate DATE
			)
...
--***************************************************************************
--IF OBJECT_ID ('Warehouse.Staging.R_0108_MB_Data') IS NOT NULL DROP TABLE Warehouse.Staging.R_0108_MB_Data
--CREATE TABLE Warehouse.Staging.R_0108_MB_Data
--	(
...
TRUNCATE TABLE Warehouse.Staging.R_0108_MB_Data
...
BEGIN
	INSERT INTO Warehouse.Staging.R_0108_MB_Data
...
SELECT	*
FROM Warehouse.Staging.R_0108_MB_Data
