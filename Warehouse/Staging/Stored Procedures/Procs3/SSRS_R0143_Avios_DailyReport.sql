...
-- Description: Avios Daily Report (Code written by Lloyd Green)
-- ***************************************************************************
CREATE PROCEDURE [Staging].[SSRS_R0143_Avios_DailyReport]
...
BEGIN
	...
	SELECT	@StartDate,
		...
		COUNT(DISTINCT f.CompositeID) as Cardholders 
...
BEGIN
	...
	WHERE	ClubID = 148  ---- (12 - Quidco, 143 - Easyfundraising, 144 - Karrot, 145 - NextJump, 148 - Avios)
