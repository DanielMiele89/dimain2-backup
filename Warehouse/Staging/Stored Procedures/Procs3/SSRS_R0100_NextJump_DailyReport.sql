...
-- ***************************************************************************
CREATE PROCEDURE [Staging].[SSRS_R0100_NextJump_DailyReport]
...
BEGIN
	...
	WHERE	ClubID = 145  ---- (12 - Quidco, 143 - Easyfundraising, 144 - Karrot, 145 - NextJump)
