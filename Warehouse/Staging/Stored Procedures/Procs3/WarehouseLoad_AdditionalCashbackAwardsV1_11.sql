...
*/
Create Procedure [Staging].[WarehouseLoad_AdditionalCashbackAwardsV1_11]
As
/*--------------------------------------------------------------------------------------------------
...
Select	StoredProcedureName = 'WarehouseLoad_AdditionalCashbackAwardsV1_11',
...
Set		EndDate = GETDATE()
where	StoredProcedureName = 'WarehouseLoad_AdditionalCashbackAwardsV1_11' and
