CREATE Procedure [Staging].[ShareofWallet_EligibleCustomersV1_4]
As
Begin
...
Select	StoredProcedureName = 'ShareofWallet_EligibleCustomersV1_4',
		TableSchemaName = '',
...
Set		EndDate = GETDATE()
where	StoredProcedureName = 'ShareofWallet_EligibleCustomersV1_4' and
		TableSchemaName = '' and
