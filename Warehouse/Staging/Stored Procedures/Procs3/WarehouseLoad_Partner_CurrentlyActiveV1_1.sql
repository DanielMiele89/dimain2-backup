...
-- Update:		3rd February 2017 - rewritten to deal with IronOfferMember changes
-- *******************************************************************************
CREATE PROCEDURE [Staging].[WarehouseLoad_Partner_CurrentlyActiveV1_1]
...
BEGIN TRY
	...
	******************************************************************************/
	...
	SELECT	StoredProcedureName = 'WarehouseLoad_Partner_CurrentlyActiveV1_1',
...
-----------------------------------------------------------------------------------------------
	...
	******************************************************************************/
	...
	SET EndDate = GETDATE()
	WHERE	StoredProcedureName = 'WarehouseLoad_Partner_CurrentlyActiveV1_1' 
