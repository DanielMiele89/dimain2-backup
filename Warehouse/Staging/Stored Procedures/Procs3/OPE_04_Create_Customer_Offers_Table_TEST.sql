...
CREATE Procedure [Staging].[OPE_04_Create_Customer_Offers_Table_TEST] (@EmailDate as date)
As
/*--------------------------------------------------------------------------------------------------
...
Select top 150000 FanID,CompositeID,ROW_NUMBER() OVER (ORDER BY FanID) AS RowNumber
Into #Customer
