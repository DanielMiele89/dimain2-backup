...
CREATE PROCEDURE [Staging].[WarehouseLoad_Cashback_Balances_V1_2]
AS
BEGIN
...
BEGIN TRY
	...
	Select	StoredProcedureName = 'WarehouseLoad_Cashback_Balances_V1_2',
	...
	where	StoredProcedureName = 'WarehouseLoad_Cashback_Balances_V1_2' and
