...
CREATE PROCEDURE [Staging].[SSRS_R0185_MyRewardsCampaignSelectionsQA_GeodemFilters](
			@Date Date
			)
...
--AND iof.Item > 0
			...
			While @CSRRank <= @MaxCSRRank
				Begin
					...
					DELETE FROM #OfferSegmentsLaunchUniversal WHERE OfferID = 17416
