...
-- ****************************************************************
CREATE PROCEDURE [Staging].[SSRS_R0097a_Quidco_HalfordsAutoCentreWeeklyCalculation]
...
SELECT	StoredProcedureName = 'SSRS_R0097a_Quidco_HalfordsAutoCentreWeeklyCalculation',
...
***************************************************************************/
IF OBJECT_ID('Warehouse.Staging.SSRS_R0097_HalfordsAutoCentreWeeklyReport') IS NOT NULL DROP TABLE Warehouse.Staging.SSRS_R0097_HalfordsAutoCentreWeeklyReport
...
INTO Warehouse.Staging.SSRS_R0097_HalfordsAutoCentreWeeklyReport
...
SET EndDate = GETDATE()
WHERE	StoredProcedureName = 'SSRS_R0097a_Quidco_HalfordsAutoCentreWeeklyCalculation' 
