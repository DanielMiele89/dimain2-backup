...
CREATE Procedure [Staging].[SLC_Report_DailyLoad_DirectDebit120days_2_0_Retrospective_1_1] (@MissingDate Date,@TableName Varchar(200))
...
Set		@Date = Dateadd(day,-120,@MissingDate)
...
Set @EndDate = @MissingDate--Dateadd(day,DATEDIFF(dd, 0, GETDATE())-120,0)
Set @StartDate = (Case
