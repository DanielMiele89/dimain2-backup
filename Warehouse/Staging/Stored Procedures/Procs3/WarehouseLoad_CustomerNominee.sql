CREATE procedure [Staging].[WarehouseLoad_CustomerNominee]
AS
...
BEGIN TRY
	...
	Select	StoredProcedureName = 'WarehouseLoad_CustomerNominee',
	...
	Set		EndDate = GETDATE()
	where	StoredProcedureName = 'WarehouseLoad_CustomerNominee' and
