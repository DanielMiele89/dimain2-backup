...
-- ***************************************************************************
CREATE PROCEDURE [Staging].[SSRS_R0101_SMS_DailyReport]
...
BEGIN
	...
	WHERE	ClubID = 146  ---- (12 - Quidco, 143 - Easyfundraising, 144 - Karrot, 145 - NextJump, 148 - Avios)
