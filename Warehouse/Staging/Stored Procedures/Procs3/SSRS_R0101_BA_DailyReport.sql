...
-- ***************************************************************************
	CREATE PROCEDURE [Staging].[SSRS_R0101_BA_DailyReport]
...
BEGIN
	...
	WHERE	ClubID = 149  ---- (12 - Quidco, 143 - Easyfundraising, 144 - Karrot, 145 - NextJump, 148 - Avios)
