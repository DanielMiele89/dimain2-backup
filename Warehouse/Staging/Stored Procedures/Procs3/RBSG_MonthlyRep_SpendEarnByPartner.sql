...
Create Procedure Staging.RBSG_MonthlyRep_SpendEarnByPartner (@StartDate date, @EndDate date,@LaunchDate date)
as
--use warehouse
...
--------------------Report Query-------------------------------------------------
---------------------------------------------------------------------------------*/
if object_id('Warehouse.staging.RBSG_MonthlyReport_SpendEarnByPartner') is not null drop table Warehouse.staging.RBSG_MonthlyReport_SpendEarnByPartner
select 
...
Into	Warehouse.staging.RBSG_MonthlyReport_SpendEarnByPartner
