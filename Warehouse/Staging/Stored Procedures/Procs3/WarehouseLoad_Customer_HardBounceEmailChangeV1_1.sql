...
Create Procedure [Staging].[WarehouseLoad_Customer_HardBounceEmailChangeV1_1]
as
/*--------------------------------------------------------------------------------------------------
...
Select	StoredProcedureName = 'WarehouseLoad_Customer_HardBounceEmailChange1_1',
...
Set		EndDate = GETDATE()
where	StoredProcedureName = 'WarehouseLoad_Customer_HardBounceEmailChange1_1' and
