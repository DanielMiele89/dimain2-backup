...
*/
CREATE Procedure [Staging].[WarehouseLoad_Customer_Registrations]
as 
...
BEGIN TRY
	...
	Select	StoredProcedureName = 'WarehouseLoad_Customer_Registrations',
	...
	Set		EndDate = GETDATE()
	where	StoredProcedureName = 'WarehouseLoad_Customer_Registrations' and
