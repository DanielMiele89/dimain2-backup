...
*/
CREATE Procedure [Staging].[WarehouseLoad_AdditionalCashbackAwards_CC_MonthlyAwards]
As
...
BEGIN TRY
	...
	Select	StoredProcedureName = 'WarehouseLoad_AdditionalCashbackAwards_CC_MonthlyAwards',
	...
	where	StoredProcedureName = 'WarehouseLoad_AdditionalCashbackAwards_CC_MonthlyAwards' and
