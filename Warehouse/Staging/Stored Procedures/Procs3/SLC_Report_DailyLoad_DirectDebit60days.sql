...
*/
CREATE Procedure [Staging].[SLC_Report_DailyLoad_DirectDebit60days] 
...
Where /*Title*/ [Description] Like '%MyRewards%' or Title Like '%Credit Card%' --SB 2017-07-03
...
Set @EndDate = Dateadd(day,DATEDIFF(dd, 0, GETDATE())-60,0)
Set @StartDate = (Case
...
Insert into Staging.SLC_Report_ProductMonitoring
