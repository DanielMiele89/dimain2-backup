...
-- Description:	Sets foreign combinations
-- =============================================
CREATE PROCEDURE [gas].[SideBySide_ForeignCombos_Set] 
...
BEGIN
	...
	CREATE INDEX IX_TMP_ForeignCombos ON #ForeignCombos(MID, Narrative, MCCID, LocationCountry, OriginatorID, BrandCombinationID, IsHighVariance)
