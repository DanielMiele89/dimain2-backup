...
-- Called by [gas].[MIDI_Setup]
-- =============================================
create PROCEDURE [gas].[CTLoad_CombinationsMIDIHolding_Set]
...
BEGIN
	...
	--	Fetch all new PayPal MIDs that don't have an existing CC but have < 10 trans
