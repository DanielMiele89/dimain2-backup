...
-- Description:	sets paypal combinations in the staging area
-- Modified for migration 09/12/2021 CJM
-- =============================================
CREATE PROCEDURE [gas].[CTLoad_CombinationsPaypal_Set]
...
-- Fetch all new PayPal MIDs 
-- that don't have an existing CC [CJM why isn't this coded in??]
-- but have < 10 trans
