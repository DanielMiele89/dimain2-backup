...
CREATE PROC [gas].[Member_GetTransactionHistory] 
	@FanID INT,
...
FROM c
	...
	INNER JOIN Archive_Light.dbo.NobleTransactionHistory_Narrow h WITH (NOLOCK) ON c.FileID = h.FileID and c.RowNum = h.RowNum and c.PaymentTypeID = 1 --Debit card transaction
