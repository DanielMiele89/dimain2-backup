...
-- Amended for perf lift CJM/JEA 20180711
-- =============================================
CREATE PROCEDURE [gas].[CTLoad_MIDINewCombo_SuggestBrands]
...
BEGIN
	...
	FROM (
		   ...
		   INNER LOOP JOIN Staging.BrandMatch bm -- CJM 20180711
	...
	AND NOT EXISTS (SELECT 1 FROM Staging.CTLoad_MIDINewCombo_PossibleBrands p WHERE p.ComboID = m.ID AND p.SuggestedBrandID = C.BrandID)
