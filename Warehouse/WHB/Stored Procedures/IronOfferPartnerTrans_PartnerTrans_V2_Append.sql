...
Jason Shipp 01/04/2020
	...
	ChrisM mod Query 28 for perf, index rebuilds on Relational.PartnerTrans
******************************************************************************/

CREATE PROCEDURE [WHB].[IronOfferPartnerTrans_PartnerTrans_V2_Append]
AS
BEGIN
	...
	BEGIN TRY
		...
		*/	
		...
		from	staging.PartnerTrans pt WITH (TABLOCK)
