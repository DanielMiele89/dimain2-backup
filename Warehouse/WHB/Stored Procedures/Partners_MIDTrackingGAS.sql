...
CREATE PROCEDURE [WHB].[Partners_MIDTrackingGAS]
as
	Begin
...
DECLARE @ERROR_NUMBER INT, @ERROR_SEVERITY INT, @ERROR_STATE INT, @ERROR_PROCEDURE VARCHAR(100), @ERROR_LINE INT, @ERROR_MESSAGE VARCHAR(200);
	...
	Create Index CIX_SLCReportMatch_RetailOutletMID On #SLC_Report_Match (RetailOutletID, MerchantID)
	...
	--------------------------------------------------------------------------------------------------------------------
		...
		-------------------------------------------------------------------------------------
			...
			CREATE CLUSTERED INDEX CIX_MID ON #MissingMID_Join (MID_GAS)
