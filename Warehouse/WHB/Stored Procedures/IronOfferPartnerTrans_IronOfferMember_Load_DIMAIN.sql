...
CREATE PROCEDURE [WHB].[IronOfferPartnerTrans_IronOfferMember_Load_DIMAIN] (	@ImportStartDate DATETIME
...
BEGIN
	...
	IF (SELECT GETDATE()) < '2021-12-03' RETURN

	--DECLARE @ImportStartDate DATE = '2020-12-19'
	...
	*******************************************************************************************************************************************/
		...
		***********************************************************************************************************************/
			...
			*******************************************************************************************************************/
				...
				SELECT @Msg = 'Created #RelationalIOM Table - All Relational memberships with NULL EndDates'
				EXEC [dbo].[oo_TimerMessageV2] @Msg, @Time OUTPUT, @SSMS OUTPUT
				...
				SELECT @Msg = 'Created #IronOffer_Dates Table - All offers with NULL membership EndDates'
				EXEC [dbo].[oo_TimerMessageV2] @Msg, @Time OUTPUT, @SSMS OUTPUT
				...
				SELECT @Msg = 'Created #SLCIOM Table - All SLC_Report memberships with NULL EndDates'
				EXEC [dbo].[oo_TimerMessageV2] @Msg, @Time OUTPUT, @SSMS OUTPUT
			...
			*******************************************************************************************************************/
				...
				SELECT @msg = 'Loaded ' + CONVERT(VARCHAR(10), @RowCount) + ' rows with EndDates requiring updates in [Relational].[IronOfferMember]'
				EXEC [dbo].[oo_TimerMessageV2] @Msg, @Time OUTPUT, @SSMS OUTPUT
				PRINT CHAR(10)
