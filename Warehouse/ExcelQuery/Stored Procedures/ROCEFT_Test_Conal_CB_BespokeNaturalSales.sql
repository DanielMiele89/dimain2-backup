...
-- Description:	<Natural Sales code amended to the custom CC list for Chef & Brewer>
-- =============================================
CREATE PROCEDURE [ExcelQuery].[ROCEFT_Test_Conal_CB_BespokeNaturalSales]
...
SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED;
	...
	INTO	#CC
	FROM	Sandbox.Conal.CB_Custom_CC_Table
