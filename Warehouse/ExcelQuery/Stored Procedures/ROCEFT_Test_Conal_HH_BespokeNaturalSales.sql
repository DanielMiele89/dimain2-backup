...
-- Description:	<Natural Sales code amended to the custom CC list for Hungry Horse>
-- =============================================
CREATE PROCEDURE [ExcelQuery].[ROCEFT_Test_Conal_HH_BespokeNaturalSales]
...
SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED;
	...
	INTO	#CC
	FROM	Sandbox.Conal.HH_Custom_CC_Table
