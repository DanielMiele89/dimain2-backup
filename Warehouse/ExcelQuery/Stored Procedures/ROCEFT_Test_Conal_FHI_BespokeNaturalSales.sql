...
-- Description:	<Natural Sales code amended to the custom CC list for Farmhouse Inns>
-- =============================================
CREATE PROCEDURE [ExcelQuery].[ROCEFT_Test_Conal_FHI_BespokeNaturalSales]
...
SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED;
	...
	INTO	#CC
	FROM	Sandbox.Conal.FHI_Custom_CC_Table
