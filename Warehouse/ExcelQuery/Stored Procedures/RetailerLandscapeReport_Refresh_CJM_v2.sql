CREATE PROCEDURE [ExcelQuery].[RetailerLandscapeReport_Refresh_CJM_v2]
AS
/*
...
-- ====================================================================================
INSERT INTO #ConsumerTransaction_MyRewards_Rollup (TranDate, BrandID, IsOnline, IsReturn, Sales, Transactions)
...
INSERT INTO #ConsumerTransaction_Rollup (TranDate, BrandID, IsOnline, IsReturn, Sales, Transactions)
SELECT TranDate, BrandID, IsOnline, IsReturn, SUM(CT.Sales) AS Sales, SUM(Transactions) AS Transactions
FROM ( -- 130,732,814 rows
	SELECT ct.ConsumerCombinationID, ct.TranDate, ct.IsOnline, x.IsReturn,
		SUM(ct.Amount) AS Sales,
