...
-- ===================================================================================
CREATE PROCEDURE [ExcelQuery].[ROCEFT_DecayRate_v2]
AS
BEGIN
	...
	CREATE CLUSTERED INDEX cix_CINID ON Warehouse.Prototype.RandomBase(CINID)
	CREATE NONCLUSTERED INDEX nix_CINID ON Warehouse.Prototype.RandomBase(CINID)
