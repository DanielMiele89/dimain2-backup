-- =============================================
-- Author:		<Sam W>
-- Create date: <07th July 2020>
-- Description:	<Manchester Picadilly Store Specific for Morrisons>
-- updated dates to reflect late 2020 transactions
-- =============================================
CREATE PROCEDURE [ExcelQuery].[ROCEFT_TEST_NaturalSalesByCycle_Calculate_Morrisons_ManchesterPicadilly]
