...
-- =============================================
CREATE PROCEDURE [ExcelQuery].[ROCEFT_TEST_NaturalSalesByCycle_ByronKensingtonSales]
...
BEGIN
	...
	WHERE CC.ConsumerCombinationID IN (SELECT ConsumerCombinationID FROM Sandbox.SamW.KensingtonStoreCCs)
