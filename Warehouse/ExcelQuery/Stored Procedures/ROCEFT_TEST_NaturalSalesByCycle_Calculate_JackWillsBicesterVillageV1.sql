...
-- Description:	<Incentivised Mids of Jack Will Bicester Village SelectionV1>
-- =============================================
CREATE PROCEDURE [ExcelQuery].[ROCEFT_TEST_NaturalSalesByCycle_Calculate_JackWillsBicesterVillageV1] 
...
DECLARE @time DATETIME
	...
	INTO	#CC
	FROM	Sandbox.SamW.Jack_Wills_Incentivised_Mids_20190627 cc
