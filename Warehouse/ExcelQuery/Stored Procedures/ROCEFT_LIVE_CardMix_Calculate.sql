...
-- =============================================
CREATE PROCEDURE [ExcelQuery].[ROCEFT_LIVE_CardMix_Calculate]
AS
BEGIN
	SET NOCOUNT ON;
	...
	EXEC Prototype.oo_TimerMessage 'ROCEFT - Card Mix -- Start', @time OUTPUT
	...
	EXEC Prototype.oo_TimerMessage 'ROCEFT - Card Mix -- End', @time OUTPUT
