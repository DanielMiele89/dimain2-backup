...
-- Description:	<Incentivised Mids of Sunglass Hut Natural Sales Selection>
-- =============================================
CREATE PROCEDURE [ExcelQuery].[ROCEFT_TEST_NaturalSalesByCycle_Calculate_SunGlassHut] 
...
DECLARE @time DATETIME
	...
	INTO	#CC
	FROM	Sandbox.SamW.Sunglass_Hut_Incentivised_Mids_20190605 cc
