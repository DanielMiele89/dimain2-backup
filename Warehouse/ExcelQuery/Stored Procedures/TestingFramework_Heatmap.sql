...
/*=================================================================================================
Author: Shaun H
Purpose: Find the heatmap index for a given brand & population
=================================================================================================*/

CREATE PROCEDURE [ExcelQuery].[TestingFramework_Heatmap] 
...
BEGIN
	...
	WHERE			b.brandid = @brandname

	SELECT			distinct p.id
					,case 
						when Index_RR is null then 100
						else Index_RR
					end as heatmap
	FROM			#Population p
