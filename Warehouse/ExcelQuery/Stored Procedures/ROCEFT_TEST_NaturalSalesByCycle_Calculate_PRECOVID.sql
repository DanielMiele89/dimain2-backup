-- =============================================
-- Author:		<Sam Weber>
-- Create date: <28th April 2020>
-- Description:	<Looking at spend pre COVID-19 TO SEE HOW SHOPPER BEHAVIOUR WAS TO FORECAST>
-- =============================================
CREATE PROCEDURE [ExcelQuery].[ROCEFT_TEST_NaturalSalesByCycle_Calculate_PRECOVID]
...
BEGIN
	...
	FROM	(SELECT	*
			 FROM	#Dates 
			 WHERE	CycleStart <= '2020-02-29'
				AND '2020-02-29' <= CycleEnd) a
	JOIN	#Dates b
		ON  a.ID - 15 < b.ID
		AND b.ID < a.ID
