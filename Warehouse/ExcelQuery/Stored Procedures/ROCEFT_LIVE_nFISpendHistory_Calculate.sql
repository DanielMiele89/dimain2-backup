...
-- =============================================
CREATE PROCEDURE [ExcelQuery].[ROCEFT_LIVE_nFISpendHistory_Calculate]
AS
BEGIN
	SET NOCOUNT ON;
	...
	EXEC Prototype.oo_TimerMessage 'ROCEFT - nFISpendHistory -- Start', @time OUTPUT
	...
	EXEC Prototype.oo_TimerMessage 'ROCEFT - nFISpendHistory -- End', @time OUTPUT
