CREATE PROCEDURE [ExcelQuery].[Demographics_MonthlyRefresh]
as
...
BEGIN TRY
	...
	*/
	...
	CREATE COLUMNSTORE INDEX csx_Stuff ON #MyRewards_CustomerBase (CINID, FanID, Social_Class, AgeCurrentBandText, Region)
...
EXEC Prototype.oo_TimerMessage_V2 'Script -- #Union_MyRewards', @RowsAffected, @time OUTPUT
	...
	*/
	...
	IF OBJECT_ID('Warehouse.InsightArchive.Tableau_Data_Main_Table_DEMOGRAPHICS') IS NOT NULL DROP TABLE Warehouse.InsightArchive.Tableau_Data_Main_Table_DEMOGRAPHICS
	...
	SELECT [Year], [Month], BrandID, 
		...
		Transactions,
		Customers
	INTO Warehouse.InsightArchive.Tableau_Data_Main_Table_DEMOGRAPHICS FROM #OUTPUT_AGE WHERE 0 = 1




	INSERT INTO Warehouse.InsightArchive.Tableau_Data_Main_Table_DEMOGRAPHICS 
