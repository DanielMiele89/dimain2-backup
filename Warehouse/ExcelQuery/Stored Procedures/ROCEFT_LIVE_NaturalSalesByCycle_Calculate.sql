...
-- CJM 12/08/2021 commented out index drop / create
-- =============================================
CREATE PROCEDURE [ExcelQuery].[ROCEFT_LIVE_NaturalSalesByCycle_Calculate]
...
---------------------------------------------------------------------------------------------
	...
	WHILE @i <= 14 BEGIN -- ######################################################################################## LOOP START
		...
		CREATE CLUSTERED INDEX cix_Brand_CINID ON #CinTrans (BrandID, CINID, TranDate) -- CJM 12/08/2021 added Trandate
		...
		IF @i < 14 BEGIN  -- ########################################## BLOCK START
			...
			--DROP INDEX cix_BrandID_CINID ON #InitialSegmentation CJM 12/08/2012
			...
			--CREATE CLUSTERED INDEX cix_BrandID_CINID ON #InitialSegmentation (BrandID,CINID) CJM 12/08/2012
