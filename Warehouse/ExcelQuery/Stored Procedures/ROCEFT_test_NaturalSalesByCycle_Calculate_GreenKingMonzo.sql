...
-- =============================================
CREATE PROCEDURE [ExcelQuery].[ROCEFT_test_NaturalSalesByCycle_Calculate_GreenKingMonzo]
...
BEGIN
	...
	SELECT    2418 as brandid, ConsumerCombinationID
	INTO    #CC
	FROM    Warehouse.Relational.ConsumerCombination CC
	WHERE    MID IN (SELECT MID FROM Sandbox.Conal.Green_King_MIDs_Darroch_15112019_Unique)
