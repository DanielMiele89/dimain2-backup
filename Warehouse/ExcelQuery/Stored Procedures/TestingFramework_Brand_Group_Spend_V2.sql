...
create PROCEDURE [ExcelQuery].[TestingFramework_Brand_Group_Spend_V2]	
...
BEGIN
	...
	EXEC('
		...
		Select @brandgroupname = BrandGroup from Sandbox.Shaun.Selected_BrandGroups_Final where brandid = ''' + @brandid + '''
