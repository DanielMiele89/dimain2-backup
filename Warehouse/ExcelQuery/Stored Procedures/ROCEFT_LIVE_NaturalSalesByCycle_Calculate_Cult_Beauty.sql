-- =============================================
-- Author:		<Sam Weber>
-- Create date: <03rd February 2020>
-- Description:	<Looking at only Incentivised MIDs for Cult Beauty>
-- =============================================
CREATE PROCEDURE [ExcelQuery].[ROCEFT_LIVE_NaturalSalesByCycle_Calculate_Cult_Beauty]
...
BEGIN
	...
	WHERE MID NOT LIKE  '%VCR1861024613%'
	AND MID NOT LIKE '%154215314095939%'
	AND MID NOT LIKE '%101400000000371%'
