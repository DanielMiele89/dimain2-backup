...
-- =============================================
CREATE PROCEDURE [ExcelQuery].[ROCEFT_RefreshAllTables_Quarter]
	(
		@BrandID INT
	)    
AS
IF @BrandID IS NOT NULL
	BEGIN
		PRINT 'This code cannot be used for a single brand'
		RETURN
	END 
ELSE
	BEGIN
		...
		EXEC Warehouse.ExcelQuery.ROCEFT_NaturalSales_Calculate @BrandID					
		...
		EXEC Warehouse.ExcelQuery.ROCEFT_nFISpendHistory_Calculate					
