...
-- Description:	Retrieves Halfords top-up transactions
-- =============================================
CREATE PROCEDURE [APW].[SchemeTrans_WeekSum_HalfordsExtra_Fetch] 
(@EndDate DATE)	
AS
BEGIN
	...
	WHERE pt.TransactionDate > @EndDate
	AND COALESCE(alt.AlternatePartnerID, pt.PartnerID) = 2396
