...
-- =============================================
CREATE PROCEDURE [Prototype].[CampaignAnalysis_Profiling_Gabor]
	(
...
--DROP TABLE Warehouse.InsightArchive.CampaignAnalysis_Profiling

	--CREATE TABLE Warehouse.InsightArchive.CampaignAnalysis_Profiling
	--(	Gender VARCHAR(100),
...
INSERT INTO Warehouse.InsightArchive.CampaignAnalysis_Profiling
	SELECT
	  Gender,
	  Age_Group,
	  Region,
...
--select * from  Warehouse.InsightArchive.CampaignAnalysis_Profiling