...
-- *****************************************************************************************************
CREATE PROCEDURE [Prototype].[SSRS_R0080_Unbranded_BrandSuggestions_SingleBrand](
			@BrandIDs INT)
...
INSERT INTO [Prototype].[SSRS_R0080_Unbranded_BrandSuggestions]	
...
LEFT OUTER JOIN [Prototype].[SSRS_R0080_Unbranded_CCsToBeExcluded] u
...
--EXEC [Prototype].[SSRS_R0080_Unbranded_BrandSuggestions_SingleBrand] '379'