...
Create Procedure [Prototype].[GenerateHeatmapIndex_SingleBrand] (@BrandID Int)
as
Begin

	/*******************************************************************************************************************************************
		1. Insert any HeatmapCombinations that may be missing to Prototype.HeatmapCombinations
	*******************************************************************************************************************************************/
		...
		***********************************************************************************************************************/
			...
			Insert Into Prototype.HeatmapCombinations
			Select cc.Gender
				 , cc.HeatmapAgeGroup
			...
			Where Not Exists (Select 1
							  From Prototype.HeatmapCombinations hmc
	...
	*******************************************************************************************************************************************/
		...
		Left join Prototype.HeatmapCombinations hmc
	...
	*******************************************************************************************************************************************/
		...
		If Exists (Select 1 From Prototype.HeatmapScore Where BrandID = @BrandID)
			Begin
				Delete
				From Prototype.HeatmapScore
				Where BrandID = @BrandID
			End
	...
	*******************************************************************************************************************************************/
		...
		Insert into Prototype.HeatmapScore
