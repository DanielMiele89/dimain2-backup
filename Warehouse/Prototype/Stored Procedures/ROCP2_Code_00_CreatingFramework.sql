...
***************************************************************************/
CREATE PROCEDURE [Prototype].[ROCP2_Code_00_CreatingFramework]
AS
BEGIN
...
WHERE SectorID IN	(
		...
		WHERE	SectorGroupID IN (1,2)
			AND SectorName NOT IN ('Gambling','Utilities','Sports And Clubs')
			)
...
values ('Quidco',1,12)
,      ('Next Jump',2,145)
,      ('Easy Fundraising',3,143)
,      ('Student Money Saver',4,NULL)
,      ('Karrot',5,144)
,      ('R4G',6,12)                                ---- Name, PublisherNo, CLUBID
...
FROM	(
	SELECT	ToDate,
		...
		Added_Cardholders
	FROM MI.ActivationsProjections_Weekly_EFR
UNION ALL
	SELECT	ToDate,
		Publisher,
		Cumulative_Cardholders,
		Added_Cardholders
	FROM MI.ActivationsProjections_Weekly_NJ
UNION ALL 
	SELECT	ToDate,
		Publisher,
		Cumulative_Cardholders,
		Added_Cardholders
	FROM MI.ActivationsProjections_Weekly_Karrot
UNION ALL 
	SELECT	ToDate,
		'Student Money Saver' as Publisher,
		Cumulative_Cardholders,
		Added_Cardholders
	FROM MI.ActivationsProjections_Weekly_SMS
UNION ALL 
	SELECT	ToDate,
		'Quidco' as Publisher,
		Cumulative_Cardholders,
		Added_Cardholders
	FROM MI.ActivationsProjections_Weekly_PureQuidco
UNION ALL 
	SELECT	ToDate,
		'R4G' as Publisher,
		Cumulative_Cardholders,
		Added_Cardholders
	FROM MI.ActivationsProjections_Weekly_R4G
