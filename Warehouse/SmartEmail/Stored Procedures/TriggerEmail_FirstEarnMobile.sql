...
/********************************************************************************************************************************
	...
	Auth:	Rory Francis
	Name:	[SmartEmail].[TriggerEmail_FirstEarnMobile]
	Desc:	Fetch customers who have earnt on the Mobile Login Offer for the first time

	Change History:

********************************************************************************************************************************/

CREATE PROCEDURE [SmartEmail].[TriggerEmail_FirstEarnMobile] 
...
*******************************************************************************************************************************************/
	...
	WHERE edy.FirstEarnDate = @Yesterday
	AND edy.EarnType = 'Mobile Login'
	AND NOT EXISTS (	SELECT 1
						...
						AND ed_all.FirstEarnDate < @Yesterday
						AND ed_all.EarnType = 'Mobile Login')
...
*******************************************************************************************************************************************/
	...
	SELECT	FanID
		,	CASE
				...
				ELSE NULL
			END AS ToUpload
		,	'Mobile Login' AS FirstEarnType
		,	@Yesterday AS FirstEarnDate
	FROM #CustomersToEmail
