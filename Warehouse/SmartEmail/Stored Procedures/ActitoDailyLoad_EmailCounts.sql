...
CREATE PROCEDURE [SmartEmail].[ActitoDailyLoad_EmailCounts]
AS
BEGIN
	Set NOCount ON;
...
*******************************************************************************************************************************************/
	...
	***************************************************************************************************************************************/
		...
		FROM [SmartEmail].[Actito_Deltas] ad
	...
	--	FROM [SmartEmail].[Actito_Deltas] ad
	--	WHERE ad.FirstEarn_Date > '1900-01-01'
	--	AND ad.Email LIKE 'VirginSample%@rewardinsight.com'
...
*******************************************************************************************************************************************/
		...
		Exec msdb..sp_send_dbmail 
			...
			@subject = 'Actito File Count - MyRewards',
