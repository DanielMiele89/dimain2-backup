...
CREATE PROCEDURE [SmartEmail].[NewsletterValidation] (	@Tablename VARCHAR(150)
													,	@RunID INT
													,	@aLionSendID INT)
AS
BEGIN
...
*******************************************************************************************************************************************/
	...
	***********************************************************************************************************************/
		...
		*******************************************************************************/
		...
		IF OBJECT_ID(''tempdb..##NewsletterValidation_RBS'') IS NOT NULL DROP TABLE ##NewsletterValidation_RBS
		...
		INTO ##NewsletterValidation_RBS
		FROM ' + @TableName

		EXEC (@Qry)

		CREATE CLUSTERED INDEX CIX_SmartFocusAssessment_FanID ON ##NewsletterValidation_RBS (FanID)
	...
	***********************************************************************************************************************/
		...
		FROM ##NewsletterValidation_RBS osd
	...
	***********************************************************************************************************************/
		...
		WHERE EXISTS (	SELECT 1
						FROM ##NewsletterValidation_RBS sfa
...
*******************************************************************************************************************************************/
	...
	INSERT INTO [SmartEmail].[PostSFDUploadValidation_DataChecks] (noRows
															 ...
															 , SmartEmail
															 , LionSendID)
	Select (Select Count(Distinct FanID) FROM ##NewsletterValidation_RBS) AS Rows
...
*******************************************************************************************************************************************/
	...
	***********************************************************************************************************************/
	...
	/***********************************************************************************************************************
		3.6. Is the customer now deceased?
	***********************************************************************************************************************/
	...
	/***********************************************************************************************************************
		3.7. Is the Is Loyalty flag correct?
	***********************************************************************************************************************/
	...
	/***********************************************************************************************************************
		3.8. Are all the right Earn Offers listed with the correct start & end dates?
	***********************************************************************************************************************/
	...
	/***********************************************************************************************************************
		3.9. Are all the right Burn Offers listed?
	***********************************************************************************************************************/
...
*******************************************************************************************************************************************/
	...
	Set isAngela = (Select Count(1) FROM ##NewsletterValidation_RBS Where FanID In (1923715,1923714))
	  , isMarianneRBS = (Select Count(1) FROM ##NewsletterValidation_RBS Where FanID In (5698997))
	  , isMariannePersonal = (Select Count(1) FROM ##NewsletterValidation_RBS Where FanID In (18412563))
	  , RunDateTime = GetDate()
