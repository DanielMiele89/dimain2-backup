...
*/
CREATE Procedure [SmartEmail].[OfferSlotDataUpdate] (@LSID int, @EmailDate date)
...
--------------------------------------------------------------------------------------------
-----------------------------Empty the table with the Offer Data----------------------------
--------------------------------------------------------------------------------------------

--*****Truncate Table Sandbox.Stuart.[OfferSlotData] -- Test Table
Truncate Table SmartEmail.[OfferSlotData] -- Real Table

--------------------------------------------------------------------------------------------
---------------------------------Loop round to pull memberships-----------------------------
--------------------------------------------------------------------------------------------

Declare @RowNo int = 1, @RowNoMax int, @Chunksize int = 750000
...
Begin
	...
	Insert into [SmartEmail].[OfferSlotData] -- Real Table
				--Sandbox.Stuart.[OfferSlotData] -- Test Table
...
--Select Count(Distinct CompositeID)
--From #OfferDates