...
CREATE procedure [SmartEmail].[PostSFDUploadValidation_V5_SmartEmail] (@Tablename VarChar(150)
																	, @RunID Int
																	, @aLionSendID Int)
as
Begin
...
Select Convert(Int, FanID) as FanID
	 ...
	 , Convert(Date, Offer1StartDate, 105) as Offer1StartDate
	 , Convert(Date, Offer2StartDate, 105) as Offer2StartDate
	 , Convert(Date, Offer3StartDate, 105) as Offer3StartDate
	 , Convert(Date, Offer4StartDate, 105) as Offer4StartDate
	 , Convert(Date, Offer5StartDate, 105) as Offer5StartDate
	 , Convert(Date, Offer6StartDate, 105) as Offer6StartDate
	 , Convert(Date, Offer7StartDate, 105) as Offer7StartDate
	 , Convert(Date, Offer1EndDate, 105) as Offer1EndDate
	 , Convert(Date, Offer2EndDate, 105) as Offer2EndDate
	 , Convert(Date, Offer3EndDate, 105) as Offer3EndDate
	 , Convert(Date, Offer4EndDate, 105) as Offer4EndDate
	 , Convert(Date, Offer5EndDate, 105) as Offer5EndDate
	 , Convert(Date, Offer6EndDate, 105) as Offer6EndDate
	 , Convert(Date, Offer7EndDate, 105) as Offer7EndDate
