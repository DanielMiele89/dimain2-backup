...
CREATE PROCEDURE [SmartEmail].[SFDDailyData_E2E_Testing]
...
Select	--top (100000 )
		f.ID as FanID,
		Cast(f.ID as Varchar(15))+'@rewardinsight.com' as Email,
		--f.Email,
		Cast(f.ID as Varchar(15))	AS [FirstName],
		'Test' as [LastName],
...
--	f.ActivationChannel,
	...
	ltv.DDEarning+ltv.DPOSEarning+ltv.CPOSEarning+ltv.OtherEarning as LVTotalEarnings,
	...
	ltv.DDEarning,
	ltv.OtherEarning,
	ltv.CurrentAnniversaryEarning,
	ltv.PreviousAnniversaryEarning,
	0 as LvEAYBEarning,
	Case
