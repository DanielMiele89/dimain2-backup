...
CREATE Procedure [SmartEmail].[PostSFDUploadValidation_RP_4_SendEmail]
	...
	Set NoCount On;
		...
		*******************************************************************************************************************************************/
			...
			***********************************************************************************************************************/
				...
				Set @CustomersToExclude = 'The validation has been completed And there are # customers to exclude – the file is attached.'

				-- Customers that have hardbounced but are included in the LionSend, # Replaced with customer Count
				Set @HardbouncedCustomers = 'There are currently # customers that meet the requirements for the redemption push but have Hardbounced without receiving any emails since. This is due to the Hardbounce flag not being updated exactly.'
		...
		*******************************************************************************************************************************************/
			...
			Set @HardbouncedCustomers = '<p>' + Replace(@HardbouncedCustomers, '#', (Select Count(Distinct FanID) From SmartEmail.PostSFDUploadValidation_HardbouncedFansIncInLionSend)) + '</p>'
		...
		*******************************************************************************************************************************************/
			...
			***********************************************************************************************************************/
				...
				Set @Table2 = '<br />'
							...
							+ '<tr>'
							+ '<th colspan=2>Reason customer should be excluded from redemption push</th>'
							+ '</tr><tr>'
			...
			***********************************************************************************************************************/
				...
				Set @Table3 = '<p>There are <b>' + (Select Convert(VarChar, Count(Distinct FanID)) From SmartEmail.PostSFDUploadValidation_FansMissingFromExtract) + '</b> customers that meet the requirements for the redemption push but were not included in the extract</p>'
							+ '<table style="border-collapse: collapse; border: 1px solid black">'															
							+ '<tr>'																														
