CREATE TABLE [SmartEmail].[DailyData_V2] (
    ...
    [Reward30_FirstEarnDD]         VARCHAR (30)  NULL,
    [Reward30_FirstEarnMobile]     VARCHAR (30)  NULL,
    [Reward30_MobileDormancy]      BIT           NULL,
    ...
    CONSTRAINT [PK_DailyData_V2] PRIMARY KEY CLUSTERED ([FanID] ASC)
);
