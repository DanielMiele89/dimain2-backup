CREATE TABLE [SmartEmail].[DailyData_PreviousDay] (
    ...
    CONSTRAINT [PK_DailyData_PreviousDay] PRIMARY KEY CLUSTERED ([FanID] ASC) WITH (FILLFACTOR = 90, DATA_COMPRESSION = PAGE)
);
