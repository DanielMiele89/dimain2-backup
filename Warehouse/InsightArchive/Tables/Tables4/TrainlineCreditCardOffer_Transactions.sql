CREATE TABLE [InsightArchive].[TrainlineCreditCardOffer_Transactions] (
    [FileID]                                  INT           NULL,
    [RowNum]                                  INT           NULL,
...
GO
CREATE CLUSTERED INDEX [cix_TrainlineCreditCardOffer_Transactions_PanID]
    ON [InsightArchive].[TrainlineCreditCardOffer_Transactions]([PanID] ASC);
