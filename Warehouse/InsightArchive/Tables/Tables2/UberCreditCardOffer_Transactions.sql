CREATE TABLE [InsightArchive].[UberCreditCardOffer_Transactions] (
    [FileID]                                  INT           NULL,
    [RowNum]                                  INT           NULL,
...
GO
CREATE CLUSTERED INDEX [cix_UberCreditCardOffer_Transactions_PanID]
    ON [InsightArchive].[UberCreditCardOffer_Transactions]([PanID] ASC);
