CREATE TABLE [InsightArchive].[RBSG_StatementDM_20170223] (
...
GO
CREATE CLUSTERED INDEX [cix_RBSG_StatementDM_20170223_RewardCustomerID]
    ON [InsightArchive].[RBSG_StatementDM_20170223]([RewardCustomerID] ASC);


GO
DENY SELECT
    ON OBJECT::[InsightArchive].[RBSG_StatementDM_20170223] TO [New_PIIRemoved]
    AS [dbo];
