CREATE TABLE [InsightArchive].[DecemberCreditCard_Transactions] (
    [FileID]                                  INT           NOT NULL,
    [RowNum]                                  INT           NOT NULL,
...
GO
CREATE CLUSTERED INDEX [cix_DecemberCreditCard_Transactions_PanID]
    ON [InsightArchive].[DecemberCreditCard_Transactions]([PanID] ASC);
