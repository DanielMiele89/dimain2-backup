CREATE TABLE [InsightArchive].[CBP_Credit_TransactionHistory_August2017] (
    [FileID]                                  INT           NOT NULL,
    [RowNum]                                  INT           NOT NULL,
...
GO
CREATE NONCLUSTERED INDEX [CBP_Credit_TransactionHistory_August2017]
    ON [InsightArchive].[CBP_Credit_TransactionHistory_August2017]([MerchantID] ASC) WITH (FILLFACTOR = 90, DATA_COMPRESSION = PAGE);


GO
CREATE CLUSTERED INDEX [cix_CBP_Credit_TransactionHistory_July2017_MerchantID]
    ON [InsightArchive].[CBP_Credit_TransactionHistory_August2017]([MerchantID] ASC) WITH (FILLFACTOR = 90, DATA_COMPRESSION = PAGE);
