CREATE TABLE [InsightArchive].[AirbnbCreditCardOffer_Transactions] (
    [FileID]                                  INT           NULL,
    [RowNum]                                  INT           NULL,
...
GO
CREATE CLUSTERED INDEX [cix_AirbnbCreditCardOffer_Transactions_PanID]
    ON [InsightArchive].[AirbnbCreditCardOffer_Transactions]([PanID] ASC);
