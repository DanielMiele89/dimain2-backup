CREATE TABLE [InsightArchive].[MyRewardsDataHashed_20190304] (
    [FanID]                     INT           NOT NULL,
...
CREATE CLUSTERED INDEX [IDX_MyRewardsDataHashed_FanID]
    ON [InsightArchive].[MyRewardsDataHashed_20190304]([FanID] ASC) WITH (FILLFACTOR = 90, DATA_COMPRESSION = PAGE);
