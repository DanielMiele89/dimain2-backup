CREATE TABLE [InsightArchive].[NovemberCreditCardOffer_Transactions2] (
    [FileID]                                  INT           NULL,
    [RowNum]                                  INT           NULL,
...
GO
CREATE CLUSTERED INDEX [cix_NovemberCreditCardOffer_Transactions_PanID]
    ON [InsightArchive].[NovemberCreditCardOffer_Transactions2]([PanID] ASC);
