CREATE TABLE [InsightArchive].[AmazonCreditCardOffer_Transactions] (
    [FileID]                                  INT           NULL,
    [RowNum]                                  INT           NULL,
...
GO
CREATE CLUSTERED INDEX [cix_AmazonCreditCardOffer_Transactions_FanID]
    ON [InsightArchive].[AmazonCreditCardOffer_Transactions]([FanID] ASC);
