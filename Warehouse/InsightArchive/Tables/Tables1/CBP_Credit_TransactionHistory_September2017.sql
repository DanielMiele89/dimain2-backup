CREATE TABLE [InsightArchive].[CBP_Credit_TransactionHistory_September2017] (
    [FileID]                                  INT           NOT NULL,
    [RowNum]                                  INT           NOT NULL,
...
GO
CREATE NONCLUSTERED INDEX [CBP_Credit_TransactionHistory_September2017]
    ON [InsightArchive].[CBP_Credit_TransactionHistory_September2017]([MerchantID] ASC) WITH (FILLFACTOR = 90, DATA_COMPRESSION = PAGE)
