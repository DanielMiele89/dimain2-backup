CREATE TABLE [InsightArchive].[CBP_Credit_TransactionHistory_November2017] (
    [FileID]                                  INT           NOT NULL,
    [RowNum]                                  INT           NOT NULL,
...
GO
CREATE NONCLUSTERED INDEX [CBP_Credit_TransactionHistory_November2017]
    ON [InsightArchive].[CBP_Credit_TransactionHistory_November2017]([MerchantID] ASC) WITH (DATA_COMPRESSION = PAGE)
