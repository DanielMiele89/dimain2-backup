CREATE TABLE [InsightArchive].[DecemberCreditCardOffer_Transactions_Less30] (
    [FileID]                                  INT           NOT NULL,
    [RowNum]                                  INT           NOT NULL,
...
GO
CREATE CLUSTERED INDEX [cix_ArgosCreditCardOffer_Transactions_PanID]
    ON [InsightArchive].[DecemberCreditCardOffer_Transactions_Less30]([PanID] ASC);
