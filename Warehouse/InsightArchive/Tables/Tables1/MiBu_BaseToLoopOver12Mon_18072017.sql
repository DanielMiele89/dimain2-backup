CREATE TABLE [InsightArchive].[MiBu_BaseToLoopOver12Mon_18072017] (
    [FanID]             INT           NOT NULL,
    [cinid]             INT           NOT NULL,
    [Gender]            CHAR (1)      NULL,
...
CREATE CLUSTERED INDEX [C_INX]
    ON [InsightArchive].[MiBu_BaseToLoopOver12Mon_18072017]([cinid] ASC) WITH (FILLFACTOR = 90, DATA_COMPRESSION = PAGE);
