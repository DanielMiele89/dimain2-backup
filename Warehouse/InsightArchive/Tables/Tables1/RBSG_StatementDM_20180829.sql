CREATE TABLE [InsightArchive].[RBSG_StatementDM_20180829] (
    ...
    [lvtotalearnings]      SMALLMONEY    NULL,
    [TypeID]               INT           NULL
);
...
GO
DENY SELECT
    ON OBJECT::[InsightArchive].[RBSG_StatementDM_20180829] TO [New_PIIRemoved]
    AS [dbo];
