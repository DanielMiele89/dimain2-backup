...
-- =============================================
CREATE PROCEDURE [InsightArchive].[TestCustomers_CoreMonth_Fetch] 
	(
		@DateID INT
	)
AS
BEGIN
	...
	CROSS JOIN (SELECT PartnerID, ClientServicesref FROM MI.WorkingCumlDates WHERE Cumlitivetype = 2 AND ClientServicesref = '0') wcd
