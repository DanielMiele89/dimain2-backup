-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-02-22>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.WA184_PreSelection_sProcASBEGIN
...
Declare @MainBrand smallint = 485	 -- Main Brand	
	...
	from 
		...
		)xIf Object_ID('Warehouse.Selections.WA184_PreSelection') Is Not Null Drop Table Warehouse.Selections.WA184_PreSelectionSelect FanIDInto Warehouse.Selections.WA184_PreSelectionFrom Warehouse.Selections.PreSelectionWhere Flag = 'Cell 07.40-50%'AND Flag2 = 'Cell 04.10-100% - OPTIMISED!'END