-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-02-20>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.WL026_PreSelection_sProcASBEGINIF OBJECT_ID('tempdb..#FB') IS NOT NULL DROP TABLE #FB
SELECT	CINID
		,FanID
		,AgeCurrent
INTO #FB
...
If Object_ID('Warehouse.Selections.WL026_PreSelection') Is Not Null Drop Table Warehouse.Selections.WL026_PreSelectionSelect FanIDInto Warehouse.Selections.WL026_PreSelection
FROM	#FB
