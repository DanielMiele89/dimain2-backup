-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-03-22>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.BTS008_PreSelection_sProcASBEGIN
...
CREATE UNIQUE CLUSTERED INDEX CIX_FanID ON #Customers (FanID)If Object_ID('Warehouse.Selections.BTS008_PreSelection') Is Not Null Drop Table Warehouse.Selections.BTS008_PreSelectionSelect FanIDInto Warehouse.Selections.BTS008_PreSelectionFROM  #CUSTOMERSEND