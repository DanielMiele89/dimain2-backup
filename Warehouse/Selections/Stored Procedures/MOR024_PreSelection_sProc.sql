-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-05-02>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.MOR024_PreSelection_sProcASBEGIN
/*
...
LEFT JOIN #ConsumerTransaction_MyRewards ct
	ON cu.CINID = ct.CINIDIf Object_ID('Warehouse.Selections.MOR024_PreSelection') Is Not Null Drop Table Warehouse.Selections.MOR024_PreSelectionSelect FanIDInto Warehouse.Selections.MOR024_PreSelectionFrom #segmentAssignment
WHERE StorePick = 1
