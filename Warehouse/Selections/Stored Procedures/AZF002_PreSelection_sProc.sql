-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-05-15>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE [Selections].[AZF002_PreSelection_sProc]ASBEGIN
		-- Amazon prime: 2704
		-- amazon fresh: 2541
...
or CINID IN (SELECT * FROM #CT_GT1)						If Object_ID('Warehouse.Selections.AZF002_PreSelection') Is Not Null Drop Table Warehouse.Selections.AZF002_PreSelectionSelect FanIDInto Warehouse.Selections.AZF002_PreSelectionFROM Relational.Customer cuWHERE EXISTS (	SELECT 1				FROM [Relational].[CINList] cl				INNER JOIN #final_output fo					ON cl.CINID = fo.CINID				WHERE cu.SourceUID = cl.CIN)END