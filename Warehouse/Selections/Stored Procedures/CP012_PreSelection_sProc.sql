...
CREATE PROCEDURE [Selections].[CP012_PreSelection_sProc]
AS
BEGIN
...
GROUP BY BrandName,ct.CINID
	...
	IF OBJECT_ID('[Warehouse].[Selections].[CP012_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[CP012_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[CP012_PreSelection]
	FROM #FB fb
