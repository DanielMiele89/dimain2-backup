-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-08-07>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.WL016_PreSelection_sProcASBEGIN
...
If Object_ID('Warehouse.Selections.WL016_PreSelection') Is Not Null Drop Table Warehouse.Selections.WL016_PreSelectionSelect FanIDInto Warehouse.Selections.WL016_PreSelectionFROM  SANDBOX.SAMW.WLHTop10290120END