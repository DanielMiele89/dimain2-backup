...
IF OBJECT_ID('[Warehouse].[Selections].[LE031_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[LE031_PreSelection]
SELECT	fb.FanID
INTO [Warehouse].[Selections].[LE031_PreSelection]
FROM #FB fb
