-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-05-04>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.LE009_PreSelection_sProcASBEGIN
...
from (
	...
	union 
	select #ct1.cinid from #ct1 join #ct2 on #ct1.cinid = #ct2.cinid) aIf Object_ID('Warehouse.Selections.LE009_PreSelection') Is Not Null Drop Table Warehouse.Selections.LE009_PreSelectionSelect FanIDInto Warehouse.Selections.LE009_PreSelectionFROM Relational.Customer cuINNER JOIN Relational.CINList cl	ON cu.SourceUID = cl.CINWHERE EXISTS (	SELECT 1				FROM SANDBOX.BASTIENC.LANDSEND le				WHERE cl.CINID = le.CINID)END