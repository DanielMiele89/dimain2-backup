...
CREATE PROCEDURE [Selections].[__CampaignSetup_Selection_Loop_POS_20190909_Archived] @RunType BIT
...
BEGIN
	...
	*******************************************************************************************************************************************/
	...
	/*******************************************************************************************************************************************
		6. Store all CustomerBaseOfferDate memberships
	*******************************************************************************************************************************************/
		...
		IF @RunType = 1
			BEGIN
				...
				--	ON htm.ClientServicesRef = ctr.ClientServicesRef

				--CREATE CLUSTERED INDEX CIX_IronOfferID ON #ExistingUniverseOffers (IronOfferID, CustomerBaseOfferDate)


				--TRUNCATE TABLE Selections.CampaignSetup_ExistingUniverse

				--ALTER INDEX CIX_OfferDateCust ON Selections.CampaignSetup_ExistingUniverse DISABLE

				--INSERT INTO Selections.CampaignSetup_ExistingUniverse
				...
				--ALTER INDEX CIX_OfferDateCust ON Selections.CampaignSetup_ExistingUniverse REBUILD

			EXEC Staging.oo_TimerMessage 'Store offer memberships from existing campaigns', @Time OUTPUT
	...
	*******************************************************************************************************************************************/
		...
		***********************************************************************************************************************/
											...
											EXEC [Selections].[CampaignSetup_Selection_IndividualCampaign_POS_20190909] @PartnerID
																											 , @StartDate
																											 , @EndDate
																											 , @CampaignName
																											 , @ClientServicesRef
