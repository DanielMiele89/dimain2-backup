CREATE PROCEDURE [Selections].[LE035_PreSelection_sProc]
AS
BEGIN
...
IF OBJECT_ID('[Warehouse].[Selections].[LE035_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[LE035_PreSelection]
SELECT	fb.FanID
INTO [Warehouse].[Selections].[LE035_PreSelection]
FROM #FB fb
