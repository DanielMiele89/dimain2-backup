CREATE PROCEDURE [Selections].[LW082_PreSelection_sProc]
AS
BEGIN
...
IF OBJECT_ID('[Warehouse].[Selections].[LW082_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[LW082_PreSelection]
SELECT	fb.FanID
INTO [Warehouse].[Selections].[LW082_PreSelection]
FROM #FB fb
