...
DECLARE @MainBrand smallint = 485	 -- Main Brand	
	...
	FROM 
		...
		FROM	#SegmentIf Object_ID('Warehouse.Selections.WA225_PreSelection') Is Not Null Drop Table Warehouse.Selections.WA225_PreSelectionSelect FanIDInto Warehouse.Selections.WA225_PreSelectionFROM Sandbox.Conal.Waitrose_Optimised_5_plusEND