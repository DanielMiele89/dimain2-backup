-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-06-14>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.CH020_PreSelection_sProcASBEGIN	declare @CB int = 1950
	...
	on	cl.CINID = b.CINID
			...
			-- Comp Acq
			if OBJECT_ID('Sandbox.Conal.ChefAndBrewer_CompAcq') is not null drop table Sandbox.Conal.ChefAndBrewer_CompAcq
			select	 CINID
					, FanID
			into Sandbox.Conal.ChefAndBrewer_CompAcq
			from #PubRestaurant_Spend
			where CB_Comp_List = 1 and Chef_Brewer_shopper = 0

			If Object_ID('Warehouse.Selections.CH020_PreSelection') Is Not Null Drop Table Warehouse.Selections.CH020_PreSelectionSelect FanIDInto Warehouse.Selections.CH020_PreSelectionFrom Sandbox.Conal.ChefAndBrewer_CompAcqEND