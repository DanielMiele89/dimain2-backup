-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-01-24>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.EJ112_PreSelection_sProcASBEGIN
-- Get EJ CCIDs
...
into #EJcusCat
from #EJcustomers cIf Object_ID('Warehouse.Selections.EJ112_PreSelection') Is Not Null Drop Table Warehouse.Selections.EJ112_PreSelectionSelect FanIDInto Warehouse.Selections.EJ112_PreSelectionFrom #EJcusCatWHERE Category LIKE '%Low%'END