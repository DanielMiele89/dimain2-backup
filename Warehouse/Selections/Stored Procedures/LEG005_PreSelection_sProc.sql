-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-07-24>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.LEG005_PreSelection_sProcASBEGIN/*
...
OR Acquired = 0
OR Acquired = 1
OR ACQUIRED IS NULLIf Object_ID('Warehouse.Selections.LEG005_PreSelection') Is Not Null Drop Table Warehouse.Selections.LEG005_PreSelectionSelect FanIDInto Warehouse.Selections.LEG005_PreSelectionFROM  SANDBOX.SAMW.LEGO170919END