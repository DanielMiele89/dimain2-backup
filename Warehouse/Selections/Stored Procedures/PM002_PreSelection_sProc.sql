-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-04-18>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE [Selections].[PM002_PreSelection_sProc]ASBEGINSET NOCOUNT ON
SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED
	...
	*******************************************************************************************************************************************/
		...
		IF OBJECT_ID('Sandbox.Rory.PoochMuttLapsing_20210506') IS NOT NULL DROP TABLE Sandbox.Rory.PoochMuttLapsing_20210506
		SELECT *
		INTO Sandbox.Rory.PoochMuttLapsing_20210506
		FROM (	SELECT	FanID
					,	TranDate
					,	Segment
				FROM #AllCustomers ac
				...
				AND EXISTS (	SELECT 1
								...
								WHERE ac.FanID = ceoo.FanID)) acIf Object_ID('Warehouse.Selections.PM002_PreSelection') Is Not Null Drop Table Warehouse.Selections.PM002_PreSelectionSelect FanIDInto Warehouse.Selections.PM002_PreSelectionFROM  SANDBOX.RORY.PoochMuttLapsing_20210506END