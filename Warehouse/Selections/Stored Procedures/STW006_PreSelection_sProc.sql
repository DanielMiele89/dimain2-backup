-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-04-20>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.STW006_PreSelection_sProcASBEGIN
...
on	cl.CINID = b.CINID
	...
	from	#Final
If Object_ID('Warehouse.Selections.STW006_PreSelection') Is Not Null Drop Table Warehouse.Selections.STW006_PreSelectionSelect FanIDInto Warehouse.Selections.STW006_PreSelectionFROM SANDBOX.VERNON.STWC_SINGLE_TRANS_150420END