-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-04-20>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.LW049_PreSelection_sProcASBEGIN
...
on	cl.CINID = b.CINID
	...
	from	#Final
If Object_ID('Warehouse.Selections.LW049_PreSelection') Is Not Null Drop Table Warehouse.Selections.LW049_PreSelectionSelect FanIDInto Warehouse.Selections.LW049_PreSelectionFROM SANDBOX.VERNON.LAIT_SINGLE_TRANS_150420END