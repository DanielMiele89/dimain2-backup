-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-06-26>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.STW008_PreSelection_sProcASBEGIN
...
on	cl.CINID = b.CINID
	...
	from	#Final
If Object_ID('Warehouse.Selections.STW008_PreSelection') Is Not Null Drop Table Warehouse.Selections.STW008_PreSelectionSelect FanIDInto Warehouse.Selections.STW008_PreSelectionFROM SANDBOX.VERNON.STWC_SINGLE_TRANS_150420END