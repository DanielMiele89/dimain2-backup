-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-05-01>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE [Selections].[STW007_PreSelection_sProc]ASBEGIN
...
on	cl.CINID = b.CINID
	...
	from	#Final
If Object_ID('Warehouse.Selections.STW007_PreSelection') Is Not Null Drop Table Warehouse.Selections.STW007_PreSelectionSelect FanIDInto Warehouse.Selections.STW007_PreSelectionFROM SANDBOX.VERNON.STWC_SINGLE_TRANS_150420INSERT INTO Warehouse.Selections.STW007_PreSelectionSELECT FanIDFROM [Segmentation].[Roc_Shopper_Segment_Members]WHERE PartnerID = 4778AND EndDate IS NULLAND ShopperSegmentTypeID = 8END