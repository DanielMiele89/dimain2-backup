...
from	#segmentAssignment
where	MainBrand_spender_2m is nullIf Object_ID('Warehouse.Selections.NB011_PreSelection') Is Not Null Drop Table Warehouse.Selections.NB011_PreSelectionSelect FanIDInto Warehouse.Selections.NB011_PreSelectionFROM  SANDBOX.SamW.NOWTV_TV_Broadband_110119_AcquireEND