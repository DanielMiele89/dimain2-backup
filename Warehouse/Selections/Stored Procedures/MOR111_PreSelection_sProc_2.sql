...
WHERE BrandShopper = 1
	  ...
	  AND Transactions >= 55
GROUP BY F.CINID
If Object_ID('Warehouse.Selections.MOR111_PreSelection_2') Is Not Null Drop Table Warehouse.Selections.MOR111_PreSelection_2Select FanIDInto Warehouse.Selections.MOR111_PreSelection_2FROM  #FB fbWHERE EXISTS (	SELECT 1				FROM Sandbox.rukank.Morrisons_LoW_SoW_17082021 st				WHERE fb.CINID = st.CINID)END
