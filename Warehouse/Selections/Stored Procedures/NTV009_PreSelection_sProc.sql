-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-10-02>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.NTV009_PreSelection_sProcASBEGIN/***********************************************************************************************************************
...
***********************************************************************************************************************/
	...
	FROM #Customers ddIf Object_ID('Warehouse.Selections.NTV009_PreSelection') Is Not Null Drop Table Warehouse.Selections.NTV009_PreSelectionSelect FanIDInto Warehouse.Selections.NTV009_PreSelectionFROM  WAREHOUSE.SELECTIONS.NTV_PRESELECTION_EXCLUSIONEND