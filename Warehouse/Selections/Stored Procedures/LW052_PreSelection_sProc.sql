-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-06-26>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.LW052_PreSelection_sProcASBEGIN
...
on	cl.CINID = b.CINID
	...
	from	#Final
If Object_ID('Warehouse.Selections.LW052_PreSelection') Is Not Null Drop Table Warehouse.Selections.LW052_PreSelectionSelect FanIDInto Warehouse.Selections.LW052_PreSelectionFROM SANDBOX.VERNON.LAIT_SINGLE_TRANS_150420END