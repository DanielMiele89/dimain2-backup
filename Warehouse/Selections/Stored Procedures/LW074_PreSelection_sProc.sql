CREATE PROCEDURE [Selections].[LW074_PreSelection_sProc]
AS
BEGIN
...
IF OBJECT_ID('[Warehouse].[Selections].[LW074_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[LW074_PreSelection]
SELECT	fb.FanID
INTO [Warehouse].[Selections].[LW074_PreSelection]
FROM #FB fb
