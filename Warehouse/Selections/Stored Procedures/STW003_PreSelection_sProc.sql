-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-11-29>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.STW003_PreSelection_sProcASBEGINIF OBJECT_ID('tempdb..#CC') IS NOT NULL DROP TABLE #CC
Select	br.BrandID
		,br.BrandName
...
from	#Final
where	Ntile = 1If Object_ID('Warehouse.Selections.STW003_PreSelection') Is Not Null Drop Table Warehouse.Selections.STW003_PreSelectionSelect FanIDInto Warehouse.Selections.STW003_PreSelectionFrom sandbox.Conal.STWC_AB_Test_10pctEND