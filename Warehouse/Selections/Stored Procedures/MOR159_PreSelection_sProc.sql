...
CREATE PROCEDURE [Selections].[MOR159_PreSelection_sProc]
AS
BEGIN
...
GROUP BY F.CINID
	...
	IF OBJECT_ID('[Warehouse].[Selections].[MOR159_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[MOR159_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[MOR159_PreSelection]
	FROM #FB fb
