...
-- =============================================
CREATE PROCEDURE Selections.LEG003_PreSelection_sProc
AS
BEGIN
...
If Object_ID('Warehouse.Selections.LEG003_PreSelection') Is Not Null Drop Table Warehouse.Selections.LEG003_PreSelection
Select FanID
Into Warehouse.Selections.LEG003_PreSelection
