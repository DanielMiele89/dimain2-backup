...
CREATE PROCEDURE [Selections].[MOR126_PreSelection_sProc]
AS
BEGIN
	...
	-- ATV btw 0 - 15
	IF OBJECT_ID('Sandbox.rukank.Morrisons_Medium_SoW_ATV_0_15_10012022') IS NOT NULL DROP TABLE Sandbox.rukank.Morrisons_Medium_SoW_ATV_0_15_10012022
	SELECT	F.CINID
	INTO	Sandbox.rukank.Morrisons_Medium_SoW_ATV_0_15_10012022
	FROM	#Txn F
	WHERE	ATV < 15
	GROUP BY F.CINID

	IF OBJECT_ID('[Warehouse].[Selections].[MOR126_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[MOR126_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[MOR126_PreSelection]
	FROM #FB fb
	WHERE EXISTS (	SELECT 1
					FROM Sandbox.RukanK.Morrisons_Medium_SoW_ATV_0_15_10012022 st
