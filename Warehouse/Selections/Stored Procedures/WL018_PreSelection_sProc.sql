-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-10-02>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.WL018_PreSelection_sProcASBEGIN
...
If Object_ID('Warehouse.Selections.WL018_PreSelection') Is Not Null Drop Table Warehouse.Selections.WL018_PreSelectionSelect FanIDInto Warehouse.Selections.WL018_PreSelectionFROM  SANDBOX.SAMW.WLHTop10290120END