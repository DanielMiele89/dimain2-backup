-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-06-26>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE Procedure Selections.MOR031_PreSelection_sProcASBEGIN
...
From		(	select CL.CINID
				...
				LEFT JOIN sandbox.[Conal].[Erith_Postcode_Sectors_190228] E ON E.postcode_sector = cu.PostalSector
...
where 
	...
	and (	online_spender = 1 
			or MainBrand_spender_6m = 1
			or AgeCurrent >50)If Object_ID('Warehouse.Selections.MOR031_PreSelection') Is Not Null Drop Table Warehouse.Selections.MOR031_PreSelectionSelect FanIDInto Warehouse.Selections.MOR031_PreSelectionFrom #Morrisons_STOREPICKEND