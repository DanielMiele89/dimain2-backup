...
-- =============================================
CREATE PROCEDURE [Selections].[NB006_PreSelection_sProc]
AS
BEGIN
...
If Object_ID('Warehouse.Selections.NB006_PreSelection') Is Not Null Drop Table Warehouse.Selections.NB006_PreSelection
Select FanID
Into Warehouse.Selections.NB006_PreSelection
