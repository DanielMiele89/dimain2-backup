-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-05-29>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.CN118_PreSelection_sProcASBEGINIF OBJECT_ID('tempdb..#FB') IS NOT NULL DROP TABLE #FB
SELECT CINID
		,FANID
INTO #FB
...
If Object_ID('Warehouse.Selections.CN118_PreSelection') Is Not Null Drop Table Warehouse.Selections.CN118_PreSelectionSelect FanIDInto Warehouse.Selections.CN118_PreSelectionFROM  SANDBOX.SAMW.CAFFENEROCOVIDCOMPSTEALEND