CREATE PROCEDURE [Selections].[STW033_PreSelection_sProc]
AS
BEGIN
...
IF OBJECT_ID('[Warehouse].[Selections].[STW033_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[STW033_PreSelection]
SELECT	fb.FanID
INTO [Warehouse].[Selections].[STW033_PreSelection]
FROM #FB fb
