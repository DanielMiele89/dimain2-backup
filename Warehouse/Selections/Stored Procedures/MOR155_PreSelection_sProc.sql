...
CREATE PROCEDURE [Selections].[MOR155_PreSelection_sProc]
AS
BEGIN
...
GROUP BY F.CINID
	...
	IF OBJECT_ID('[Warehouse].[Selections].[MOR155_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[MOR155_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[MOR155_PreSelection]
	FROM #FB fb
