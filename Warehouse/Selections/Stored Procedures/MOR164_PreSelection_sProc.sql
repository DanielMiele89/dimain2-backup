...
CREATE PROCEDURE [Selections].[MOR164_PreSelection_sProc]
AS
BEGIN
...
GROUP BY F.CINID
	...
	IF OBJECT_ID('[Warehouse].[Selections].[MOR164_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[MOR164_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[MOR164_PreSelection]
	FROM #FB fb
