CREATE PROCEDURE [Selections].[BHO008_PreSelection_sProc]
AS
BEGIN
...
IF OBJECT_ID('[Warehouse].[Selections].[BHO008_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[BHO008_PreSelection]
SELECT	fb.FanID
INTO [Warehouse].[Selections].[BHO008_PreSelection]
FROM #FB fb
