...
IF OBJECT_ID('[Warehouse].[Selections].[BHO014_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[BHO014_PreSelection]
SELECT	fb.FanID
INTO [Warehouse].[Selections].[BHO014_PreSelection]
FROM #FB fb
