...
FROM #Responders F
GROUP BY F.CINID
If Object_ID('Warehouse.Selections.MOR112_PreSelection') Is Not Null Drop Table Warehouse.Selections.MOR112_PreSelectionSelect FanIDInto Warehouse.Selections.MOR112_PreSelectionFROM  #FB fbWHERE EXISTS (	SELECT 1				FROM Sandbox.rukank.Morrisons_Nursery_16092021 st				WHERE fb.CINID = st.CINID)END
