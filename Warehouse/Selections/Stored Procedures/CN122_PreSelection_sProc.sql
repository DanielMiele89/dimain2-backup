-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-08-21>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.CN122_PreSelection_sProcASBEGINIF OBJECT_ID('tempdb..#FB') IS NOT NULL DROP TABLE #FB
SELECT CINID
		,FANID
INTO #FB
...
FROM	#FB F 
JOIN	#CompetitorSteal C ON C.CINID = F.CINIDIf Object_ID('Warehouse.Selections.CN122_PreSelection') Is Not Null Drop Table Warehouse.Selections.CN122_PreSelectionSelect FanIDInto Warehouse.Selections.CN122_PreSelectionFROM  SANDBOX.SAMW.CAFFENEROCOVIDCOMPSTEALEND