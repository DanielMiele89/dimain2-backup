-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-06-25>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.SEL010_PreSelection_sProcASBEGIN
/*
...
UNION ALL
Select FanID
FROM SANDBOX.SamW.Selfridges_Selection_260121_LapsedCoreIf Object_ID('Warehouse.Selections.SEL010_PreSelection') Is Not Null Drop Table Warehouse.Selections.SEL010_PreSelectionSelect FanIDInto Warehouse.Selections.SEL010_PreSelectionFROM  #SELECTIONEND