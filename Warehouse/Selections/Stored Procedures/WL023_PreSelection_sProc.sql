-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-11-02>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE [Selections].[WL023_PreSelection_sProc]ASBEGINIF OBJECT_ID('tempdb..#FB') IS NOT NULL DROP TABLE #FB
SELECT	CINID
		,FanID
		,AgeCurrent
INTO #FB
...
If Object_ID('Warehouse.Selections.WL023_PreSelection') Is Not Null Drop Table Warehouse.Selections.WL023_PreSelectionSelect FanIDInto Warehouse.Selections.WL023_PreSelectionFROM #FB fbWHERE EXISTS (	SELECT 1				FROM Sandbox.SamW.WarnerLeisureKeyTargetting161020 sb				WHERE fb.cinID = sb.CinID)END