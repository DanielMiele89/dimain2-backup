...
IF OBJECT_ID('[Warehouse].[Selections].[TFL006_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[TFL006_PreSelection]
SELECT	FanID
INTO [Warehouse].[Selections].[TFL006_PreSelection]
FROM #FB fb
WHERE EXISTS (	SELECT 1
				FROM Sandbox.bastienc.rbs_thortful t
