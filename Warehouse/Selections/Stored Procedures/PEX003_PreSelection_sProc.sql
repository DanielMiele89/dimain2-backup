...
CREATE PROCEDURE [Selections].[PEX003_PreSelection_sProc] 
AS  
BEGIN     
...
IF OBJECT_ID('[Warehouse].[Selections].[PEX003_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[PEX003_PreSelection]   
SELECT fb.FanID
INTO [Warehouse].[Selections].[PEX003_PreSelection]   
FROM #FB fb
