-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-05-15>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE [Selections].[AZF009_PreSelection_sProc]ASBEGIN
...
FROM #FB
GROUP BY CINID
				If Object_ID('Warehouse.Selections.AZF009_PreSelection') Is Not Null Drop Table Warehouse.Selections.AZF009_PreSelectionSelect FanIDInto Warehouse.Selections.AZF009_PreSelectionFROM #FB fbWHERE EXISTS (	SELECT 1				FROM Sandbox.RukanK.AmazonFresh_FullOpp_27102021 st				WHERE fb.CINID = st.CINID)END