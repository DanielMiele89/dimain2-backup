-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-12-22>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE [Selections].[STW019_PreSelection_sProc]ASBEGIN
...
on	cl.CINID = b.CINID
	...
	FROM (	SELECT FanID
			...
			AND EndDate IS NULL
			AND ShopperSegmentTypeID IN (7, 8)) sIf Object_ID('Warehouse.Selections.STW019_PreSelection') Is Not Null Drop Table Warehouse.Selections.STW019_PreSelectionSelect FanIDInto Warehouse.Selections.STW019_PreSelectionFROM #PreSelectionEND