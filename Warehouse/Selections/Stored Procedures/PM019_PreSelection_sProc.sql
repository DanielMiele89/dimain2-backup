...
IF OBJECT_ID('[Warehouse].[Selections].[PM019_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[PM019_PreSelection]
SELECT	FanID
INTO [Warehouse].[Selections].[PM019_PreSelection]
