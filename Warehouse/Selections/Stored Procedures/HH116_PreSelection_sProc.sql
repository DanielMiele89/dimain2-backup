-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-03-22>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.HH116_PreSelection_sProcASBEGIN
...
IF OBJECT_ID('sandbox.Conal.HH_General') IS NOT NULL DROP TABLE sandbox.Conal.HH_General
		...
		from #PubRestaurant_SpendIf Object_ID('Warehouse.Selections.HH116_PreSelection') Is Not Null Drop Table Warehouse.Selections.HH116_PreSelectionSelect FanIDInto Warehouse.Selections.HH116_PreSelectionFrom #PubRestaurant_SpendEND