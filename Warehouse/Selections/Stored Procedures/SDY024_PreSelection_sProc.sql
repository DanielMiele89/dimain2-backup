...
CREATE PROCEDURE [Selections].[SDY024_PreSelection_sProc]
AS
BEGIN
...
GROUP BY CINID
	...
	IF OBJECT_ID('[Warehouse].[Selections].[SDY024_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[SDY024_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[SDY024_PreSelection]
	FROM #FB fb
