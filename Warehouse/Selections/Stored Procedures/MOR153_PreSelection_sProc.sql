...
CREATE PROCEDURE [Selections].[MOR153_PreSelection_sProc]
AS
BEGIN
...
GROUP BY F.CINID
	...
	IF OBJECT_ID('[Warehouse].[Selections].[MOR153_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[MOR153_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[MOR153_PreSelection]
	FROM #FB fb
