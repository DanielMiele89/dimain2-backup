-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-06-14>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.MOR029_PreSelection_sProcASBEGIN
...
where	 SoW < 0.25
		and Transactions >= 30If Object_ID('Warehouse.Selections.MOR029_PreSelection') Is Not Null Drop Table Warehouse.Selections.MOR029_PreSelectionSelect FanIDInto Warehouse.Selections.MOR029_PreSelectionFrom Sandbox.Conal.Morrisons_Selection_080519END