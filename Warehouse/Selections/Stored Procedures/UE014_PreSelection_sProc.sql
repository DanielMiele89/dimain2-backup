...
-- =============================================
CREATE PROCEDURE [Selections].[UE014_PreSelection_sProc]
AS
BEGIN
...
If Object_ID('Warehouse.Selections.UE014_PreSelection') Is Not Null Drop Table Warehouse.Selections.UE014_PreSelection
Select FanID
Into Warehouse.Selections.UE014_PreSelection
