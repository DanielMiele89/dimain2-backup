...
CREATE Procedure [Selections].[OPE_Validation] (@Date Date)
...
Begin
	...
	/*
	TRUNCATE TABLE Warehouse.Selections.OPE_Validation_Reviewed
	TRUNCATE TABLE Warehouse.Selections.OPE_Validation_OffersWithErrors
	Declare @EmailDate Date = '2022-04-21'
	*/
	...
	*******************************************************************************************************************************************/
		...
		SELECT *
		INTO #IronOffer
		FROM DIMAIN_TR.SLC_REPL.dbo.IronOffer
		...
		***********************************************************************************************************************/
			...
			If Object_ID('tempdb..#OPE_Validation_OffersWithErrors') Is Not Null Drop Table #OPE_Validation_OffersWithErrors
			Create Table #OPE_Validation_OffersWithErrors (IronOfferID Int Not Null
	...
	/*******************************************************************************************************************************************
		2. Split ROCShopperSegment_PreSelection_ALS to offer level
	*******************************************************************************************************************************************/

		/***********************************************************************************************************************
			2.1. Fetch ROCShopperSegment_PreSelection_ALS into temp table for campaigns with upcoming selection
		***********************************************************************************************************************/
	...
	*******************************************************************************************************************************************/
		...
		***********************************************************************************************************************/
			...
			Insert Into #OPE_Validation_OffersWithErrors (IronOfferID
														, IronOfferName
														, StartDate
														, EndDate
														, PartnerID
		...
		***********************************************************************************************************************/
		...
		/***********************************************************************************************************************
			3.6. Offers that are in the OPE but are not in the ROCShopperSegment_PreSelection_ALS table 
		***********************************************************************************************************************/
		...
		/***********************************************************************************************************************
			3.7. Offers that are in the ROCShopperSegment_PreSelection_ALS table but are not in the OPE
		***********************************************************************************************************************/
	...
	*******************************************************************************************************************************************/
		...
		Insert into Warehouse.Selections.OPE_Validation_OffersWithErrors
		Select IronOfferID
			 , IronOfferName
			 , StartDate
			 , EndDate
		...
		From (Select IronOfferID
			  ...
			  From #OPE_Validation_OffersWithErrors
		...
		UPDATE Warehouse.Selections.OPE_Validation_OffersWithErrors
	...
	*******************************************************************************************************************************************/
		...
		FROM [Selections].[OPE_Validation_OffersWithErrors] owe
	...
	*******************************************************************************************************************************************/
		...
		Insert Into Warehouse.Selections.OPE_Validation_Reviewed
		Select Distinct
			   eo.PartnerName
			 , eo.AccountManager
			 ...
			 , eo.IronOfferID
			 , Coalesce(eo.CashbackRate * 100, iof.TopCashBackRate) as CashbackRate
		...
		Left Join Selections.OPE_Validation_OffersWithErrors opeerr
