-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-02-05>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE [Selections].[STW005_PreSelection_sProc]ASBEGINIF OBJECT_ID('tempdb..#CC') IS NOT NULL DROP TABLE #CC
Select	br.BrandID
		,br.BrandName
...
IF OBJECT_ID('sandbox.Conal.STWC_AB_Test_10pct') IS NOT NULL DROP TABLE sandbox.Conal.STWC_AB_Test_10pct

select	 CINID
		, fanid
into	sandbox.Conal.STWC_AB_Test_10pct
from	#Final
where	Ntile = 2

IF OBJECT_ID('sandbox.Conal.STWC_AB_Test_5pct') IS NOT NULL DROP TABLE sandbox.Conal.STWC_AB_Test_5pct

select	 CINID
		, fanid
into	sandbox.Conal.STWC_AB_Test_5pct
from	#Final
where	Ntile = 1If Object_ID('Warehouse.Selections.STW005_PreSelection') Is Not Null Drop Table Warehouse.Selections.STW005_PreSelectionSelect FanIDInto Warehouse.Selections.STW005_PreSelectionFROM SANDBOX.CONAL.STWC_AB_TEST_10PCTEND