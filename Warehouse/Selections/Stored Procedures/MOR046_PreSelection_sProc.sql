-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-11-29>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.MOR046_PreSelection_sProcASBEGIN
...
WHERE IO.IronOfferID in (17606, 17608, 17610)
		...
		where	SoW_Morrisons <= 0.20
			...
			and FanID NOT IN (SELECT FANID FROM #OnOffers)If Object_ID('Warehouse.Selections.MOR046_PreSelection') Is Not Null Drop Table Warehouse.Selections.MOR046_PreSelectionSelect FanIDInto Warehouse.Selections.MOR046_PreSelectionFrom Sandbox.SamW.Morrisons_November_ProposalEND