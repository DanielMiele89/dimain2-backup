...
CREATE Procedure [Selections].[WA144_PreSelection_sProc]
AS
BEGIN
...
If object_id('Warehouse.Selections.WA_PreSelection') is not null
drop table Warehouse.Selections.WA_PreSelection
Select Flag
	 , FanID
...
If object_id('Warehouse.Selections.WA144_PreSelection') is not null
drop table Warehouse.Selections.WA144_PreSelection
Select FanID
Into Warehouse.Selections.WA144_PreSelection
