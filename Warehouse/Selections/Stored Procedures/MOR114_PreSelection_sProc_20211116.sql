...
WHERE BrandShopper = 1
	  ...
	  AND Transactions >= 45
GROUP BY F.CINID
If Object_ID('Warehouse.Selections.MOR114_PreSelection') Is Not Null Drop Table Warehouse.Selections.MOR114_PreSelectionSelect FanIDInto Warehouse.Selections.MOR114_PreSelectionFROM  #FB fbWHERE EXISTS (	SELECT 1				FROM Sandbox.rukank.Morrisons_LoW_SoW_14102021 st				WHERE fb.CINID = st.CINID)END