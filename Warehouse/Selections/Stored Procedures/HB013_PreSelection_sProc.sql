-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-03-21>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.HB013_PreSelection_sProcASBEGIN--Please take acquire customers only from the following table
 ...
 When lk.UnknownGroup = 1 Then 100
 Else Index_RR
 End >=100If Object_ID('Warehouse.Selections.HB013_PreSelection') Is Not Null Drop Table Warehouse.Selections.HB013_PreSelectionSelect FanIDInto Warehouse.Selections.HB013_PreSelectionFrom #Activated_HM2END