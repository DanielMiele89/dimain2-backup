-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-03-06>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.LK002_PreSelection_sProcASBEGIN
...
--AND		CINID NOT IN (SELECT CINID FROM Sandbox.SamW.LookFantastic_Acquire_100221)
If Object_ID('Warehouse.Selections.LK002_PreSelection') Is Not Null Drop Table Warehouse.Selections.LK002_PreSelectionSelect FanIDInto Warehouse.Selections.LK002_PreSelectionFROM  #FullBase fbWHERE EXISTS (	SELECT 1				FROM Sandbox.SamW.LookFantastic_Group1ATV_100221 sb				WHERE fb.CINID = sb.CINID)END