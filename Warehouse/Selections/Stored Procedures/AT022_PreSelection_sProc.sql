-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-12-20>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.AT022_PreSelection_sProcASBEGIN
...
AND Comp_Spender = 1If Object_ID('Warehouse.Selections.AT022_PreSelection') Is Not Null Drop Table Warehouse.Selections.AT022_PreSelectionSelect FanIDInto Warehouse.Selections.AT022_PreSelectionFrom Sandbox.Tasfia.ATG_CompSteal_200219END