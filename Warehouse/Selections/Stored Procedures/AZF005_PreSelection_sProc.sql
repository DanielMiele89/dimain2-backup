...
AND CINID NOT IN (SELECT * FROM #CT_GT1)If Object_ID('Warehouse.Selections.AZF005_PreSelection') Is Not Null Drop Table Warehouse.Selections.AZF005_PreSelectionSelect FanIDInto Warehouse.Selections.AZF005_PreSelectionFROM Relational.Customer cuWHERE EXISTS (	SELECT 1				FROM [Relational].[CINList] cl				INNER JOIN #final_output fo					ON cl.CINID = fo.CINID				WHERE cu.SourceUID = cl.CIN)END