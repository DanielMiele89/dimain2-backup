...
WHERE Comp_Spender = 1If Object_ID('Warehouse.Selections.LW062_PreSelection') Is Not Null Drop Table Warehouse.Selections.LW062_PreSelectionSelect FanIDInto Warehouse.Selections.LW062_PreSelectionFROM  SANDBOX.SAMW.LAITHWAITES_COMPSTEAL_280519END