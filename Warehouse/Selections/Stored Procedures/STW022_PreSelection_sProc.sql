-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-03-19>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE [Selections].[STW022_PreSelection_sProc]ASBEGIN
...
AND EndDate IS NULL
AND ShopperSegmentTypeID IN (7, 8)If Object_ID('Warehouse.Selections.STW022_PreSelection') Is Not Null Drop Table Warehouse.Selections.STW022_PreSelectionSelect FanIDInto Warehouse.Selections.STW022_PreSelectionFROM  sandbox.vernon.STWC_single_trans_150420END