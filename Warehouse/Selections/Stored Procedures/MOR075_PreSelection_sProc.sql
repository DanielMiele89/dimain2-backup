-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-11-13>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.MOR075_PreSelection_sProcASBEGIN
...
OR		AwarenessLevel = '3 - Bronze'If Object_ID('Warehouse.Selections.MOR075_PreSelection') Is Not Null Drop Table Warehouse.Selections.MOR075_PreSelectionSelect FanIDInto Warehouse.Selections.MOR075_PreSelectionFROM  #FB fbWHERE EXISTS (	SELECT 1				FROM SANDBOX.SAMW.MorrisonsGamston011020 gm				WHERE fb.CINID = gm.CINID)END