...
CREATE PROCEDURE [Selections].[MOR161_PreSelection_sProc]
AS
BEGIN
...
-- ATV > 35
IF OBJECT_ID('Sandbox.rukank.Morrisons_Medium_SoW_ATV_35_31032022') IS NOT NULL DROP TABLE Sandbox.rukank.Morrisons_Medium_SoW_ATV_35_31032022				-- 43,670
SELECT	F.CINID
INTO	Sandbox.rukank.Morrisons_Medium_SoW_ATV_35_31032022
FROM	#Txn F
WHERE	ATV > 35
GROUP BY F.CINID
	...
	IF OBJECT_ID('[Warehouse].[Selections].[MOR161_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[MOR161_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[MOR161_PreSelection]
	FROM #FB fb
	WHERE EXISTS (	SELECT 1
					FROM Sandbox.rukank.Morrisons_Medium_SoW_ATV_35_31032022  st
