...
GROUP BY BrandName,ct.CINIDIf Object_ID('Warehouse.Selections.HIE014_PreSelection') Is Not Null Drop Table Warehouse.Selections.HIE014_PreSelectionSelect FanIDInto Warehouse.Selections.HIE014_PreSelectionFROM #FB fbWHERE EXISTS (	SELECT 1				FROM Sandbox.bastienc.week_spender_HIE cl				WHERE fb.CINID = cl.CINID)END