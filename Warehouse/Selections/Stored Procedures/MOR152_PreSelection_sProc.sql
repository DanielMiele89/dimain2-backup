...
CREATE PROCEDURE [Selections].[MOR152_PreSelection_sProc]
AS
BEGIN
...
IF OBJECT_ID('tempdb..#shoppper_sow') IS NOT NULL DROP TABLE #shoppper_sow												-- 123,360
SELECT   CT.CINID
...
IF OBJECT_ID('tempdb..#Txn') IS NOT NULL DROP TABLE #Txn																-- 123,360
...
-- ATV btw 15 - 35
IF OBJECT_ID('Sandbox.rukank.Morrisons_Medium_SoW_ATV_15_35_31032022') IS NOT NULL DROP TABLE Sandbox.rukank.Morrisons_Medium_SoW_ATV_15_35_31032022		-- 52,207
SELECT	F.CINID
INTO	Sandbox.rukank.Morrisons_Medium_SoW_ATV_15_35_31032022
FROM	#Txn F
WHERE	ATV BETWEEN 15 AND 35
GROUP BY F.CINID

	IF OBJECT_ID('[Warehouse].[Selections].[MOR152_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[MOR152_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[MOR152_PreSelection]
	FROM #FB fb
	WHERE EXISTS (	SELECT 1
					FROM Sandbox.rukank.Morrisons_Medium_SoW_ATV_15_35_31032022  st
