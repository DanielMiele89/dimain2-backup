-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-03-11>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.MOR021_PreSelection_sProcASBEGIN
...
where 
	...
	and (	online_spender = 1 
			...
			or AgeCurrent >50)If Object_ID('Warehouse.Selections.MOR021_PreSelection') Is Not Null Drop Table Warehouse.Selections.MOR021_PreSelectionSelect FanIDInto Warehouse.Selections.MOR021_PreSelectionFrom #Morrisons_STOREPICKEND