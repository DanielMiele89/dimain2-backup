...
AND		Amount > 0
AND		DATENAME(WEEKDAY, TranDate) IN ('FRIDAY','SATURDAY','SUNDAY')If Object_ID('Warehouse.Selections.CP006_PreSelection') Is Not Null Drop Table Warehouse.Selections.CP006_PreSelectionSelect FanIDInto Warehouse.Selections.CP006_PreSelectionFROM SANDBOX.EWAN.WITHINDISTANCEIHG100120END