...
-- =============================================
CREATE Procedure [Selections].[WA213_PreSelection_sProc]
AS
BEGIN
...
If Object_ID('Warehouse.Selections.WA213_PreSelection') Is Not Null Drop Table Warehouse.Selections.WA213_PreSelection
Select FanID
Into Warehouse.Selections.WA213_PreSelection
From Sandbox.Conal.Waitrose_10_20_Shopper
