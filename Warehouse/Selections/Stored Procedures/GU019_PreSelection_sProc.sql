-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-04-18>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.GU019_PreSelection_sProcASBEGINIF OBJECT_ID('tempdb..#FB') IS NOT NULL DROP TABLE #FB
SELECT CINID
		,FANID
INTO #FB
...
WHERE	TranDate >= DATEADD(MONTH,-12,GETDATE())If Object_ID('Warehouse.Selections.GU019_PreSelection') Is Not Null Drop Table Warehouse.Selections.GU019_PreSelectionSelect FanIDInto Warehouse.Selections.GU019_PreSelectionFROM  SANDBOX.SAMW.GOUSTOCOMPSTEAL060720END