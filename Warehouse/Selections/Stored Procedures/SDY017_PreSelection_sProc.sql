...
BEGIN
	...
	-- shoppers - SOW - >= 33% & < 66%
	IF OBJECT_ID('Sandbox.samh.superdry_sow33_66_25012021') IS NOT NULL DROP TABLE Sandbox.samh.superdry_sow33_66_25012021
	SELECT	F.CINID, FanID
	INTO	Sandbox.samh.superdry_sow33_66_25012021
	FROM	#shoppper_sow F
	...
	IF OBJECT_ID('[Warehouse].[Selections].[SDY017_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[SDY017_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[SDY017_PreSelection]
	FROM Sandbox.samh.superdry_sow33_66_25012021
