-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-01-24>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.EJ114_PreSelection_sProcASBEGIN
-- Get EJ CCIDs
...
into #EJcusCat
from #EJcustomers cIf Object_ID('Warehouse.Selections.EJ114_PreSelection') Is Not Null Drop Table Warehouse.Selections.EJ114_PreSelectionSelect FanIDInto Warehouse.Selections.EJ114_PreSelectionFrom #EJcusCatWHERE Category LIKE '%High%'END