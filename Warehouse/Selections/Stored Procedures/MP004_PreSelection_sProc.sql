-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-03-06>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.MP004_PreSelection_sProcASBEGIN--SELECT	*
...
FROM	#ATVGroup
WHERE	51 <= ATV AND ATV <= 60If Object_ID('Warehouse.Selections.MP004_PreSelection') Is Not Null Drop Table Warehouse.Selections.MP004_PreSelectionSelect FanIDInto Warehouse.Selections.MP004_PreSelectionFROM  #FullBase fbWHERE EXISTS (	SELECT 1				FROM Sandbox.SAMW.MyProtein_Group3ATV_100221 sb				WHERE fb.CINID = sb.CINID)END