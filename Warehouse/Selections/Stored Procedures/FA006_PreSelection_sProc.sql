...
-- =============================================
CREATE Procedure [Selections].[FA006_PreSelection_sProc]
AS
BEGIN
...
-- comp steal selection
IF OBJECT_ID('#compsteal') IS NOT NULL 
 DROP TABLE #compsteal
  select CINID
   , FanID
  into #compsteal
  from #PubRestaurant_Spend
  where Universe_2 = 1 and Universe_1 = 0 and Within_25_DT = 1


If Object_ID('Warehouse.Selections.FA006_PreSelection') Is Not Null Drop Table Warehouse.Selections.FA006_PreSelection
Select FanID
Into Warehouse.Selections.FA006_PreSelection
From #compsteal
