...
-- Optimised 4+ Extension
		...
		WHERE	(Prem_flag = 'Everyone Else' AND flag = '08.50-60%')
			OR (Prem_flag = 'Optimised' AND flag = '09.60-70%')If Object_ID('Warehouse.Selections.WA224_PreSelection') Is Not Null Drop Table Warehouse.Selections.WA224_PreSelectionSelect FanIDInto Warehouse.Selections.WA224_PreSelectionFROM Sandbox.Conal.Waitrose_Optimised_6_plusEND