-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-06-14>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.HH118_PreSelection_sProcASBEGINdeclare @HH int = 212
	...
	on	cl.CINID = b.CINID
		...
		-- General
		if OBJECT_ID('Sandbox.Conal.HungryHorse_General') is not null drop table Sandbox.Conal.HungryHorse_General
		select	 CINID
				, FanID
		into	Sandbox.Conal.HungryHorse_General
		from	#PubRestaurant_Spend
		where	Hungry_Horse_shopper = 1 or Hungry_Horse_shopper is nullIf Object_ID('Warehouse.Selections.HH118_PreSelection') Is Not Null Drop Table Warehouse.Selections.HH118_PreSelectionSelect FanIDInto Warehouse.Selections.HH118_PreSelectionFrom Sandbox.Conal.HungryHorse_GeneralEND