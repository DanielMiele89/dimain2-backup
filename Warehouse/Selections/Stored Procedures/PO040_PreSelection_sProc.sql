...
IF OBJECT_ID('[Warehouse].[Selections].[PO040_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[PO040_PreSelection]
SELECT	FanID
INTO [Warehouse].[Selections].[PO040_PreSelection]
FROM #FB fb
WHERE EXISTS (	SELECT 1
				FROM Sandbox.RukanK.po_ferries_compsteal sb
