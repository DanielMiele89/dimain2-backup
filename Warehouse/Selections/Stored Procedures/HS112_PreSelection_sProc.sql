-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-10-02>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE Procedure [Selections].[HS112_PreSelection_sProc]ASBEGIN
...
into #HScusCat
from #HScustomers c
If Object_ID('Warehouse.Selections.HS112_PreSelection') Is Not Null Drop Table Warehouse.Selections.HS112_PreSelectionSelect FanIDInto Warehouse.Selections.HS112_PreSelectionFrom #HScusCatwhere Category LIKE '%Medium%'END