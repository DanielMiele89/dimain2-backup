-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-01-24>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.NTV006_PreSelection_sProcASBEGIN/***********************************************************************************************************************
...
***********************************************************************************************************************/
	...
	FROM #Customers ddIf Object_ID('Warehouse.Selections.NTV006_PreSelection') Is Not Null Drop Table Warehouse.Selections.NTV006_PreSelectionSelect FanIDInto Warehouse.Selections.NTV006_PreSelectionFrom Warehouse.Selections.NTV_PreSelection_ExclusionEND