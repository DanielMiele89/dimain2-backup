...
CREATE PROCEDURE [Selections].[MOR160_PreSelection_sProc]
AS
BEGIN
...
GROUP BY F.CINID
	...
	IF OBJECT_ID('[Warehouse].[Selections].[MOR160_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[MOR160_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[MOR160_PreSelection]
	FROM #FB fb
