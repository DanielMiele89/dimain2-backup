-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-02-05>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.STW004_PreSelection_sProcASBEGINIF OBJECT_ID('tempdb..#CC') IS NOT NULL DROP TABLE #CC
Select	br.BrandID
		,br.BrandName
...
from	#Final
where	Ntile = 1If Object_ID('Warehouse.Selections.STW004_PreSelection') Is Not Null Drop Table Warehouse.Selections.STW004_PreSelectionSelect FanIDInto Warehouse.Selections.STW004_PreSelectionFROM SANDBOX.CONAL.STWC_AB_TEST_5PCTEND