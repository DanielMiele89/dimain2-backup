-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-07-12>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.CW011_PreSelection_sProcASBEGIN
...
WHERE (MainBrand_Spender_48M = 0 AND Comp_Spender_48M = 1)If Object_ID('Warehouse.Selections.CW011_PreSelection') Is Not Null Drop Table Warehouse.Selections.CW011_PreSelectionSelect FanIDInto Warehouse.Selections.CW011_PreSelectionFrom Sandbox.Tasfia.CarphoneWarehouse_CompSteal_100419END