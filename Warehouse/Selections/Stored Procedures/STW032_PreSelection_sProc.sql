CREATE PROCEDURE [Selections].[STW032_PreSelection_sProc]
AS
BEGIN
...
IF OBJECT_ID('[Warehouse].[Selections].[STW032_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[STW032_PreSelection]
SELECT	fb.FanID
INTO [Warehouse].[Selections].[STW032_PreSelection]
FROM #FB fb
