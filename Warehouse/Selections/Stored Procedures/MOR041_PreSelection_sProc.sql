-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-11-04>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.MOR041_PreSelection_sProcASBEGIN
...
where 
	...
	and (	online_spender = 1 
			or MainBrand_spender_6m = 1
			or AgeCurrent >50)If Object_ID('Warehouse.Selections.MOR041_PreSelection') Is Not Null Drop Table Warehouse.Selections.MOR041_PreSelectionSelect FanIDInto Warehouse.Selections.MOR041_PreSelectionFrom #Morrisons_STOREPICKEND