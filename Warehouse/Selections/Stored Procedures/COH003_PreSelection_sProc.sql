-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-09-04>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.COH003_PreSelection_sProcASBEGINIF OBJECT_ID('tempdb..#CC') IS NOT NULL DROP TABLE #CC
SELECT br.BrandID,
		br.BrandName,
...
If Object_ID('Warehouse.Selections.COH003_PreSelection') Is Not Null Drop Table Warehouse.Selections.COH003_PreSelectionSelect FanIDInto Warehouse.Selections.COH003_PreSelectionFROM  SANDBOX.TASFIA.COTE_EXCREGIONSFOODSERVICES_020620END