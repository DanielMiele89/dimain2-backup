-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-04-18>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.SIC004_PreSelection_sProcASBEGIN
...
OR F.CINID NOT IN (SELECT CINID FROM #UnderSpend)If Object_ID('Warehouse.Selections.SIC004_PreSelection') Is Not Null Drop Table Warehouse.Selections.SIC004_PreSelectionSelect FanIDInto Warehouse.Selections.SIC004_PreSelectionFROM #FB fbWHERE EXISTS (	SELECT 1				FROM SANDBOX.SAMW.SIMPLYCOOK020221 sc				WHERE fb.CINID = sc.CINID)END