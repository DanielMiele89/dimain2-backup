CREATE PROCEDURE [Selections].[STW036_PreSelection_sProc]
AS
BEGIN
...
IF OBJECT_ID('[Warehouse].[Selections].[STW036_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[STW036_PreSelection]
SELECT	fb.FanID
INTO [Warehouse].[Selections].[STW036_PreSelection]
FROM #FB fb
