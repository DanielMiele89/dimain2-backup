-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-10-02>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.CT045_PreSelection_sProcASBEGIN
...
ORDER BY CINID
 ,fanid
If Object_ID('Warehouse.Selections.CT045_PreSelection') Is Not Null Drop Table Warehouse.Selections.CT045_PreSelectionSelect FanIDInto Warehouse.Selections.CT045_PreSelectionFrom #segmentAssignmentEND