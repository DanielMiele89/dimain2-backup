-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-06-25>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE [Selections].[TT019_PreSelection_sProc]ASBEGIN--SELECT *
...
AND		Amount > 0
GROUP BY F.CINIDIf Object_ID('Warehouse.Selections.TT019_PreSelection') Is Not Null Drop Table Warehouse.Selections.TT019_PreSelectionSelect FanIDInto Warehouse.Selections.TT019_PreSelectionFROM #FB fbWHERE EXISTS (	SELECT 1				FROM SANDBOX.SAMW.TELEGRAPH050221 t				WHERE fb.CINID = t.CINID)END