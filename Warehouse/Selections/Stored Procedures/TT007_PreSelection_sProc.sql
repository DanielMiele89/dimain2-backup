-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-06-11>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.TT007_PreSelection_sProcASBEGINSELECT *
...
AND		Amount > 0
GROUP BY F.CINIDIf Object_ID('Warehouse.Selections.TT007_PreSelection') Is Not Null Drop Table Warehouse.Selections.TT007_PreSelectionSelect FanIDInto Warehouse.Selections.TT007_PreSelectionFROM Relational.Customer cuWHERE EXISTS (	SELECT 1				FROM relational.CinList cl				INNER JOIN SANDBOX.SAMW.TELEGRAPH050221 t					ON cl.CINID = t.CINID				WHERE cu.SourceUID = cl.CIN)END