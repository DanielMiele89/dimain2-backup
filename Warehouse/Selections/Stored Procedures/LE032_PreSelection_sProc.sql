...
IF OBJECT_ID('[Warehouse].[Selections].[LE032_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[LE032_PreSelection]
SELECT	fb.FanID
INTO [Warehouse].[Selections].[LE032_PreSelection]
FROM #FB fb
