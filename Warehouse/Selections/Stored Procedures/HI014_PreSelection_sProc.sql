...
GROUP BY BrandName,ct.CINIDIf Object_ID('Warehouse.Selections.HI014_PreSelection') Is Not Null Drop Table Warehouse.Selections.HI014_PreSelectionSelect FanIDInto Warehouse.Selections.HI014_PreSelectionFROM #FB fbWHERE EXISTS (	SELECT 1				FROM Sandbox.bastienc.week_spender_HI cl				WHERE fb.CINID = cl.CINID)END