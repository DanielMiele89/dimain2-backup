...
-- Optimised 4+ Extension
		...
		WHERE	(Prem_flag = 'Everyone Else' AND flag = '08.50-60%')
			OR (Prem_flag = 'Optimised' AND flag = '09.60-70%')If Object_ID('Warehouse.Selections.WA222_PreSelection') Is Not Null Drop Table Warehouse.Selections.WA222_PreSelectionSelect FanIDInto Warehouse.Selections.WA222_PreSelectionFROM Sandbox.Conal.Waitrose_10_20_ShopperEND