...
CREATE PROCEDURE [Selections].[SDY019_PreSelection_sProc]
AS
BEGIN
...
--GROUP BY CINID
	...
	IF OBJECT_ID('[Warehouse].[Selections].[SDY019_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[SDY019_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[SDY019_PreSelection]
	FROM #FB fb
