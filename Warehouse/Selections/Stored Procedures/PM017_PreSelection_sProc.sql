...
SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED
	...
	*******************************************************************************************************************************************/
		...
		IF OBJECT_ID('Sandbox.Rory.PoochMuttLapsing_20210617_Warehouse') IS NOT NULL DROP TABLE Sandbox.Rory.PoochMuttLapsing_20210617_Warehouse
		SELECT *
		INTO Sandbox.Rory.PoochMuttLapsing_20210617_Warehouse
		FROM #AllCustomers
		WHERE Segment = 'Lapsing'

		IF OBJECT_ID('[Warehouse].[Selections].[PM017_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[PM017_PreSelection]
		SELECT	FanID
		INTO [Warehouse].[Selections].[PM017_PreSelection]
		FROM Sandbox.Rory.PoochMuttLapsing_20210617_Warehouse
