-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-08-05>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE [Selections].[BHO001_PreSelection_sProc]ASBEGIN
...
FROM	#Trans
GROUP BY CINIDIf Object_ID('Warehouse.Selections.BHO001_PreSelection') Is Not Null Drop Table Warehouse.Selections.BHO001_PreSelectionSelect FanIDInto Warehouse.Selections.BHO001_PreSelection FROM  Relational.Customer cuWHERE EXISTS (	SELECT 1				FROM Sandbox.RukanK.boohoo_Female_CompSteal_18to55_09082021 s				INNER JOIN Relational.CINList cl					ON s.CINID = cl.CINID				WHERE cu.SourceUID = cl.CIN)END