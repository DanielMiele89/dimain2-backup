-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-10-02>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.NTV010_PreSelection_sProcASBEGIN/***********************************************************************************************************************
...
***********************************************************************************************************************/
	...
	FROM #Customers ddIf Object_ID('Warehouse.Selections.NTV010_PreSelection') Is Not Null Drop Table Warehouse.Selections.NTV010_PreSelectionSelect FanIDInto Warehouse.Selections.NTV010_PreSelectionFROM  WAREHOUSE.SELECTIONS.NTV_PRESELECTION_EXCLUSIONEND