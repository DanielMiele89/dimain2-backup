...
on	cl.CINID = b.CINID
	...
	FROM (	SELECT FanID
			...
			AND EndDate IS NULL
			AND ShopperSegmentTypeID IN (7, 8)) sIf Object_ID('Warehouse.Selections.LW081_PreSelection') Is Not Null Drop Table Warehouse.Selections.LW081_PreSelectionSelect FanIDInto Warehouse.Selections.LW081_PreSelectionFROM  #PRESELECTIONEND