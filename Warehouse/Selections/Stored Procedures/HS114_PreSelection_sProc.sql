-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-10-02>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE Procedure [Selections].[HS114_PreSelection_sProc]ASBEGIN
...
If Object_ID('Warehouse.Selections.HS114_PreSelection') Is Not Null Drop Table Warehouse.Selections.HS114_PreSelectionSelect FanIDInto Warehouse.Selections.HS114_PreSelectionFrom #HScusCatwhere Category LIKE '%VIP%'END