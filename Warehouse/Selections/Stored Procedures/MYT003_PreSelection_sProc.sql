-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-11-13>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.MYT003_PreSelection_sProcASBEGIN	--	Premier Reward Account holders
	...
	OR EXISTS (		SELECT 1
					...
					WHERE cu.FanID = pc.FanID)If Object_ID('Warehouse.Selections.MYT003_PreSelection') Is Not Null Drop Table Warehouse.Selections.MYT003_PreSelectionSelect FanIDInto Warehouse.Selections.MYT003_PreSelectionFROM  #ALLCUSTOMERSEND