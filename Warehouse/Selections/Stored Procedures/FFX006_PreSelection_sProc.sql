...
FROM  #Trans
If Object_ID('Warehouse.Selections.FFX006_PreSelection') Is Not Null Drop Table Warehouse.Selections.FFX006_PreSelectionSelect FanIDInto Warehouse.Selections.FFX006_PreSelectionFROM #FB fbWHERE EXISTS (	SELECT 1				FROM Sandbox.RukanK.FFX_CompSteal_17092021 cu				WHERE fb.CINID = cu.CINID)END