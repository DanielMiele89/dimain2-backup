...
IF OBJECT_ID('[Warehouse].[Selections].[PO041_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[PO041_PreSelection]
SELECT	FanID
INTO [Warehouse].[Selections].[PO041_PreSelection]
FROM #FB fb
WHERE EXISTS (	SELECT 1
				FROM Sandbox.RukanK.po_ferries_compsteal_p2 sb
