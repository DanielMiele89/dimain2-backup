...
--WHERE Txn >= 3
	...
	IF OBJECT_ID('[Warehouse].[Selections].[CT065_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[CT065_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[CT065_PreSelection]
	FROM #FB fb
