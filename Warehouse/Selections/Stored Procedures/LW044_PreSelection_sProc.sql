-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-11-29>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.LW044_PreSelection_sProcASBEGIN
...
from	#Final
where	Ntile = 1
If Object_ID('Warehouse.Selections.LW044_PreSelection') Is Not Null Drop Table Warehouse.Selections.LW044_PreSelectionSelect FanIDInto Warehouse.Selections.LW044_PreSelectionFrom sandbox.Conal.Laithwaites_AB_Test_10pctEND