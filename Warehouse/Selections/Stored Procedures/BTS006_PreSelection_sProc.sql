-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-03-22>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.BTS006_PreSelection_sProcASBEGIN
...
AND NOT EXISTS (	SELECT 1
					...
					WHERE cl.CINID = ct.CINID)If Object_ID('Warehouse.Selections.BTS006_PreSelection') Is Not Null Drop Table Warehouse.Selections.BTS006_PreSelectionSelect FanIDInto Warehouse.Selections.BTS006_PreSelectionFROM  #CUSTOMERSEND