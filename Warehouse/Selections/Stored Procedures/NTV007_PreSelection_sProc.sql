-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-07-10>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.NTV007_PreSelection_sProcASBEGIN/***********************************************************************************************************************
...
***********************************************************************************************************************/
	...
	FROM #Customers ddIf Object_ID('Warehouse.Selections.NTV007_PreSelection') Is Not Null Drop Table Warehouse.Selections.NTV007_PreSelectionSelect FanIDInto Warehouse.Selections.NTV007_PreSelectionFROM  WAREHOUSE.SELECTIONS.NTV_PRESELECTION_EXCLUSIONEND