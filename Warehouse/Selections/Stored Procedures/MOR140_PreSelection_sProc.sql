...
CREATE PROCEDURE [Selections].[MOR140_PreSelection_sProc]
AS
BEGIN
	...
	IF OBJECT_ID('[Warehouse].[Selections].[MOR140_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[MOR140_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[MOR140_PreSelection]
	FROM #FB fb
	WHERE EXISTS (	SELECT 1
					FROM Sandbox.RukanK.Morrisons_Medium_SoW_ATV_15_35_24022022 st
