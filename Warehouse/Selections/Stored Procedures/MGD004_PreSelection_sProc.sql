...
CREATE PROCEDURE [Selections].[MGD004_PreSelection_sProc]
AS
BEGIN
...
***********************************************************************************************************************/
	...
	If Object_ID('Warehouse.Selections.MGD004_PreSelection') IS NOT NULL DROP TABLE Warehouse.Selections.MGD004_PreSelection
	SELECT *
	INTO Warehouse.Selections.MGD004_PreSelection
	FROM #Customers
