...
CREATE PROCEDURE [Selections].[SDY012_PreSelection_sProc]
AS
BEGIN
...
--GROUP BY CINID
	...
	IF OBJECT_ID('[Warehouse].[Selections].[SDY012_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[SDY012_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[SDY012_PreSelection]
	FROM #FB fb
