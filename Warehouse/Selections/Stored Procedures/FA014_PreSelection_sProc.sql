-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-05-17>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.FA014_PreSelection_sProcASBEGINIF OBJECT_ID('tempdb..#CC') IS NOT NULL DROP TABLE #CC
Select	br.BrandID
		,br.BrandName
...
IF OBJECT_ID('sandbox.Conal.FI_General') IS NOT NULL DROP TABLE sandbox.Conal.FI_General
		...
		If Object_ID('Warehouse.Selections.FA014_PreSelection') Is Not Null Drop Table Warehouse.Selections.FA014_PreSelectionSelect FanIDInto Warehouse.Selections.FA014_PreSelectionFrom sandbox.Conal.FI_GeneralEND