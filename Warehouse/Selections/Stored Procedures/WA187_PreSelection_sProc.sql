-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-04-17>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE Procedure [Selections].[WA187_PreSelection_sProc]ASBEGIN
...
If Object_ID('Warehouse.Selections.WA187_PreSelection') Is Not Null Drop Table Warehouse.Selections.WA187_PreSelectionSelect FanIDInto Warehouse.Selections.WA187_PreSelectionFrom Warehouse.Selections.WA_PreSelectionWhere Flag = 'WA187'END