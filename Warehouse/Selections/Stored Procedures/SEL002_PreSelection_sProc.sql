-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-11-13>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.SEL002_PreSelection_sProcASBEGIN
...
LEFT JOIN 
	...
	FROM	#SEGMENTATION
	WHERE	IsCompShopper = 1 AND SEGMENT = 8If Object_ID('Warehouse.Selections.SEL002_PreSelection') Is Not Null Drop Table Warehouse.Selections.SEL002_PreSelectionSelect FanIDInto Warehouse.Selections.SEL002_PreSelectionFROM SANDBOX.CONAL.Selfridges_Selection_240920_AcquireINSERT Into Warehouse.Selections.SEL002_PreSelectionSelect FanIDFROM SANDBOX.CONAL.Selfridges_Selection_240920_LapsedEND