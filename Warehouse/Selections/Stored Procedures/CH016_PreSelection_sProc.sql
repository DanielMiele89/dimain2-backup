-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-03-22>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.CH016_PreSelection_sProcASBEGINIF OBJECT_ID('tempdb..#CC') IS NOT NULL DROP TABLE #CC
Select	br.BrandID
		,br.BrandName
...
on	cl.CINID = b.CINID
	...
	from #PubRestaurant_Spend
	where (Chef_Brewer_shopper_or_lapsed = 1 and Tesco_spender_6m = 1)If Object_ID('Warehouse.Selections.CH016_PreSelection') Is Not Null Drop Table Warehouse.Selections.CH016_PreSelectionSelect FanIDInto Warehouse.Selections.CH016_PreSelection
from #PubRestaurant_Spend
where (Chef_Brewer_shopper_or_lapsed = 1 and Tesco_spender_6m = 1)END