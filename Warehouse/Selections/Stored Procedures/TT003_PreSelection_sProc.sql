-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-02-05>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.TT003_PreSelection_sProcASBEGIN--SELECT *
...
AND		Amount > 0
GROUP BY F.CINIDIf Object_ID('Warehouse.Selections.TT003_PreSelection') Is Not Null Drop Table Warehouse.Selections.TT003_PreSelectionSelect FanIDInto Warehouse.Selections.TT003_PreSelectionFROM  SANDBOX.SAMW.TELEGRAPH050221 sbINNER JOIN #FB fb	ON sb.CINID = fb.CINIDEND