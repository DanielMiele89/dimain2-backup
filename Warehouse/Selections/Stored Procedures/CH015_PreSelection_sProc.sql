-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-03-22>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.CH015_PreSelection_sProcASBEGIN
...
on	cl.CINID = b.CINID
	...
	where Chef_Brewer_shopper_or_lapsed = 0
		...
		or (Chef_Brewer_shopper_or_lapsed = 1 and Tesco_spender_6m = 0)If Object_ID('Warehouse.Selections.CH015_PreSelection') Is Not Null Drop Table Warehouse.Selections.CH015_PreSelectionSelect FanIDInto Warehouse.Selections.CH015_PreSelectionFrom #PubRestaurant_Spend
	where Chef_Brewer_shopper_or_lapsed = 0
		or (Chef_Brewer_shopper_or_lapsed is null)
		or (Chef_Brewer_shopper_or_lapsed = 1 and Tesco_spender_6m = 0)END