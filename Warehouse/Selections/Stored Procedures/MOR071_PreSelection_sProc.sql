-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-10-19>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE [Selections].[MOR071_PreSelection_sProc]ASBEGINIF OBJECT_ID('tempdb..#FB') IS NOT NULL DROP TABLE #FB
SELECT CINID
		,FANID
INTO #FB
...
If Object_ID('Warehouse.Selections.MOR071_PreSelection') Is Not Null Drop Table Warehouse.Selections.MOR071_PreSelectionSelect FanIDInto Warehouse.Selections.MOR071_PreSelectionFROM  SANDBOX.SAMW.MorrisonsStIves011020 s
