...
CREATE PROCEDURE [Selections].[MOR135_PreSelection_sProc]
AS
BEGIN
...
-- ATV btw 20 - 50	-- SS £75
IF OBJECT_ID('Sandbox.rukank.Morrisons_High_SoW_ATV_20_50_02022022') IS NOT NULL DROP TABLE Sandbox.rukank.Morrisons_High_SoW_ATV_20_50_02022022		-- 44,879
SELECT	F.CINID
INTO	Sandbox.rukank.Morrisons_High_SoW_ATV_20_50_02022022
FROM	#Txn F
...
GROUP BY F.CINID					
	...
	IF OBJECT_ID('[Warehouse].[Selections].[MOR135_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[MOR135_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[MOR135_PreSelection]
	FROM #FB fb
	WHERE EXISTS (	SELECT 1
					FROM Sandbox.rukank.Morrisons_High_SoW_ATV_20_50_02022022 st
