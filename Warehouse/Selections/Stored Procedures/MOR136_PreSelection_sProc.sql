...
CREATE PROCEDURE [Selections].[MOR136_PreSelection_sProc]
AS
BEGIN
...
IF OBJECT_ID('Sandbox.rukank.Morrisons_High_SoW_ATV_50_02022022_2') IS NOT NULL DROP TABLE Sandbox.rukank.Morrisons_High_SoW_ATV_50_02022022_2				-- 31,331
SELECT	F.CINID
INTO	Sandbox.rukank.Morrisons_High_SoW_ATV_50_02022022_2
FROM	#Txn F
WHERE	ATV > 50 
		AND ATV <= 75
GROUP BY F.CINID							
	...
	IF OBJECT_ID('[Warehouse].[Selections].[MOR136_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[MOR136_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[MOR136_PreSelection]
	FROM #FB fb
	WHERE EXISTS (	SELECT 1
					FROM Sandbox.rukank.Morrisons_High_SoW_ATV_50_02022022_2 st
