...
AND		Amount > 0
AND		DATENAME(WEEKDAY, TranDate) IN ('FRIDAY','SATURDAY','SUNDAY')If Object_ID('Warehouse.Selections.CP007_PreSelection') Is Not Null Drop Table Warehouse.Selections.CP007_PreSelectionSelect FanIDInto Warehouse.Selections.CP007_PreSelectionFROM SANDBOX.EWAN.WITHINDISTANCEIHG100120END