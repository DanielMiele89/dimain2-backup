-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-02-21>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.WL013_PreSelection_sProcASBEGIN
...
If Object_ID('Warehouse.Selections.WL013_PreSelection') Is Not Null Drop Table Warehouse.Selections.WL013_PreSelectionSelect FanIDInto Warehouse.Selections.WL013_PreSelectionFROM  SANDBOX.SAMW.WLHDEDUPE290120END