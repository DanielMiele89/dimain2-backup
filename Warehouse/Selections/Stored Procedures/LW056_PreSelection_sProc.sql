-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-08-21>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE [Selections].[LW056_PreSelection_sProc]ASBEGIN
...
AND EndDate IS NULL
AND ShopperSegmentTypeID = 8If Object_ID('Warehouse.Selections.LW056_PreSelection') Is Not Null Drop Table Warehouse.Selections.LW056_PreSelectionSelect FanIDInto Warehouse.Selections.LW056_PreSelectionFROM  SANDBOX.VERNON.LAIT_SINGLE_TRANS_150420END