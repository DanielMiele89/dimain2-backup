-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-01-24>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.HS119_PreSelection_sProcASBEGIN
-- Get HS CCIDs
...
into #HScusCat
from #HScustomers cIf Object_ID('Warehouse.Selections.HS119_PreSelection') Is Not Null Drop Table Warehouse.Selections.HS119_PreSelectionSelect FanIDInto Warehouse.Selections.HS119_PreSelectionFrom #HScusCatwhere Category LIKE '%High%'END