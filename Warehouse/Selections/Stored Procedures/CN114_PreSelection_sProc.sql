-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-01-27>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.CN114_PreSelection_sProcASBEGINIF OBJECT_ID('tempdb..#CC') IS NOT NULL DROP TABLE #CC
SELECT br.BrandID,
		br.BrandName,
...
--ALS--
IF OBJECT_ID('Sandbox.Vernon.Caffe_Nero_SOW_210120') IS NOT NULL DROP TABLE Sandbox.Vernon.Caffe_Nero_SOW_210120
SELECT CINID,
		Fanid

INTO Sandbox.Vernon.Caffe_Nero_SOW_210120

FROM #ALS

WHERE (Acquired = 1 OR Lapsed = 1 OR Shopper = 1)If Object_ID('Warehouse.Selections.CN114_PreSelection') Is Not Null Drop Table Warehouse.Selections.CN114_PreSelectionSelect FanIDInto Warehouse.Selections.CN114_PreSelectionFROM  SANDBOX.VERNON.CAFFE_NERO_SOW_210120END