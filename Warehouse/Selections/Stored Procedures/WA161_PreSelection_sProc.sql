...
CREATE Procedure [Selections].[WA161_PreSelection_sProc]
AS
BEGIN
		...
		If Object_ID('Warehouse.Selections.WA161_PreSelection') Is Not Null Drop Table Warehouse.Selections.WA161_PreSelection
		Select FanID
		Into Warehouse.Selections.WA161_PreSelection
