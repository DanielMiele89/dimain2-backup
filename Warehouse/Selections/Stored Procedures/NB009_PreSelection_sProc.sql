...
from	#segmentAssignment
where	MainBrand_spender_2m is nullIf Object_ID('Warehouse.Selections.NB009_PreSelection') Is Not Null Drop Table Warehouse.Selections.NB009_PreSelectionSelect FanIDInto Warehouse.Selections.NB009_PreSelectionFROM  SANDBOX.CONAL.NOWTV_TV_BROADBAND_110119_ACQUIREEND