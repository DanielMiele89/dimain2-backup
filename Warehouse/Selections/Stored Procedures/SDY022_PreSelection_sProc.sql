...
GROUP BY CINID
	...
	IF OBJECT_ID('[Warehouse].[Selections].[SDY022_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[SDY022_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[SDY022_PreSelection]
	FROM #FB fb
