CREATE PROCEDURE [Selections].[DX027_PreSelection_sProc]
AS
BEGIN
...
IF OBJECT_ID('[Warehouse].[Selections].[DX027_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[DX027_PreSelection]
SELECT	fb.FanID
INTO [Warehouse].[Selections].[DX027_PreSelection]
