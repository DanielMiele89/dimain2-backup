...
CREATE PROCEDURE [Selections].[HIE018_PreSelection_sProc]
AS
BEGIN
...
GROUP BY BrandName,ct.CINID
	...
	IF OBJECT_ID('[Warehouse].[Selections].[HIE018_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[HIE018_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[HIE018_PreSelection]
	FROM #FB fb
