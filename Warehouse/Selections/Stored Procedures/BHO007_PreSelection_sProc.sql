CREATE PROCEDURE [Selections].[BHO007_PreSelection_sProc]
AS
BEGIN
...
IF OBJECT_ID('[Warehouse].[Selections].[BHO007_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[BHO007_PreSelection]
SELECT	fb.FanID
INTO [Warehouse].[Selections].[BHO007_PreSelection]
FROM #FB fb
