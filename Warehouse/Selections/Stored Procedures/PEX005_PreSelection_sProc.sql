...
CREATE PROCEDURE [Selections].[PEX005_PreSelection_sProc] 
AS  
BEGIN     
...
IF OBJECT_ID('[Warehouse].[Selections].[PEX005_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[PEX005_PreSelection]   
SELECT fb.FanID
INTO [Warehouse].[Selections].[PEX005_PreSelection]   
FROM #FB fb
