...
CREATE PROCEDURE [Selections].[MOR131_PreSelection_sProc_20220307]
AS
BEGIN
	...
	IF OBJECT_ID('Sandbox.rukank.Morrisons_Aldi_Lidl_11012022') IS NOT NULL DROP TABLE Sandbox.rukank.Morrisons_Aldi_Lidl_11012022		
	SELECT	F.CINID
	INTO	Sandbox.rukank.Morrisons_Aldi_Lidl_11012022
	FROM	#Aldi_Lidl F
	WHERE	Morrisons_SoW_diff >= 0.20
			and CINID NOT IN (SELECT CINID FROM					
											(SELECT CINID  FROM	Sandbox.rukank.Morrisons_Medium_SoW_ATV_0_15_10012022
											  UNION
											  SELECT CINID  FROM	Sandbox.rukank.Morrisons_Medium_SoW_ATV_15_35_10012022
											  UNION
											  SELECT CINID  FROM	Sandbox.rukank.Morrisons_Medium_SoW_ATV_35_10012022
											  ) A
							)
	GROUP BY F.CINID
	...
	WHERE EXISTS (	SELECT 1
					FROM Sandbox.RukanK.Morrisons_Aldi_Lidl_11012022 st
