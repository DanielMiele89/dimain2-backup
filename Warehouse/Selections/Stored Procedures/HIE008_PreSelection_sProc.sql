-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-02-05>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.HIE008_PreSelection_sProcASBEGINDECLARE @CYCLESTARTDATE DATE = '2020-02-13'
...
AND		Amount > 0
AND		DATENAME(WEEKDAY, TranDate) IN ('FRIDAY','SATURDAY','SUNDAY')If Object_ID('Warehouse.Selections.HIE008_PreSelection') Is Not Null Drop Table Warehouse.Selections.HIE008_PreSelectionSelect FanIDInto Warehouse.Selections.HIE008_PreSelectionFROM SANDBOX.EWAN.WITHINDISTANCEIHG100120END