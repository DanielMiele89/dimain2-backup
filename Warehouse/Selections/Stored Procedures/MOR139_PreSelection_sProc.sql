...
CREATE PROCEDURE [Selections].[MOR139_PreSelection_sProc]
AS
BEGIN
	...
	IF OBJECT_ID('[Warehouse].[Selections].[MOR139_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[MOR139_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[MOR139_PreSelection]
	FROM #FB fb
	WHERE EXISTS (	SELECT 1
					FROM Sandbox.RukanK.Morrisons_Medium_SoW_ATV_0_15_24022022 st
