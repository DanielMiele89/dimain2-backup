-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-02-21>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.GU011_PreSelection_sProcASBEGIN
...
if OBJECT_ID('sandbox.SamW.Gousto_Comp_remaining') is not null drop table sandbox.SamW.Gousto_Comp_remaining
select	CINID, FanID
into	sandbox.SamW.Gousto_Comp_remaining
From	#segmentAssignment
where	comp_shopper = 0If Object_ID('Warehouse.Selections.GU011_PreSelection') Is Not Null Drop Table Warehouse.Selections.GU011_PreSelectionSelect FanIDInto Warehouse.Selections.GU011_PreSelectionFROM SANDBOX.SAMW.GOUSTO_COMP_REMAININGEND