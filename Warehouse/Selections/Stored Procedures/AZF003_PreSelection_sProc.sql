...
-- =============================================
CREATE PROCEDURE [Selections].[AZF003_PreSelection_sProc]
AS
BEGIN
...
and a.CINID not in (select * from Sandbox.BastienC.AMAZON_FRESH_2)
--group by A.CINID,month(trandate),year(trandate);

IF OBJECT_ID('Sandbox.BastienC.AMAZON_FRESH_1') IS NOT NULL DROP TABLE Sandbox.BastienC.AMAZON_FRESH_1;
select distinct cinid
into Sandbox.BastienC.AMAZON_FRESH_1
from #CT2


If Object_ID('Warehouse.Selections.AZF003_PreSelection') Is Not Null Drop Table Warehouse.Selections.AZF003_PreSelection
Select FanID
Into Warehouse.Selections.AZF003_PreSelectionFROM Relational.Customer cuWHERE EXISTS (	SELECT 1				FROM [Relational].[CINList] cl				INNER JOIN SANDBOX.BASTIENC.AMAZON_FRESH_1 fo					ON cl.CINID = fo.CINID				WHERE cu.SourceUID = cl.CIN)
