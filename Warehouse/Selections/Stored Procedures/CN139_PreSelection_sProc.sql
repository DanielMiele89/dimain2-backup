-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-04-18>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE [Selections].[CN139_PreSelection_sProc]ASBEGINIF OBJECT_ID('tempdb..#FB') IS NOT NULL DROP TABLE #FB
SELECT	CINID ,FanID
INTO #FB
...
GROUP BY t3.CINIDIf Object_ID('Warehouse.Selections.CN139_PreSelection') Is Not Null Drop Table Warehouse.Selections.CN139_PreSelectionSelect FanIDInto Warehouse.Selections.CN139_PreSelectionFROM #FB fbWHERE EXISTS (	SELECT 1				FROM Sandbox.rukank.CaffeNero_Lapsed_Shopper_31082021 cl				WHERE fb.CINID = cl.CINID)END