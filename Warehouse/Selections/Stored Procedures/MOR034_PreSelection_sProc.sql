-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-07-25>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.MOR034_PreSelection_sProcASBEGIN
...
--		, case when Transactions >= 50 then 1 else 0 end
		...
		if OBJECT_ID('Sandbox.SamW.Morrisons_Q3_Selection_17072019') is not null drop table Sandbox.SamW.Morrisons_Q3_Selection_17072019
		select	 CINID
				, FanID
		into	Sandbox.SamW.Morrisons_Q3_Selection_17072019
		from	#segmentAssignment
		where	SoW_Morrisons <= 0.15
			and Comp_SoW >= 0.5
			and Transactions >= 75
...
If Object_ID('Warehouse.Selections.MOR034_PreSelection') Is Not Null Drop Table Warehouse.Selections.MOR034_PreSelectionSelect FanIDInto Warehouse.Selections.MOR034_PreSelectionFrom Sandbox.SamW.Morrisons_Q3_Selection_17072019END