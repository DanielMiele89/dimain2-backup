-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-09-10>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.CW013_PreSelection_sProcASBEGIN
...
WHERE (MainBrand_Spender_48M = 0 AND Comp_Spender_48M = 1)If Object_ID('Warehouse.Selections.CW013_PreSelection') Is Not Null Drop Table Warehouse.Selections.CW013_PreSelectionSelect FanIDInto Warehouse.Selections.CW013_PreSelectionFrom Sandbox.Tasfia.CarphoneWarehouse_CompSteal_100419END