-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-10-02>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE Procedure [Selections].[HS113_PreSelection_sProc]ASBEGIN
...
into #HScusCat
from #HScustomers cIf Object_ID('Warehouse.Selections.HS113_PreSelection') Is Not Null Drop Table Warehouse.Selections.HS113_PreSelectionSelect FanIDInto Warehouse.Selections.HS113_PreSelectionFrom #HScusCatwhere Category LIKE '%High%'END