...
create PROCEDURE [Selections].[__Partner_GenerateTriggerMember_CJM_Archived]
			(
			@CampaignID INT
			)
...
BEGIN
		...
		EXEC Staging.oo_TimerMessage 'Partner_GenerateTriggerMember', @time Output		
	...
	EXEC Staging.oo_TimerMessage 'Populated #Customers1', @time Output		
	...
	EXEC Staging.oo_TimerMessage 'Populated #Customers2', @time Output		
	...
	EXEC Staging.oo_TimerMessage 'Populated #Customers3', @time Output	
	...
	EXEC Staging.oo_TimerMessage 'PartnerTrigger_Members populated', @time Output		
...
EXEC Staging.oo_TimerMessage 'Leaving Partner_GenerateTriggerMember', @time Output	
