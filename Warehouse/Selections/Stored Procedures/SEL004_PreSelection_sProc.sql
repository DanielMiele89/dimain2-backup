-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-02-20>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.SEL004_PreSelection_sProcASBEGIN
/*
...
LEFT JOIN 
	...
	AND		CINID NOT IN (SELECT CINID 
						FROM (SELECT CINID 
							...
							UNION 
							SELECT CINID
							FROM SANDBOX.SamW.Selfridges_Selection_260121_LapsedWelcome) A)If Object_ID('Warehouse.Selections.SEL004_PreSelection') Is Not Null Drop Table Warehouse.Selections.SEL004_PreSelectionSelect FanIDInto Warehouse.Selections.SEL004_PreSelectionFROM  SANDBOX.SamW.Selfridges_Selection_260121_AcquireCoreUNION ALLSelect FanIDFROM  SANDBOX.SamW.Selfridges_Selection_260121_LapsedCoreEND