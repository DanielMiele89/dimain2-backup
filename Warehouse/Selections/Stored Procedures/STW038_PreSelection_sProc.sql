...
AND EndDate IS NULL
AND ShopperSegmentTypeID IN(7, 8)If Object_ID('Warehouse.Selections.STW038_PreSelection') Is Not Null Drop Table Warehouse.Selections.STW038_PreSelectionSelect FanIDInto Warehouse.Selections.STW038_PreSelectionFROM  sandbox.vernon.STWC_single_trans_150420END