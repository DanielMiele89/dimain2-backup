-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-07-24>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE [Selections].[MOR111_PreSelection_sProc]ASBEGIN
...
CREATE CLUSTERED INDEX CIX_ConsumerCombinationID ON #CC (DataSource, ConsumerCombinationID)
...
WHERE BrandShopper = 1
	  ...
	  AND Transactions >= 55
GROUP BY F.CINID
If Object_ID('Warehouse.Selections.MOR111_PreSelection') Is Not Null Drop Table Warehouse.Selections.MOR111_PreSelectionSelect FanIDInto Warehouse.Selections.MOR111_PreSelectionFROM  #FB fbWHERE EXISTS (	SELECT 1				FROM Sandbox.rukank.Morrisons_LoW_SoW_17082021 st				WHERE fb.CINID = st.CINID)END
