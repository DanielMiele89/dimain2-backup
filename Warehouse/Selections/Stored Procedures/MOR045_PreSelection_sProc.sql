-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-12-06>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.MOR045_PreSelection_sProcASBEGIN
...
--		, case when Transactions >= 50 then 1 else 0 end
		...
		if OBJECT_ID('Sandbox.SamW.Morrisons_December_Proposalv2') is not null drop table Sandbox.SamW.Morrisons_December_Proposalv2
		select	 CINID
				, FanID
		into	Sandbox.SamW.Morrisons_December_Proposalv2
		from	#segmentAssignment
		where	SoW_Morrisons <= 0.10
			--and Comp_SoW >= 0.5
			and Transactions >= 55
...
If Object_ID('Warehouse.Selections.MOR045_PreSelection') Is Not Null Drop Table Warehouse.Selections.MOR045_PreSelectionSelect FanIDInto Warehouse.Selections.MOR045_PreSelectionFrom Sandbox.SamW.Morrisons_December_Proposalv2END