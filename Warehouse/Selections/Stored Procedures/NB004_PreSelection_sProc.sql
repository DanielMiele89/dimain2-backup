-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-02-21>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.NB004_PreSelection_sProcASBEGIN
...
from	#segmentAssignment
where	MainBrand_spender_2m is nullIf Object_ID('Warehouse.Selections.NB004_PreSelection') Is Not Null Drop Table Warehouse.Selections.NB004_PreSelectionSelect FanIDInto Warehouse.Selections.NB004_PreSelectionFROM  SANDBOX.CONAL.NOWTV_TV_BROADBAND_110119_ACQUIREEND