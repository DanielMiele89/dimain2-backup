-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-08-21>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.MOR064_PreSelection_sProcASBEGINIF OBJECT_ID('tempdb..#FB') IS NOT NULL DROP TABLE #FB
SELECT CINID
		,FANID
INTO #FB
...
If Object_ID('Warehouse.Selections.MOR064_PreSelection') Is Not Null Drop Table Warehouse.Selections.MOR064_PreSelectionSelect FanIDInto Warehouse.Selections.MOR064_PreSelectionFROM  Sandbox.SamW.MorrisonsGlenfield040820END