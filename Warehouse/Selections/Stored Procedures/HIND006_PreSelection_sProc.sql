-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-04-18>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE [Selections].[HIND006_PreSelection_sProc]ASBEGIN--	HIND006IF OBJECT_ID('tempdb..#FB') IS NOT NULL DROP TABLE #FB
SELECT	CINID
		,FanID
		,AgeCurrent
INTO #FB
...
GROUP BY BrandName,ct.CINIDIf Object_ID('Warehouse.Selections.HIND006_PreSelection') Is Not Null Drop Table Warehouse.Selections.HIND006_PreSelectionSelect FanIDInto Warehouse.Selections.HIND006_PreSelectionFROM #FB fbWHERE EXISTS (	SELECT 1				FROM Sandbox.bastienc.week_spender_INDIGO cl				WHERE fb.CINID = cl.CINID)END