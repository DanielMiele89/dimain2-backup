-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-08-07>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.WL015_PreSelection_sProcASBEGIN
...
If Object_ID('Warehouse.Selections.WL015_PreSelection') Is Not Null Drop Table Warehouse.Selections.WL015_PreSelectionSelect FanIDInto Warehouse.Selections.WL015_PreSelectionFROM  SANDBOX.SAMW.WLHDEDUPE290120END