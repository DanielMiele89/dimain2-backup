...
FROM Sandbox.SamW.MorrisonsTotalCombo1501202
WHERE ATV_BANDS IN ('£65 - £75', '£75 - £85', '£85+')If Object_ID('Warehouse.Selections.MOR049_PreSelection') Is Not Null Drop Table Warehouse.Selections.MOR049_PreSelectionSelect FanIDInto Warehouse.Selections.MOR049_PreSelectionFROM  SANDBOX.SAMW.MorrisonsHighATVEND