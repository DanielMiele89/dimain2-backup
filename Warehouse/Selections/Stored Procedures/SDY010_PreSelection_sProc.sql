...
CREATE PROCEDURE [Selections].[SDY010_PreSelection_sProc]
AS
BEGIN
...
GROUP BY CINID
	...
	IF OBJECT_ID('[Warehouse].[Selections].[SDY010_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[SDY010_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[SDY010_PreSelection]
	FROM #FB fb
	WHERE EXISTS (	SELECT 1
					FROM Sandbox.samh.superdryAcq_GROUP1_04022022 st
