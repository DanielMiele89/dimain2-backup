...
-- =============================================
Create Procedure Selections.BB009_PreSelection_sProc
AS
BEGIN
...
If Object_ID('Warehouse.Selections.BB009_PreSelection') Is Not Null Drop Table Warehouse.Selections.BB009_PreSelection
Select FanID
Into Warehouse.Selections.BB009_PreSelection
From #finalselection
