-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-06-25>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.SEL012_PreSelection_sProcASBEGIN/*
...
UNION ALL
SELECT FanID
FROM SANDBOX.SamW.Selfridges_Selection_260121_LapsedOtherIf Object_ID('Warehouse.Selections.SEL012_PreSelection') Is Not Null Drop Table Warehouse.Selections.SEL012_PreSelectionSelect FanIDInto Warehouse.Selections.SEL012_PreSelectionFROM  #SELECTIONEND