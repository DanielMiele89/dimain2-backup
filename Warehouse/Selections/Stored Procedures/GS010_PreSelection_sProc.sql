...
GROUP BY CINID
	...
	IF OBJECT_ID('[Warehouse].[Selections].[GS010_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[GS010_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[GS010_PreSelection]
	FROM #FB_rbs fb
