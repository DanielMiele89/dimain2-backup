...
CREATE PROCEDURE [Selections].[LW080_PreSelection_sProc]
AS
BEGIN
...
FROM	#trans_rbs
	...
	IF OBJECT_ID('[Warehouse].[Selections].[LW080_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[LW080_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[LW080_PreSelection]
