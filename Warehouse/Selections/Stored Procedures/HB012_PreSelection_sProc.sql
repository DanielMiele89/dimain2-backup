...
CREATE Procedure [Selections].[HB012_PreSelection_sProc]
AS
BEGIN
	...
	If Object_ID('Warehouse.Selections.HB012_PreSelection') Is Not Null Drop Table Warehouse.Selections.HB012_PreSelection
	Select FanID
	Into Warehouse.Selections.HB012_PreSelection
	From #Activated_HM2
	Where Response_Index >=100
