-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-12-22>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.CTA011_PreSelection_sProcASBEGINIF OBJECT_ID('tempdb..#FB') IS NOT NULL DROP TABLE #FB
SELECT	CINID
		,FANID
INTO #FB
...
AND		CostaSoW < 0.9
AND		CostaShopper = 1
If Object_ID('Warehouse.Selections.CTA011_PreSelection') Is Not Null Drop Table Warehouse.Selections.CTA011_PreSelectionSelect FanIDInto Warehouse.Selections.CTA011_PreSelectionFROM  SANDBOX.SAMW.COSTA60TO90SOW180820END