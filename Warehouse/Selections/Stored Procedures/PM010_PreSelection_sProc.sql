...
IF OBJECT_ID('[Warehouse].[Selections].[PM010_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[PM010_PreSelection]
SELECT	FanID
INTO [Warehouse].[Selections].[PM010_PreSelection]
