...
JOIN	Relational.Customer C ON C.PostalSector = DTM.FromSector

JOIN	#HI ON #HI.PostalSector = DTM.FromSector

AND DriveTimeMins < = @MINDRIVETIME
...
--SANDBOX--
IF OBJECT_ID('Sandbox.SamW.Holiday_Inn_City_Centres_20062019') IS NOT NULL DROP TABLE Sandbox.SamW.Holiday_Inn_City_Centres_20062019
SELECT	#SA.FanID
		,#SA.CINID

INTO Sandbox.SamW.Holiday_Inn_City_Centres_20062019

FROM #SA

CREATE CLUSTERED INDEX ix_ComboID ON Sandbox.SamW.Holiday_Inn_City_Centres_20062019(CINID)If Object_ID('Warehouse.Selections.HI004_PreSelection') Is Not Null Drop Table Warehouse.Selections.HI004_PreSelectionSelect FanIDInto Warehouse.Selections.HI004_PreSelectionFrom Sandbox.SamW.Holiday_Inn_City_Centres_20062019END