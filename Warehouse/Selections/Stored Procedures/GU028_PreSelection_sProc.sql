-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-04-18>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE [Selections].[GU028_PreSelection_sProc]ASBEGINIF OBJECT_ID('tempdb..#FB') IS NOT NULL DROP TABLE #FB
SELECT CINID
		,FANID
INTO #FB
...
WHERE	TranDate >= @DATE_12If Object_ID('Warehouse.Selections.GU028_PreSelection') Is Not Null Drop Table Warehouse.Selections.GU028_PreSelectionSelect FanIDInto Warehouse.Selections.GU028_PreSelectionFROM  SANDBOX.SAMW.GOUSTOCOMPSTEAL060720END