-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-06-11>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE [Selections].[LW069_PreSelection_sProc]ASBEGINIF OBJECT_ID('tempdb..#CC') IS NOT NULL DROP TABLE #CC
Select	br.BrandID
		,br.BrandName
...
on	cl.CINID = b.CINID
	...
	FROM (	SELECT FanID
			...
			AND EndDate IS NULL
			AND ShopperSegmentTypeID IN (7, 8)) sIf Object_ID('Warehouse.Selections.LW069_PreSelection') Is Not Null Drop Table Warehouse.Selections.LW069_PreSelectionSelect FanIDInto Warehouse.Selections.LW069_PreSelectionFROM  #PRESELECTIONEND