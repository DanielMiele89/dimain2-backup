-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-02-22>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.WGC008_PreSelection_sProcASBEGINIF OBJECT_ID('tempdb..#CC') IS NOT NULL DROP TABLE #CC
Select	br.BrandID
		,br.BrandName
...
select
	 targetable 
	, sum(MainBrand_spend_12M) as MainBrand_spend_12M
	, sum(MainBrand_spend_24M) as MainBrand_spend_24M 
	, sum(MainBrand_spend_12_24M) as MainBrand_spend_12_24M 
	, count(*)as custs 
from 
	#segmentAssignment
group by 
...
group by 
	...
	, MainBrand_spend_12M
	, MainBrand_spend_24M 
	If Object_ID('Warehouse.Selections.WGC008_PreSelection') Is Not Null Drop Table Warehouse.Selections.WGC008_PreSelectionSelect FanIDInto Warehouse.Selections.WGC008_PreSelectionFrom #segmentAssignment
where targetable = 1 
