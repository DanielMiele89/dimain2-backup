CREATE PROCEDURE [Selections].[LW079_PreSelection_sProc]
AS
BEGIN
...
IF OBJECT_ID('[Warehouse].[Selections].[LW079_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[LW079_PreSelection]
SELECT	fb.FanID
INTO [Warehouse].[Selections].[LW079_PreSelection]
FROM #FB fb
