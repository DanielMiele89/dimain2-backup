-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-07-12>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.LE019_PreSelection_sProcASBEGINIF OBJECT_ID('tempdb..#CC') IS NOT NULL DROP TABLE #CC;
...
WHERE EXISTS (	SELECT 1
				...
				WHERE cu.SourceUID = cl.CIN)If Object_ID('Warehouse.Selections.LE019_PreSelection') Is Not Null Drop Table Warehouse.Selections.LE019_PreSelectionSelect FanIDInto Warehouse.Selections.LE019_PreSelectionFROM  #SEGMENTASSIGNMENTEND