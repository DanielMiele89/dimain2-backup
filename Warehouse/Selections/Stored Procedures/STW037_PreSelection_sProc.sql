...
CREATE PROCEDURE [Selections].[STW037_PreSelection_sProc]
AS
BEGIN
...
FROM	#trans_rbs
	...
	IF OBJECT_ID('[Warehouse].[Selections].[STW037_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[STW037_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[STW037_PreSelection]
