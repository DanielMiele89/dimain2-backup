...
CREATE PROCEDURE [Selections].[MOR128_PreSelection_sProc_20220307]
AS
BEGIN
	...
	-- ATV > 35
	IF OBJECT_ID('Sandbox.rukank.Morrisons_Medium_SoW_ATV_35_10012022') IS NOT NULL DROP TABLE Sandbox.rukank.Morrisons_Medium_SoW_ATV_35_10012022
	SELECT	F.CINID
	INTO	Sandbox.rukank.Morrisons_Medium_SoW_ATV_35_10012022
	FROM	#Txn F
	WHERE	ATV > 35
	GROUP BY F.CINID
	...
	WHERE EXISTS (	SELECT 1
					FROM Sandbox.RukanK.Morrisons_Medium_SoW_ATV_35_10012022 st
