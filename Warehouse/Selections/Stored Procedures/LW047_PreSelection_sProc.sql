-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-02-05>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE [Selections].[LW047_PreSelection_sProc]ASBEGIN
...
from	#Final
where	Ntile = 1
If Object_ID('Warehouse.Selections.LW047_PreSelection') Is Not Null Drop Table Warehouse.Selections.LW047_PreSelectionSelect FanIDInto Warehouse.Selections.LW047_PreSelectionFROM SANDBOX.CONAL.LAITHWAITES_AB_TEST_10PCTEND