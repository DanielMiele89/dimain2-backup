...
IF OBJECT_ID('Sandbox.SamW.Wyevale_CH_220519') IS NOT NULL DROP TABLE Sandbox.SamW.Wyevale_CH_220519
SELECT CINID,
		FanID

INTO Sandbox.SamW.Wyevale_CH_220519
...
IF OBJECT_ID('Sandbox.SamW.Wyevale_NS_220519') IS NOT NULL DROP TABLE Sandbox.SamW.Wyevale_NS_220519
SELECT CINID,
		FanID

INTO Sandbox.SamW.Wyevale_NS_220519

FROM #SegmentAssignment

WHERE (MainBrand_Shopper_NS = 0 OR MainBrand_Shopper_NS IS NULL)If Object_ID('Warehouse.Selections.WGC015_PreSelection') Is Not Null Drop Table Warehouse.Selections.WGC015_PreSelectionSelect FanIDInto Warehouse.Selections.WGC015_PreSelectionFrom Sandbox.SamW.Wyevale_CH_220519END