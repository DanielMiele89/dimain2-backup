...
CREATE PROCEDURE [Selections].[PM013_PreSelection_sProc]
AS
BEGIN
...
SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED
	...
	*******************************************************************************************************************************************/
		...
		IF OBJECT_ID('[Warehouse].[Selections].[PM013_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[PM013_PreSelection]
		SELECT	FanID
		INTO [Warehouse].[Selections].[PM013_PreSelection]
		FROM #AllCustomers
