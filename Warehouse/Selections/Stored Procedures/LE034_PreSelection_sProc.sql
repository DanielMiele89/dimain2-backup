CREATE PROCEDURE [Selections].[LE034_PreSelection_sProc]
AS
BEGIN
...
IF OBJECT_ID('[Warehouse].[Selections].[LE034_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[LE034_PreSelection]
SELECT	fb.FanID
INTO [Warehouse].[Selections].[LE034_PreSelection]
FROM #FB fb
