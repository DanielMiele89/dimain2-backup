...
CREATE PROCEDURE [Selections].[HIND008_PreSelection_sProc]
AS
BEGIN
...
GROUP BY BrandName,ct.CINID
	...
	IF OBJECT_ID('[Warehouse].[Selections].[HIND008_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[HIND008_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[HIND008_PreSelection]
	FROM #FB fb
