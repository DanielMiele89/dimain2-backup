...
on	cl.CINID = b.CINID
	...
	-- Tesco LS selection
	IF OBJECT_ID('sandbox.Conal.CB_Tesco') IS NOT NULL DROP TABLE sandbox.Conal.CB_Tesco
	select CINID, FanID
	into sandbox.Conal.CB_Tesco
	from #PubRestaurant_Spend
	where (Chef_Brewer_shopper_or_lapsed = 1 and Tesco_spender_6m = 1)If Object_ID('Warehouse.Selections.CH018_PreSelection') Is Not Null Drop Table Warehouse.Selections.CH018_PreSelectionSelect FanIDInto Warehouse.Selections.CH018_PreSelectionFrom sandbox.Conal.CB_TescoEND