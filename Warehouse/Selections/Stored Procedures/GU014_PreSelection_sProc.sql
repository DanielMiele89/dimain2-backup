-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-08-07>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.GU014_PreSelection_sProcASBEGINIF OBJECT_ID('tempdb..#FB') IS NOT NULL DROP TABLE #FB
SELECT CINID
		,FANID
INTO #FB
...
WHERE	TranDate >= @OneYearAgoIf Object_ID('Warehouse.Selections.GU014_PreSelection') Is Not Null Drop Table Warehouse.Selections.GU014_PreSelectionSelect FanIDInto Warehouse.Selections.GU014_PreSelectionFROM  SANDBOX.SAMW.GOUSTOCOMPSTEAL060720END