...
FROM Sandbox.SamW.MorrisonsTotalCombo1501202
WHERE ATV_BANDS IN ('£65 - £75', '£75 - £85', '£85+')If Object_ID('Warehouse.Selections.MOR047_PreSelection') Is Not Null Drop Table Warehouse.Selections.MOR047_PreSelectionSelect FanIDInto Warehouse.Selections.MOR047_PreSelectionFROM  SANDBOX.SAMW.MorrisonsLowATVEND