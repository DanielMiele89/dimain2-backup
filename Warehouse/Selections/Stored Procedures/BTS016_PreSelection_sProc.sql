-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-07-09>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE [Selections].[BTS016_PreSelection_sProc]ASBEGINIF OBJECT_ID('tempdb..#FB') IS NOT NULL DROP TABLE #FB
SELECT	CINID
		,FanID
INTO #FB
...
GROUP BY F.CINID
If Object_ID('Warehouse.Selections.BTS016_PreSelection') Is Not Null Drop Table Warehouse.Selections.BTS016_PreSelectionSelect FanIDInto Warehouse.Selections.BTS016_PreSelection
from #FB 
