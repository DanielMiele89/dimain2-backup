...
CREATE PROCEDURE [Selections].[SDY023_PreSelection_sProc]
AS
BEGIN
...
--GROUP BY CINID
	...
	IF OBJECT_ID('[Warehouse].[Selections].[SDY023_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[SDY023_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[SDY023_PreSelection]
	FROM #FB fb
