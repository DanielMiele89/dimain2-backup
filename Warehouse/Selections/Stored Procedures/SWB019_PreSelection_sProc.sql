...
IF OBJECT_ID('[Warehouse].[Selections].[SWB019_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[SWB019_PreSelection]   
SELECT fb.FanID
INTO [Warehouse].[Selections].[SWB019_PreSelection]   
FROM #FB_rbs fb
