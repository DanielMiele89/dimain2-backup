-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-10-02>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE Procedure [Selections].[EJ106_PreSelection_sProc]ASBEGIN
-- Get EJ CCIDs
...
If Object_ID('Warehouse.Selections.EJ106_PreSelection') Is Not Null Drop Table Warehouse.Selections.EJ106_PreSelectionSelect FanIDInto Warehouse.Selections.EJ106_PreSelectionFrom #EJcusCatwhere Category LIKE '%Medium%'END