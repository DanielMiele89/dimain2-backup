-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-09-18>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE [Selections].[LW058_PreSelection_sProc]ASBEGIN
...
AND EndDate IS NULL
AND ShopperSegmentTypeID = 8If Object_ID('Warehouse.Selections.LW058_PreSelection') Is Not Null Drop Table Warehouse.Selections.LW058_PreSelectionSelect FanIDInto Warehouse.Selections.LW058_PreSelectionFROM  SANDBOX.VERNON.Lait_single_trans_150420END