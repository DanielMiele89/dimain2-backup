-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-10-18>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.WL019_PreSelection_sProcASBEGIN
...
If Object_ID('Warehouse.Selections.WL019_PreSelection') Is Not Null Drop Table Warehouse.Selections.WL019_PreSelectionSelect FanIDInto Warehouse.Selections.WL019_PreSelectionFROM  SANDBOX.SAMW.WLHDEDUPE290120END