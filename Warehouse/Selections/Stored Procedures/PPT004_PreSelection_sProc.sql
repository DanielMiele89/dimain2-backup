-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-04-18>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.PPT004_PreSelection_sProcASBEGINSET NOCOUNT ON
SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED
	...
	*******************************************************************************************************************************************/
		...
		IF OBJECT_ID('Sandbox.Rory.PaulP_Lapsing_20210418') IS NOT NULL DROP TABLE Sandbox.Rory.PaulP_Lapsing_20210418
		SELECT *
		INTO Sandbox.Rory.PaulP_Lapsing_20210418
		FROM (	SELECT	FanID
					,	TranDate
					,	Segment
				FROM #AllCustomers ac
				WHERE Segment IN ('Lapsing')) acIf Object_ID('Warehouse.Selections.PPT004_PreSelection') Is Not Null Drop Table Warehouse.Selections.PPT004_PreSelectionSelect FanIDInto Warehouse.Selections.PPT004_PreSelectionFROM  SANDBOX.RORY.PAULP_LAPSING_20210418END