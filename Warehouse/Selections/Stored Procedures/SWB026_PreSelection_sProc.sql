...
IF OBJECT_ID('[Warehouse].[Selections].[SWB026_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[SWB026_PreSelection]   
SELECT fb.FanID
INTO [Warehouse].[Selections].[SWB026_PreSelection]   
FROM #FB_rbs fb
