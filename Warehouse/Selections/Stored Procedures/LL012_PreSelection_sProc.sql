CREATE PROCEDURE [Selections].[LL012_PreSelection_sProc]
AS
BEGIN
...
IF OBJECT_ID('[Warehouse].[Selections].[LL012_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[LL012_PreSelection]
SELECT	FanID
INTO [Warehouse].[Selections].[LL012_PreSelection]
FROM #FB fb
