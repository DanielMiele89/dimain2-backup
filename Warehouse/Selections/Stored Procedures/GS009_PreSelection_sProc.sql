...
GROUP BY CINID
	...
	IF OBJECT_ID('[Warehouse].[Selections].[GS009_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[GS009_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[GS009_PreSelection]
	FROM #FB_rbs fb
