CREATE PROCEDURE [Selections].[CN140_PreSelection_sProc]
AS
BEGIN
...
IF OBJECT_ID('[Warehouse].[Selections].[CN140_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[CN140_PreSelection]
SELECT	FanID
INTO [Warehouse].[Selections].[CN140_PreSelection]
FROM #FB fb
