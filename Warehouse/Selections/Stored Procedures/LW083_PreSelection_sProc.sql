...
CREATE PROCEDURE [Selections].[LW083_PreSelection_sProc]
AS
BEGIN
...
FROM	#trans_rbs
	...
	IF OBJECT_ID('[Warehouse].[Selections].[LW083_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[LW083_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[LW083_PreSelection]
