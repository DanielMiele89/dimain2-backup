...
CREATE PROCEDURE [Selections].[SKY003_PreSelection_sProc]
AS
BEGIN
...
***********************************************************************************************************************/
	...
	If Object_ID('Warehouse.Selections.SKY003_PreSelection') IS NOT NULL DROP TABLE Warehouse.Selections.SKY003_PreSelection
	SELECT *
	INTO Warehouse.Selections.SKY003_PreSelection
	FROM #ToAction ta
	WHERE ta.NewOfferID = @SkyOffer3
