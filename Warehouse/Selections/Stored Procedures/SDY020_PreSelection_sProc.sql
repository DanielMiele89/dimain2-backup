...
CREATE PROCEDURE [Selections].[SDY020_PreSelection_sProc]
AS
BEGIN
...
GROUP BY CINID
	...
	IF OBJECT_ID('[Warehouse].[Selections].[SDY020_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[SDY020_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[SDY020_PreSelection]
	FROM #FB fb
