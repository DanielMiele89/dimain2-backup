-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-10-18>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.WL020_PreSelection_sProcASBEGIN
...
If Object_ID('Warehouse.Selections.WL020_PreSelection') Is Not Null Drop Table Warehouse.Selections.WL020_PreSelectionSelect FanIDInto Warehouse.Selections.WL020_PreSelectionFROM  SANDBOX.SAMW.WLHTop10290120END