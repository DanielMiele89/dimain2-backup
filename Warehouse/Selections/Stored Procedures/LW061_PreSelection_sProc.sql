-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-10-05>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.LW061_PreSelection_sProcASBEGINIF OBJECT_ID('tempdb..#CC') IS NOT NULL DROP TABLE #CC
Select	br.BrandID
		,br.BrandName
...
INSERT INTO sandbox.vernon.Lait_single_trans_150420
SELECT	CINID
	,	sg.FanID
...
AND EndDate IS NULL
AND ShopperSegmentTypeID = 8If Object_ID('Warehouse.Selections.LW061_PreSelection') Is Not Null Drop Table Warehouse.Selections.LW061_PreSelectionSelect FanIDInto Warehouse.Selections.LW061_PreSelectionFROM  SANDBOX.VERNON.Lait_single_trans_150420END