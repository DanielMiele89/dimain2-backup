...
CREATE PROCEDURE [Selections].[MOR162_PreSelection_sProc]
AS
BEGIN
...
GROUP BY F.CINID
	...
	IF OBJECT_ID('[Warehouse].[Selections].[MOR162_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[MOR162_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[MOR162_PreSelection]
	FROM #FB fb
