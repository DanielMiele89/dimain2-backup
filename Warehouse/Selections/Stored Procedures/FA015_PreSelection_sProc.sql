-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-06-14>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.FA015_PreSelection_sProcASBEGIN	declare @FHI int = 2016
	...
	on	cl.CINID = b.CINID
		...
		-- General
		if OBJECT_ID('Sandbox.Conal.FarmHouseInns_General') is not null drop table Sandbox.Conal.FarmHouseInns_General
		select	 CINID
				, FanID
		into	Sandbox.Conal.FarmHouseInns_General
		from	#PubRestaurant_Spend
		where	Farmhouse_shopper = 1 or Farmhouse_shopper is nullIf Object_ID('Warehouse.Selections.FA015_PreSelection') Is Not Null Drop Table Warehouse.Selections.FA015_PreSelectionSelect FanIDInto Warehouse.Selections.FA015_PreSelectionFrom Sandbox.Conal.FarmHouseInns_GeneralEND