-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-05-03>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE [Selections].[BTS010_PreSelection_sProc]ASBEGINIF OBJECT_ID('tempdb..#FB') IS NOT NULL DROP TABLE #FB
SELECT	CINID
		,FanID
INTO #FB
...
GROUP BY F.CINID
If Object_ID('Warehouse.Selections.BTS010_PreSelection') Is Not Null Drop Table Warehouse.Selections.BTS010_PreSelectionSelect FanIDInto Warehouse.Selections.BTS010_PreSelection
from #FB 
