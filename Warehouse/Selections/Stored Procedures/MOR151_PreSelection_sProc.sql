...
CREATE PROCEDURE [Selections].[MOR151_PreSelection_sProc]
AS
BEGIN
...
-- ATV btw 0 - 15
IF OBJECT_ID('Sandbox.rukank.Morrisons_Medium_SoW_ATV_0_15_31032022') IS NOT NULL DROP TABLE Sandbox.rukank.Morrisons_Medium_SoW_ATV_0_15_31032022			--27,483
SELECT	F.CINID
INTO	Sandbox.rukank.Morrisons_Medium_SoW_ATV_0_15_31032022
FROM	#Txn F
WHERE	ATV < 15
GROUP BY F.CINID


	IF OBJECT_ID('[Warehouse].[Selections].[MOR151_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[MOR151_PreSelection]
	SELECT FanID
	INTO [Warehouse].[Selections].[MOR151_PreSelection]
	FROM #FB fb
	WHERE EXISTS (	SELECT 1
					FROM Sandbox.rukank.Morrisons_Medium_SoW_ATV_0_15_31032022  st
