...
CREATE PROCEDURE [Selections].[SWB023_PreSelection_sProc] 
AS  
BEGIN
...
IF OBJECT_ID('[Warehouse].[Selections].[SWB023_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[SWB023_PreSelection]   
SELECT fb.FanID
INTO [Warehouse].[Selections].[SWB023_PreSelection]   
FROM #FB_rbs fb
WHERE EXISTS (	SELECT 1
				FROM Sandbox.bastienc.sweatyBetty_RBS st
