-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-01-09>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.GU009_PreSelection_sProcASBEGINIF OBJECT_ID('tempdb..#CC') IS NOT NULL DROP TABLE #CC
SELECT br.BrandID,
		br.BrandName,
...
If Object_ID('Warehouse.Selections.GU009_PreSelection') Is Not Null Drop Table Warehouse.Selections.GU009_PreSelectionSelect FanIDInto Warehouse.Selections.GU009_PreSelectionFrom Sandbox.Tasfia.Gousto_CompSteal_080319END