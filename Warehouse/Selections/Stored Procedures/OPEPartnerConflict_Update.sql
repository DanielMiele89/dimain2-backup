...
*/
CREATE PROCEDURE [Selections].[OPEPartnerConflict_Update] (@Email DATE)
...
-----------------------------------------------------------------------------------------------
	...
	FROM (	SELECT pc.RuleID
			...
			FROM [Selections].[OPE_PartnerConflict] pc
	...
	INTO #OldRules
	FROM [Selections].[OPE_PartnerConflict] pc
	INNER JOIN [Selections].[OfferPrioritisation] op
...
-----------------------------------------------------------------------------------------------
	...
	FROM [Selections].[OPEPartnerConflict] pc
