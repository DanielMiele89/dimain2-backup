...
CREATE Procedure  [Selections].[WA139_PreSelection_sProc_Secondary]
AS
BEGIN
	...
	from 
	 ...
	 Create Index IX_WA_PreSelection_FlagFan on Warehouse.Selections.WA_PreSelection (flag, FanID)

	If object_id('Warehouse.Selections.WA139_Selection_Secondary') is not null drop table Warehouse.Selections.WA139_Selection_Secondary
	Select FanID
	Into Warehouse.Selections.WA139_Selection_Secondary
	From Warehouse.Selections.WA_PreSelection
	Where flag = 'Cell 03.0-10%'

	Create Index IX_WA139_Selection_Secondary_Fan on Warehouse.Selections.WA139_Selection_Secondary (FanID)
