-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-05-30>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE Selections.HIND004_PreSelection_sProcASBEGIN
...
AND TranDate >= @Date	If Object_ID('Warehouse.Selections.HIND004_PreSelection') Is Not Null Drop Table Warehouse.Selections.HIND004_PreSelectionSelect FanIDInto Warehouse.Selections.HIND004_PreSelectionFROM Relational.Customer cuWHERE EXISTS (	SELECT 1				FROM SANDBOX.BASTIENC.CROWNE_PLAZA_HOTEL_INDIGO st				INNER JOIN Relational.CINList cl					ON st.CINID = cl.CINID				WHERE cu.SourceUID = cl.CIN)END