-- =============================================-- Author:  <Rory Francis>-- Create date: <2020-08-21>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE [Selections].[STW012_PreSelection_sProc]ASBEGIN
...
AND EndDate IS NULL
AND ShopperSegmentTypeID = 8If Object_ID('Warehouse.Selections.STW012_PreSelection') Is Not Null Drop Table Warehouse.Selections.STW012_PreSelectionSelect FanIDInto Warehouse.Selections.STW012_PreSelectionFROM  SANDBOX.VERNON.STWC_SINGLE_TRANS_150420END