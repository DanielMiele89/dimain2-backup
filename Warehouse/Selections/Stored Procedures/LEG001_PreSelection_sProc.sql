-- =============================================-- Author:  <Rory Francis>-- Create date: <2019-09-20>-- Description: < sProc to run preselection code per camapign >-- =============================================Create Procedure Selections.LEG001_PreSelection_sProcASBEGIN/*SELECT *
...
OR Acquired = 1
OR ACQUIRED IS NULL
If Object_ID('Warehouse.Selections.LEG001_PreSelection') Is Not Null Drop Table Warehouse.Selections.LEG001_PreSelectionSelect FanIDInto Warehouse.Selections.LEG001_PreSelectionFrom Sandbox.SamW.Lego170919END