...
SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED
	...
	*******************************************************************************************************************************************/
		...
		FROM #AllCustomers
		WHERE Segment = 'Lapsing'If Object_ID('Warehouse.Selections.PM005_PreSelection') Is Not Null Drop Table Warehouse.Selections.PM005_PreSelectionSelect FanIDInto Warehouse.Selections.PM005_PreSelectionFROM  SANDBOX.RORY.POOCHMUTTLAPSING_20210617END