CREATE PROCEDURE [Selections].[CN135_PreSelection_sProc]
AS
BEGIN
...
IF OBJECT_ID('[Warehouse].[Selections].[CN135_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[CN135_PreSelection]
SELECT	FanID
INTO [Warehouse].[Selections].[CN135_PreSelection]
FROM #FB fb
