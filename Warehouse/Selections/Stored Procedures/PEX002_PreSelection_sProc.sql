...
CREATE PROCEDURE [Selections].[PEX002_PreSelection_sProc]
AS
BEGIN
...
IF OBJECT_ID('[Warehouse].[Selections].[PEX002_PreSelection]') IS NOT NULL DROP TABLE [Warehouse].[Selections].[PEX002_PreSelection]
SELECT	FanID
INTO [Warehouse].[Selections].[PEX002_PreSelection]
FROM #FB fb
