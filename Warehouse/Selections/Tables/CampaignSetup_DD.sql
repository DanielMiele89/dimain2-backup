CREATE TABLE [Selections].[CampaignSetup_DD] (
...
CREATE NONCLUSTERED INDEX [IX_StartDate_IncEmailDate]
    ON [Selections].[CampaignSetup_DD]([StartDate] ASC)
    INCLUDE([EmailDate]);


GO
CREATE NONCLUSTERED INDEX [IX_OfferID]
    ON [Selections].[CampaignSetup_DD]([OfferID] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_EmailDate]
    ON [Selections].[CampaignSetup_DD]([EmailDate] ASC);
