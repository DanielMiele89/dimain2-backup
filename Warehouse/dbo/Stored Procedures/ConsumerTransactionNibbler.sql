...
WHILE 1 = 1 BEGIN
	...
	IF @@SERVERNAME <> 'DIMAIN2' BEGIN
		EXEC('DROP INDEX csx_Stuff ON Relational.ConsumerTransaction_p' + @strPartitionID + '_Stage');
	END
	...
	IF @@SERVERNAME <> 'DIMAIN2' BEGIN
		EXEC('CREATE NONCLUSTERED COLUMNSTORE INDEX [csx_Stuff] ON Relational.ConsumerTransaction_p' + @strPartitionID + '_Stage
