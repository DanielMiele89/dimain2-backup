...
-- =============================================
CREATE PROCEDURE [MI].[USPFigures_RefreshHayden] 
...
BEGIN
	...
	VALUES('Total Transactions Calculated (Hayden)')
	...
	INSERT INTO MI.USPAudit(AuditAction)
	VALUES('Total Transactions Last Year Calculated (Hayden)')
	...
	INSERT INTO MI.USPAudit(AuditAction)
	VALUES('Total Transactions Last Month Calculated (Hayden)')
	...
	INSERT INTO MI.USPAudit(AuditAction)
	VALUES('Scheme Activations Calculated (Hayden)')
	...
	--INSERT INTO MI.USPAudit(AuditAction)
	--VALUES('Earnings Total Calculated (Hayden)')

	--SPEND TOTAL -- 23/05/2015 added to include Total Spend
	--SELECT @SpendTotal = SUM(TransactionAmount) FROM Relational.PartnerTrans

	--SELECT @SpendTotal += SUM(Amount) FROM Relational.AdditionalCashbackAward
	--where MatchID is null

	INSERT INTO MI.USPAudit(AuditAction)
	VALUES('Spend Total Calculated (Hayden)')

	--SECTOR TOTAL
	SELECT @SectorCount = COUNT(1) FROM Relational.BrandSector

	INSERT INTO MI.USPAudit(AuditAction)
	VALUES('Sector Count Calculated (Hayden)')

	--BRAND TOTAL
	SELECT @BrandCount = COUNT(1) FROM Relational.Brand

	INSERT INTO MI.USPAudit(AuditAction)
	VALUES('Brand Count Calculated (Hayden)')
	...
	INSERT INTO MI.USPAudit(AuditAction)
	VALUES('Cardholder Count Calculated (Hayden)')
	...
	INSERT INTO MI.USPAudit(AuditAction)
	VALUES('Gender Count Calculated (Hayden)')
	...
	INSERT INTO MI.USPAudit(AuditAction)
	VALUES('Retailer Stats Calculated (Hayden)')
	...
	INSERT INTO MI.USPAudit(AuditAction)
	VALUES('Yearly Transaction Spend Calculated (Hayden)')
	...
	INSERT INTO MI.USPAudit(AuditAction)
	VALUES('Age Band Values Updated (Hayden)')


	INSERT INTO MI.USP_Hayden(StatsDate
		, TotalTransactions
	...
	INSERT INTO MI.USPAudit(AuditAction)
	VALUES('Statistics Inserted (Hayden)')
/**** Unused ***
...
**************/
	...
	INSERT INTO MI.USPAudit(AuditAction)
	VALUES('Age Band Inserted (Hayden)')
	...
	INSERT INTO MI.USPAudit(AuditAction)
	VALUES('Process Complete (Hayden)')
