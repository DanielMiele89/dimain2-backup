...
CREATE PROCEDURE [MI].[TotalBrandSpend_RBSG_UpdateSingleBrand_V2_20210702] (@BrandID INT)
AS
BEGIN

	--DECLARE @BrandID INT = 2891
...
GO
GRANT EXECUTE
    ON OBJECT::[MI].[TotalBrandSpend_RBSG_UpdateSingleBrand_V2_20210702] TO [New_Branding]
    AS [dbo];
