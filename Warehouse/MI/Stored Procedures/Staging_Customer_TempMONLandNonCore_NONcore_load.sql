...
-- =============================================
CREATE PROCEDURE [MI].[Staging_Customer_TempMONLandNonCore_NONcore_load] (@DateID INT, @PartnerID INT, @ClientServiceRef nvarchar(30))
...
insert into MI.Staging_Customer_Temp (FanID,
ProgramID,
PartnerID,
ClientServicesRef,
CumulativeTypeID,
