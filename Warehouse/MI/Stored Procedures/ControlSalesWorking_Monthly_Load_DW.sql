...
-- =============================================
CREATE PROCEDURE [MI].[ControlSalesWorking_Monthly_Load_DW] (@DateID int, @Partnerid int, @ControlPartnerid int)
...
inner join Mi.Staging_Control_Temp c on
...
INTO #Customers	
FROM  Mi.Staging_Control_Temp CON 
