...
-- =============================================
CREATE PROCEDURE [MI].[EarnRedeemFinance_RBS_Totals_Month_Refresh] 
	(
		@IsMonthEnd BIT = 1
	)
...
BEGIN
	...
	INSERT INTO MI.EarnRedeemFinance_RBS_Totals_Month(BrandID, PaymentMethodID, IsRBS, ChargeTypeID, Earnings, RedemptionValue, EligibleEarnings, IneligibleEarnings, NoLiability)
