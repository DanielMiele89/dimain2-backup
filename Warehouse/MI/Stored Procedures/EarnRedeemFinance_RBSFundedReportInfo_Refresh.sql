...
-- =============================================
CREATE PROCEDURE [MI].[EarnRedeemFinance_RBSFundedReportInfo_Refresh]
	(
		@IsMonthEnd BIT = 1
	)
...
BEGIN
    ...
    TRUNCATE TABLE MI.EarnRedeemFinance_RBSFundedReportInfo
	...
	FROM MI.EarnRedeemFinance_RBS_Totals e
	...
	INSERT INTO MI.EarnRedeemFinance_RBSFundedReportInfo(
		YearNumber
		, MonthNumber
		, PartnerID
		, PartnerName
	...
	(
		...
		FROM MI.EarnRedeemFinance_RBS_Totals t
		LEFT OUTER JOIN MI.EarnRedeemFinance_RBS_Totals_Month m	
			ON t.BrandID = m. BrandID
			AND t.PaymentMethodID = m.PaymentMethodID
			AND t.ChargeTypeID = m.ChargeTypeID
			AND t.IsRBS = m.IsRBS
		LEFT OUTER JOIN MI.EarnRedeemFinance_RBS_EligibleCustomers c
	...
	INSERT INTO MI.EarnRedeemFinance_RBSFundedReportInfo_Archive(
		YearNumber
		, MonthNumber
		, PartnerID
		, PartnerName
	...
	INSERT INTO MI.EarnRedeemFinance_RBS_EligibleCustomersTotal_Archive(
