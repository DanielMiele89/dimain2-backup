...
CREATE PROCEDURE [MI].[CampaignResults_Calculate] (@ClientServicesRef varchar(25)=NULL, @StartDate DATE=NULL, @DatabaseName NVARCHAR(400)='Sandbox') AS -- -- unhide this row to modify SP
...
BEGIN
    ...
    WHERE ID=@MY_ID
    --PRINT 'Part1'
    EXEC MI. CampaignResults_Calculate_Part1 @ClientServicesRef, @StartDate, @DatabaseName
