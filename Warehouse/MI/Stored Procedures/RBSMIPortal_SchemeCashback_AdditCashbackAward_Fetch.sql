...
-- =============================================
CREATE PROCEDURE [MI].[RBSMIPortal_SchemeCashback_AdditCashbackAward_Fetch]
	(
		@Incremental BIT = 1
	)
AS
BEGIN
	...
	WHERE @Incremental = 0 OR ac.AddedDate > @ACAAddedDate
	--ac.AddedDate between '2019-06-05' and '2019-06-08'
