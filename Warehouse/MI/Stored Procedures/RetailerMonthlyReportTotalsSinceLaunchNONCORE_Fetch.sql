...
-- =============================================
Create PROCEDURE [MI].[RetailerMonthlyReportTotalsSinceLaunchNONCORE_Fetch]
...
FROM #MonthTotals RM
   ...
   INNER JOIN [Warehouse].[MI].[retailerreportmonthly] RMC ON RM.partnerID = RMC.partnerID AND RMC.monthid = RM.Monthid and RMC.LabelID = ML.CumulativeLabelID and RMC.ClientServicesRef = @ClientServicesRef
