...
-- =============================================
CREATE PROCEDURE [MI].[RetailerReportMetricCumulativeFix_Commission]  (@DateID INT, @CumulativeTypeID INT, @PartnerID INT = NULL)
...
and rm.CustomerAttributeID not in (1,2,3,4)
and rm.CustomerAttributeID  < 3000
