...
-- =============================================
CREATE PROCEDURE [MI].[RBSMIPortal_SchemeCashback_AdditCashbackAward_Fetch_Catchup]
...
BEGIN
	...
	INNER JOIN RBSMIPortal.AwardsMissing am ON ac.FileID = am.FileID and ac.RowNum = am.RowNum
