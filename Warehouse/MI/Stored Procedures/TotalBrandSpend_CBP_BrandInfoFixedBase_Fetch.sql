...
-- Description:	Sources brand-level information for the Total Brand Spend report - CBP Version
-- =============================================
CREATE PROCEDURE [MI].[TotalBrandSpend_CBP_BrandInfoFixedBase_Fetch] 
...
BEGIN
	...
	FROM MI.TotalBrandSpendFixedBase_CBP t
