...
-- =============================================
CREATE PROCEDURE [MI].[CBP_DailyMIReport_Load_New] 
...
BEGIN
	...
	@subject = 'Warning 42',
	@body='MI.CBP_DailyMIReport_Load_New called unexpectedly',
	@body_format = 'TEXT', 
	@importance = 'HIGH', 
	@exclude_query_output = 1

	TRUNCATE TABLE MI.CBP_DailyMIReport_New
	...
	BEGIN
		INSERT INTO MI.CBP_DailyMIReport_New
		(
			[CUSTOMER ID],
			[E-MAIL ADDRESS],
			[MOBILE NUMBER],
