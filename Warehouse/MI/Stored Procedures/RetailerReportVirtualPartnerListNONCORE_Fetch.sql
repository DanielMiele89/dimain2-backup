...
-- =============================================
CReate PROCEDURE [MI].[RetailerReportVirtualPartnerListNONCORE_Fetch] 
	(
		@MonthID Int
	)
AS
BEGIN
	...
	SELECT P.[VirtualPartnerID], ISNULL(S.PartnerID, 0) As ControlGroupID, p.Scheme_StartDate, p.Scheme_EndDate
	FROM 
		(
