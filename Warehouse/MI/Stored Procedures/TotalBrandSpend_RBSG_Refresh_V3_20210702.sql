...
CREATE PROCEDURE [MI].[TotalBrandSpend_RBSG_Refresh_V3_20210702]
AS
BEGIN
	...
	*******************************************************************************************************************************************/
		...
		***********************************************************************************************************************/
			...
			CREATE COLUMNSTORE INDEX CSX_All ON ##CT_AllTrans (DirectDebit, IsOnline, MyRewardsCustomer, BrandID, SectorID, SectorGroupID, CurrentYear, Amount, Transactions, FanID) -- 00:06:00
	...
	*******************************************************************************************************************************************/
		...
		***********************************************************************************************************************/
			...
			INSERT INTO [MI].[TotalBrandSpend_RBSG_SectorGroup] (FilterID, SectorGroupID, SectorGroupName, TransactionChannel, CustomerType, TransactionType, Amount, Transactions, Customers, TotalCustomers, CurrentYear)
			SELECT 1 AS FilterID
				 , SectorGroupID
