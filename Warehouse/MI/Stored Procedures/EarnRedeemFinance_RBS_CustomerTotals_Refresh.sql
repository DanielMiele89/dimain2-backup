...
-- =============================================
CREATE PROCEDURE [MI].[EarnRedeemFinance_RBS_CustomerTotals_Refresh] 
	(
		@IsMonthEnd BIT = 1
	)
...
BEGIN
	...
	FROM MI.EarnRedeemFinance_RBS_Totals
	...
	BEGIN
		...
		INSERT INTO MI.EarnRedeemFinance_RBS_EligibleCustomers(BrandID
			, PaymentMethodID
			, IsRBS
			, ChargeTypeID
			, EligibleCount
	...
	INSERT INTO MI.EarnRedeemFinance_RBS_EligibleCustomersTotal(
