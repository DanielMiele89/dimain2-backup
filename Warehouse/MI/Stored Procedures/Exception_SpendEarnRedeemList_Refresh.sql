...
-- =============================================
CREATE PROCEDURE [MI].[Exception_SpendEarnRedeemList_Refresh]
...
BEGIN
	...
	TRUNCATE TABLE MI.RBSPortal_Exception_SpendEarnRedeemList
	...
	INSERT INTO MI.RBSPortal_Exception_SpendEarnRedeemList (LineType 
		,CIN
		,PartnerName
		,AddMonth
		,AddYear
