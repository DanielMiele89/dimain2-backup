CREATE TABLE [MI].[CampaignExternalResultsLTEFinalWave_Segment] (
    ...
    CONSTRAINT [UNQ_CampaignExternalResultsLTEFinalWave_Segment] UNIQUE NONCLUSTERED ([Effect] ASC, [ClientServicesRef] ASC, [StartDate] ASC, [SegmentID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignExternalResultsLTEFinalWave_Segment]([SegmentID] ASC);


GO
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignExternalResultsLTEFinalWave_Segment]([ClientServicesRef] ASC, [StartDate] ASC);
