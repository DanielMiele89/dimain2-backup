CREATE TABLE [MI].[MRR_MemberSales_Working] (
    ...
    [DateID]                  INT           NOT NULL,
    [MemberSales]             SMALLMONEY    NOT NULL,
    [MemberTransactions]      INT           NULL,
    [FanID]                   INT           NOT NULL,
    [IsPost]                  BIT           NOT NULL,
    [Cardholders]             INT           NOT NULL,
    CONSTRAINT [MI_MRR_MemberSales_Working] PRIMARY KEY CLUSTERED ([ID] ASC)
);
