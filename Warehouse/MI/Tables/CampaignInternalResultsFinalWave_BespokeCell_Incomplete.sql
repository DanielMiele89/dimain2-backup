CREATE TABLE [MI].[CampaignInternalResultsFinalWave_BespokeCell_Incomplete] (
    ...
    CONSTRAINT [UNQ_CampaignResultsFinalWave_BespokeCell_Incomplete] UNIQUE NONCLUSTERED ([ClientServicesRef] ASC, [StartDate] ASC, [Cell] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignInternalResultsFinalWave_BespokeCell_Incomplete]([Cell] ASC);


GO
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignInternalResultsFinalWave_BespokeCell_Incomplete]([ClientServicesRef] ASC, [StartDate] ASC);
