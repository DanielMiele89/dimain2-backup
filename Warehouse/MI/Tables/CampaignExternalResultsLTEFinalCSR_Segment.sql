CREATE TABLE [MI].[CampaignExternalResultsLTEFinalCSR_Segment] (
    ...
    CONSTRAINT [UNQ_CampaignResultsLTEExternalFinalCSR_Segment] UNIQUE NONCLUSTERED ([Effect] ASC, [ClientServicesRef] ASC, [SegmentID] ASC)
);
...
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignExternalResultsLTEFinalCSR_Segment]([ClientServicesRef] ASC);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignExternalResultsLTEFinalCSR_Segment]([SegmentID] ASC);
...
CREATE TRIGGER [MI].[TrgAfterInsert_ExternalResultsLTEFinalCSR_Segment] ON [Warehouse].[MI].[CampaignExternalResultsLTEFinalCSR_Segment]
AFTER INSERT
AS
