CREATE TABLE [MI].[CampaignInternalResultsFinalCSR_SuperSegment] (
    ...
    CONSTRAINT [UNQ_CampaignResultsFinalCSR_SuperSegment] UNIQUE NONCLUSTERED ([ClientServicesRef] ASC, [SegmentID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignInternalResultsFinalCSR_SuperSegment]([SegmentID] ASC);


GO
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignInternalResultsFinalCSR_SuperSegment]([ClientServicesRef] ASC);
...
CREATE TRIGGER [MI].[TrgAfterInsert_InternalResultsFinalCSR_SuperSegment] ON [Warehouse].[MI].[CampaignInternalResultsFinalCSR_SuperSegment]
AFTER INSERT
AS
