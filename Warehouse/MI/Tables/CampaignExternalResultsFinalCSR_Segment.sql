CREATE TABLE [MI].[CampaignExternalResultsFinalCSR_Segment] (
    ...
    CONSTRAINT [UNQ_CampaignResultsOutOfProgrammeFinalCSR_Segment] UNIQUE NONCLUSTERED ([ClientServicesRef] ASC, [SegmentID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignExternalResultsFinalCSR_Segment]([ClientServicesRef] ASC);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignExternalResultsFinalCSR_Segment]([SegmentID] ASC);
...
CREATE TRIGGER [MI].[TrgAfterInsert_ExternalResultsFinalCSR_Segment] ON [Warehouse].[MI].[CampaignExternalResultsFinalCSR_Segment]
AFTER INSERT
AS
