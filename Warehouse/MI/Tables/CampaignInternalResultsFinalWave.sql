CREATE TABLE [MI].[CampaignInternalResultsFinalWave] (
    ...
    CONSTRAINT [UNQ_CampaignResultsFinalWave] UNIQUE NONCLUSTERED ([ClientServicesRef] ASC, [StartDate] ASC)
);
...
CREATE TRIGGER [MI].[TrgAfterInsert_ResultsFinalWave] ON [Warehouse].[MI].[CampaignInternalResultsFinalWave]
AFTER INSERT
AS
