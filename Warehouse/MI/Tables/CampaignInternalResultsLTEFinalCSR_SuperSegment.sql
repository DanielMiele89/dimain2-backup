CREATE TABLE [MI].[CampaignInternalResultsLTEFinalCSR_SuperSegment] (
    ...
    CONSTRAINT [UNQ_CampaignResultsLTEInternalFinalCSR_SuperSegment] UNIQUE NONCLUSTERED ([Effect] ASC, [ClientServicesRef] ASC, [SegmentID] ASC)
);
...
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignInternalResultsLTEFinalCSR_SuperSegment]([ClientServicesRef] ASC);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignInternalResultsLTEFinalCSR_SuperSegment]([SegmentID] ASC);
...
CREATE TRIGGER [MI].[TrgAfterInsert_InternalResultsLTEFinalCSR_SuperSegment] ON [Warehouse].[MI].[CampaignInternalResultsLTEFinalCSR_SuperSegment]
AFTER INSERT
AS
