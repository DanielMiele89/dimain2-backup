CREATE TABLE [MI].[CampaignExternalResultsLTEFinalWave_SuperSegment] (
    ...
    CONSTRAINT [UNQ_CampaignExternalResultsLTEFinalWave_SuperSegment] UNIQUE NONCLUSTERED ([Effect] ASC, [ClientServicesRef] ASC, [StartDate] ASC, [SegmentID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignExternalResultsLTEFinalWave_SuperSegment]([SegmentID] ASC);


GO
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignExternalResultsLTEFinalWave_SuperSegment]([ClientServicesRef] ASC, [StartDate] ASC);
