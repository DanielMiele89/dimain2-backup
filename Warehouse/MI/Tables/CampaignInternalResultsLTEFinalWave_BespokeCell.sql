CREATE TABLE [MI].[CampaignInternalResultsLTEFinalWave_BespokeCell] (
    ...
    CONSTRAINT [UNQ_CampaignInternalResultsLTEFinalWave_BespokeCell] UNIQUE NONCLUSTERED ([Effect] ASC, [ClientServicesRef] ASC, [StartDate] ASC, [Cell] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignInternalResultsLTEFinalWave_BespokeCell]([ClientServicesRef] ASC, [StartDate] ASC);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignInternalResultsLTEFinalWave_BespokeCell]([Cell] ASC);
