CREATE TABLE [MI].[CampaignInternalResultsFinalWave_Incomplete] (
    ...
    CONSTRAINT [UNQ_CampaignResultsFinalWave_Incomplete] UNIQUE NONCLUSTERED ([ClientServicesRef] ASC, [StartDate] ASC)
);
