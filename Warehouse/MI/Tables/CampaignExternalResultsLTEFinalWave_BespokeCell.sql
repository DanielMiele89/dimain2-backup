CREATE TABLE [MI].[CampaignExternalResultsLTEFinalWave_BespokeCell] (
    ...
    CONSTRAINT [UNQ_CampaignExternalResultsLTEFinalWave_BespokeCell] UNIQUE NONCLUSTERED ([Effect] ASC, [ClientServicesRef] ASC, [StartDate] ASC, [Cell] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignExternalResultsLTEFinalWave_BespokeCell]([ClientServicesRef] ASC, [StartDate] ASC);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignExternalResultsLTEFinalWave_BespokeCell]([Cell] ASC);
