CREATE TABLE [MI].[CampaignInternalResultsFinalCSR] (
    ...
    CONSTRAINT [UNQ_CampaignResultsFinalCSR] UNIQUE NONCLUSTERED ([ClientServicesRef] ASC)
);
...
CREATE TRIGGER [MI].[TrgAfterInsert_ResultsFinalCSR] ON [Warehouse].[MI].[CampaignInternalResultsFinalCSR]
AFTER INSERT
AS
