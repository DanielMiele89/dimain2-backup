CREATE TABLE [MI].[CampaignExternalResultsFinalCSR_SuperSegment_Incomplete] (
    ...
    CONSTRAINT [UNQ_CampaignResultsOutOfProgrammeFinalCSR_SuperSegment_Incomplete] UNIQUE NONCLUSTERED ([ClientServicesRef] ASC, [SegmentID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignExternalResultsFinalCSR_SuperSegment_Incomplete]([SegmentID] ASC);


GO
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignExternalResultsFinalCSR_SuperSegment_Incomplete]([ClientServicesRef] ASC);
