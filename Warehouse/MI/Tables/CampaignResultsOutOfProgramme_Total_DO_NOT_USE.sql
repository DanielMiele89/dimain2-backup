CREATE TABLE [MI].[CampaignResultsOutOfProgramme_Total_DO_NOT_USE] (
...
GO
CREATE TRIGGER [MI].[OOPTrgAfterInsert4] ON [Warehouse].[MI].[CampaignResultsOutOfProgramme_Total_DO_NOT_USE] 
AFTER INSERT
AS
    UPDATE Warehouse.MI.CampaignResultsOutOfProgramme_Total_Total_DO_NOT_USE 
...
GO
CREATE TRIGGER [MI].[OOPNewTrgAfterUpdate4] ON [Warehouse].[MI].[CampaignResultsOutOfProgramme_Total_DO_NOT_USE] 
AFTER UPDATE
AS
    UPDATE Warehouse.MI.CampaignResultsOutOfProgramme_Total_DO_NOT_USE
