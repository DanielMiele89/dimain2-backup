CREATE TABLE [MI].[TotalBrandSpend_MyRewards_CorePrivate_Archive] (
    [ID]                                   INT      IDENTITY (1, 1) NOT NULL,
    [GenerationDate]                       DATE     CONSTRAINT [DF__MI_TotalBrandSpend_MyRewards_CorePrivate_GenerationDate] DEFAULT (getdate()) NOT NULL,
    ...
    CONSTRAINT [PK_MI_TotalBrandSpend_MyRewards_CorePrivate_Archive] PRIMARY KEY CLUSTERED ([ID] ASC)
);
