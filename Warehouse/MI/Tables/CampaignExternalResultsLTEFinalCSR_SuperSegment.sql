CREATE TABLE [MI].[CampaignExternalResultsLTEFinalCSR_SuperSegment] (
    ...
    CONSTRAINT [UNQ_CampaignResultsLTEExternalFinalCSR_SuperSegment] UNIQUE NONCLUSTERED ([Effect] ASC, [ClientServicesRef] ASC, [SegmentID] ASC)
);
...
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignExternalResultsLTEFinalCSR_SuperSegment]([ClientServicesRef] ASC);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignExternalResultsLTEFinalCSR_SuperSegment]([SegmentID] ASC);
...
CREATE TRIGGER [MI].[TrgAfterInsert_ExternalResultsLTEFinalCSR_SuperSegment] ON [Warehouse].[MI].[CampaignExternalResultsLTEFinalCSR_SuperSegment]
AFTER INSERT
AS
