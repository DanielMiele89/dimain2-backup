CREATE TABLE [MI].[CampaignInternalResultsLTEFinalCSR_BespokeCell] (
    ...
    CONSTRAINT [UNQ_CampaignResultsLTEInternalFinalCSR_BespokeCell] UNIQUE NONCLUSTERED ([Effect] ASC, [ClientServicesRef] ASC, [Cell] ASC)
);
...
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignInternalResultsLTEFinalCSR_BespokeCell]([ClientServicesRef] ASC);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignInternalResultsLTEFinalCSR_BespokeCell]([Cell] ASC);
...
CREATE TRIGGER [MI].[TrgAfterInsert_InternalResultsLTEFinalCSR_BespokeCell] ON [Warehouse].[MI].[CampaignInternalResultsLTEFinalCSR_BespokeCell]
AFTER INSERT
AS
