CREATE TABLE [MI].[CampaignExternalResultsFinalCSR_Segment_Incomplete] (
    ...
    CONSTRAINT [UNQ_CampaignResultsOutOfProgrammeFinalCSR_Segment_Incomplete] UNIQUE NONCLUSTERED ([ClientServicesRef] ASC, [SegmentID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignExternalResultsFinalCSR_Segment_Incomplete]([ClientServicesRef] ASC);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignExternalResultsFinalCSR_Segment_Incomplete]([SegmentID] ASC);
