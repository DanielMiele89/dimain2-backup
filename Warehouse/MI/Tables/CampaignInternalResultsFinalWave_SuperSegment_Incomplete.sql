CREATE TABLE [MI].[CampaignInternalResultsFinalWave_SuperSegment_Incomplete] (
    ...
    CONSTRAINT [UNQ_CampaignResultsFinalWave_SuperSegment_Incomplete] UNIQUE NONCLUSTERED ([ClientServicesRef] ASC, [StartDate] ASC, [SegmentID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignInternalResultsFinalWave_SuperSegment_Incomplete]([ClientServicesRef] ASC, [StartDate] ASC);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignInternalResultsFinalWave_SuperSegment_Incomplete]([SegmentID] ASC);
