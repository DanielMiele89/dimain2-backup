CREATE TABLE [MI].[CampaignInternalResultsLTEFinalWave] (
    ...
    CONSTRAINT [UNQ_CampaignInternalResultsLTEFinalWave] UNIQUE NONCLUSTERED ([Effect] ASC, [ClientServicesRef] ASC, [StartDate] ASC)
);


GO

CREATE TRIGGER [MI].[TrgAfterInsert_InternalResultsLTEFinalWave] ON [Warehouse].[MI].[CampaignInternalResultsLTEFinalWave]
AFTER INSERT
AS
