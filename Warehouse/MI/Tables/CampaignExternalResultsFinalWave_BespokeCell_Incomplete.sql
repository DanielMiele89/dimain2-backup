CREATE TABLE [MI].[CampaignExternalResultsFinalWave_BespokeCell_Incomplete] (
    ...
    CONSTRAINT [UNQ_CampaignResultsOutofProgrammeFinalWave_BespokeCell_Incomplete] UNIQUE NONCLUSTERED ([ClientServicesRef] ASC, [StartDate] ASC, [Cell] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignExternalResultsFinalWave_BespokeCell_Incomplete]([ClientServicesRef] ASC, [StartDate] ASC);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignExternalResultsFinalWave_BespokeCell_Incomplete]([Cell] ASC);
