CREATE TABLE [MI].[CampaignExternalResultsFinalWave_Segment] (
    ...
    CONSTRAINT [UNQ_CampaignResultsOutofProgrammeFinalWave_Segment] UNIQUE NONCLUSTERED ([ClientServicesRef] ASC, [StartDate] ASC, [SegmentID] ASC)
);
...
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignExternalResultsFinalWave_Segment]([ClientServicesRef] ASC, [StartDate] ASC);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignExternalResultsFinalWave_Segment]([SegmentID] ASC);
...
CREATE  TRIGGER [MI].[TrgAfterInsert_ExternalResultsFinalWave_Segment] ON [Warehouse].[MI].[CampaignExternalResultsFinalWave_Segment]
AFTER INSERT
AS
