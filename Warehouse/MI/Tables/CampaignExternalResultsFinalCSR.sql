CREATE TABLE [MI].[CampaignExternalResultsFinalCSR] (
    ...
    CONSTRAINT [UNQ_CampaignResultsOutOfProgrammeFinalCSR] UNIQUE NONCLUSTERED ([ClientServicesRef] ASC)
);
...
CREATE TRIGGER [MI].[TrgAfterInsert_ExternalResultsFinalCSR] ON [Warehouse].[MI].[CampaignExternalResultsFinalCSR]
AFTER INSERT
AS
