CREATE TABLE [MI].[CampaignExternalResultsFinalCSR_SuperSegment] (
    ...
    CONSTRAINT [UNQ_CampaignResultsOutOfProgrammeFinalCSR_SuperSegment] UNIQUE NONCLUSTERED ([ClientServicesRef] ASC, [SegmentID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignExternalResultsFinalCSR_SuperSegment]([ClientServicesRef] ASC);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignExternalResultsFinalCSR_SuperSegment]([SegmentID] ASC);
...
CREATE TRIGGER [MI].[TrgAfterInsert_ExternalResultsFinalCSR_SuperSegment] ON [Warehouse].[MI].[CampaignExternalResultsFinalCSR_SuperSegment]
AFTER INSERT
AS
