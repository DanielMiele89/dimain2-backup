CREATE TABLE [MI].[CampaignExternalResultsFinalWave_Incomplete] (
    ...
    CONSTRAINT [UNQ_CampaignResultsOutofProgrammeFinalWave_Incomplete] UNIQUE NONCLUSTERED ([ClientServicesRef] ASC, [StartDate] ASC)
);
