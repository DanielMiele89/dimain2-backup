CREATE TABLE [MI].[CampaignInternalResultsFinalWave_Segment] (
    ...
    CONSTRAINT [UNQ_CampaignResultsFinalWave_Segment] UNIQUE NONCLUSTERED ([ClientServicesRef] ASC, [StartDate] ASC, [SegmentID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignInternalResultsFinalWave_Segment]([ClientServicesRef] ASC, [StartDate] ASC);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignInternalResultsFinalWave_Segment]([SegmentID] ASC);
...
CREATE TRIGGER [MI].[TrgAfterInsert_ResultsFinalWave_Segment] ON [Warehouse].[MI].[CampaignInternalResultsFinalWave_Segment]
AFTER INSERT
AS
