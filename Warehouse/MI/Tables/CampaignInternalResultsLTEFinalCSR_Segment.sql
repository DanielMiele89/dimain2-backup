CREATE TABLE [MI].[CampaignInternalResultsLTEFinalCSR_Segment] (
    ...
    CONSTRAINT [UNQ_CampaignResultsLTEInternalFinalCSR_Segment] UNIQUE NONCLUSTERED ([Effect] ASC, [ClientServicesRef] ASC, [SegmentID] ASC)
);
...
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignInternalResultsLTEFinalCSR_Segment]([ClientServicesRef] ASC);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignInternalResultsLTEFinalCSR_Segment]([SegmentID] ASC);
...
CREATE TRIGGER [MI].[TrgAfterInsert_InternalResultsLTEFinalCSR_Segment] ON [Warehouse].[MI].[CampaignInternalResultsLTEFinalCSR_Segment]
AFTER INSERT
AS
