CREATE TABLE [MI].[CampaignInternalResultsFinalWave_Segment_Incomplete] (
    ...
    CONSTRAINT [UNQ_CampaignResultsFinalWave_Segment_Incomplete] UNIQUE NONCLUSTERED ([ClientServicesRef] ASC, [StartDate] ASC, [SegmentID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignInternalResultsFinalWave_Segment_Incomplete]([SegmentID] ASC);


GO
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignInternalResultsFinalWave_Segment_Incomplete]([ClientServicesRef] ASC, [StartDate] ASC);
