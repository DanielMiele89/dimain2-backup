CREATE TABLE [MI].[CampaignInternalResultsFinalCSR_Segment] (
    ...
    CONSTRAINT [UNQ_CampaignResultsFinalCSR_Segment] UNIQUE NONCLUSTERED ([ClientServicesRef] ASC, [SegmentID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignInternalResultsFinalCSR_Segment]([ClientServicesRef] ASC);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignInternalResultsFinalCSR_Segment]([SegmentID] ASC);
...
CREATE TRIGGER [MI].[TrgAfterInsert_ResultsFinalCSR_Segment] ON [Warehouse].[MI].[CampaignInternalResultsFinalCSR_Segment]
AFTER INSERT
AS
