CREATE TABLE [MI].[CampaignExternalResultsFinalCSR_BespokeCell_Incomplete] (
    ...
    CONSTRAINT [UNQ_CampaignResultsOutOfProgrammeFinalCSR_BespokeCell_Incomplete] UNIQUE NONCLUSTERED ([ClientServicesRef] ASC, [Cell] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignExternalResultsFinalCSR_BespokeCell_Incomplete]([Cell] ASC);


GO
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignExternalResultsFinalCSR_BespokeCell_Incomplete]([ClientServicesRef] ASC);
