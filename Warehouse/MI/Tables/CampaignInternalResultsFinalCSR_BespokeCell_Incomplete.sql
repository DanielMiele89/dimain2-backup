CREATE TABLE [MI].[CampaignInternalResultsFinalCSR_BespokeCell_Incomplete] (
    ...
    CONSTRAINT [UNQ_CampaignResultsFinalCSR_BespokeCell_Incomplete] UNIQUE NONCLUSTERED ([ClientServicesRef] ASC, [Cell] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignInternalResultsFinalCSR_BespokeCell_Incomplete]([ClientServicesRef] ASC);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignInternalResultsFinalCSR_BespokeCell_Incomplete]([Cell] ASC);
