CREATE TABLE [MI].[CampaignExternalResultsFinalWave_SuperSegment_Incomplete] (
    ...
    CONSTRAINT [UNQ_CampaignResultsOutofProgrammeFinalWave_SuperSegment_Incomplete] UNIQUE NONCLUSTERED ([ClientServicesRef] ASC, [StartDate] ASC, [SegmentID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignExternalResultsFinalWave_SuperSegment_Incomplete]([ClientServicesRef] ASC, [StartDate] ASC);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignExternalResultsFinalWave_SuperSegment_Incomplete]([SegmentID] ASC);
