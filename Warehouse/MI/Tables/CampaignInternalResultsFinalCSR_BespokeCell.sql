CREATE TABLE [MI].[CampaignInternalResultsFinalCSR_BespokeCell] (
    ...
    CONSTRAINT [UNQ_CampaignResultsFinalCSR_BespokeCell] UNIQUE NONCLUSTERED ([ClientServicesRef] ASC, [Cell] ASC)
);
...
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignInternalResultsFinalCSR_BespokeCell]([ClientServicesRef] ASC);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignInternalResultsFinalCSR_BespokeCell]([Cell] ASC);
...
CREATE TRIGGER [MI].[TrgAfterInsert_ResultsFinalCSR_BespokeCell] ON [Warehouse].[MI].[CampaignInternalResultsFinalCSR_BespokeCell]
AFTER INSERT
AS
