CREATE TABLE [MI].[CampaignInternalResultsLTEFinalWave_SuperSegment] (
    ...
    CONSTRAINT [UNQ_CampaignInternalResultsLTEFinalWave_SuperSegment] UNIQUE NONCLUSTERED ([Effect] ASC, [ClientServicesRef] ASC, [StartDate] ASC, [SegmentID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignInternalResultsLTEFinalWave_SuperSegment]([ClientServicesRef] ASC, [StartDate] ASC);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignInternalResultsLTEFinalWave_SuperSegment]([SegmentID] ASC);
