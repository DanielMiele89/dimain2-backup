CREATE TABLE [MI].[CampaignExternalResultsLTEFinalCSR] (
    ...
    CONSTRAINT [UNQ_CampaignResultsLTEOutOfProgrammeFinalCSR] UNIQUE NONCLUSTERED ([Effect] ASC, [ClientServicesRef] ASC)
);
...
CREATE TRIGGER [MI].[TrgAfterInsert_ExternalResultsLTEFinalCSR] ON [Warehouse].[MI].[CampaignExternalResultsLTEFinalCSR]
AFTER INSERT
AS
