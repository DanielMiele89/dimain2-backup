CREATE TABLE [MI].[CampaignExternalResultsFinalWave_SuperSegment] (
    ...
    CONSTRAINT [UNQ_CampaignResultsOutofProgrammeFinalWave_SuperSegment] UNIQUE NONCLUSTERED ([ClientServicesRef] ASC, [StartDate] ASC, [SegmentID] ASC)
);
...
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignExternalResultsFinalWave_SuperSegment]([ClientServicesRef] ASC, [StartDate] ASC);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignExternalResultsFinalWave_SuperSegment]([SegmentID] ASC);
...
CREATE TRIGGER [MI].[TrgAfterInsert_ExternalResultsFinalWave_SuperSegment] ON [Warehouse].[MI].[CampaignExternalResultsFinalWave_SuperSegment]
AFTER INSERT
AS
