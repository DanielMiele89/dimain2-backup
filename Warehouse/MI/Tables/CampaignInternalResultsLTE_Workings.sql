CREATE TABLE [MI].[CampaignInternalResultsLTE_Workings] (
    ...
    CONSTRAINT [UNQ_CampaignResultsLTE_Workings] UNIQUE NONCLUSTERED ([Effect] ASC, [ControlGroup] ASC, [SalesType] ASC, [CustomerUniverse] ASC, [ClientServicesRef] ASC, [StartDate] ASC, [Level] ASC, [SegmentID] ASC, [Cell] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignInternalResultsLTE_Workings]([Cell] ASC);


GO
CREATE NONCLUSTERED INDEX [IND_2]
    ON [MI].[CampaignInternalResultsLTE_Workings]([SegmentID] ASC);


GO
CREATE NONCLUSTERED INDEX [IND_1]
    ON [MI].[CampaignInternalResultsLTE_Workings]([StartDate] ASC);


GO
CREATE CLUSTERED INDEX [IND_C]
    ON [MI].[CampaignInternalResultsLTE_Workings]([ClientServicesRef] ASC);
