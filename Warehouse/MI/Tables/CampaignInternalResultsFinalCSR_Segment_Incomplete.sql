CREATE TABLE [MI].[CampaignInternalResultsFinalCSR_Segment_Incomplete] (
    ...
    CONSTRAINT [UNQ_CampaignResultsFinalCSR_Segment_Incomplete] UNIQUE NONCLUSTERED ([ClientServicesRef] ASC, [SegmentID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignInternalResultsFinalCSR_Segment_Incomplete]([SegmentID] ASC);


GO
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignInternalResultsFinalCSR_Segment_Incomplete]([ClientServicesRef] ASC);
