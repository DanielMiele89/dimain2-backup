CREATE TABLE [MI].[CampaignInternalResultsFinalCSR_SuperSegment_Incomplete] (
    ...
    CONSTRAINT [UNQ_CampaignResultsFinalCSR_SuperSegment_Incomplete] UNIQUE NONCLUSTERED ([ClientServicesRef] ASC, [SegmentID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IND]
    ON [MI].[CampaignInternalResultsFinalCSR_SuperSegment_Incomplete]([ClientServicesRef] ASC);


GO
CREATE NONCLUSTERED INDEX [IND_3]
    ON [MI].[CampaignInternalResultsFinalCSR_SuperSegment_Incomplete]([SegmentID] ASC);
