CREATE TABLE [MI].[EarnRedeemFinance_RBSFundedReportInfo_WG_Archive] (
    ...
    [BankID]                       TINYINT       NULL,
    [ArchiveDate]                  DATETIME      CONSTRAINT [DF_MI_EarnRedeemFinance_RBSFundedReportInfo_WG_Archive_ArchiveDate] DEFAULT (getdate()) NOT NULL,
    CONSTRAINT [PK_MI_EarnRedeemFinance_RBSFundedReportInfo_WG_Archive] PRIMARY KEY CLUSTERED ([ID] ASC)
);
