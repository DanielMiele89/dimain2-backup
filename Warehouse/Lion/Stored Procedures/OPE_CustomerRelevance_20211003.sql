...
CREATE PROCEDURE [Lion].[OPE_CustomerRelevance_20211003]
AS
BEGIN
...
GRANT VIEW DEFINITION
    ON OBJECT::[Lion].[OPE_CustomerRelevance_20211003] TO [New_PIIRemoved]
    AS [dbo];


GO
GRANT VIEW DEFINITION
    ON OBJECT::[Lion].[OPE_CustomerRelevance_20211003] TO [New_Insight]
    AS [dbo];
