...
CREATE PROCEDURE [Lion].[OPE_CustomerRelevance_20220317]
AS
...
EXEC master.dbo.oo_TimerMessagev2 'Start Lion.OPE_CustomerRelevance', @Time OUTPUT, @SSMS OUTPUT; 
	...
	*******************************************************************************************************************************************/
		...
		EXEC master.dbo.oo_TimerMessagev2 'Get all live partnerids and brandids', @Time OUTPUT, @SSMS OUTPUT; 
	...
	*******************************************************************************************************************************************/
		...
		EXEC master.dbo.oo_TimerMessagev2 'Obtain private customers', @Time OUTPUT, @SSMS OUTPUT; 
	...
	*******************************************************************************************************************************************/
		...
		***********************************************************************************************************************/
			...
			where
			CurrentlyActive = 1
			EXEC master.dbo.oo_TimerMessagev2 '3.1 Fetch Customers & their demographics', @Time OUTPUT, @SSMS OUTPUT;
	...
	*******************************************************************************************************************************************/
		...
		EXEC master.dbo.oo_TimerMessagev2 '4. Get customers, their heatmap groups and the premium customer flag', @Time OUTPUT, @SSMS OUTPUT;
	...
	*******************************************************************************************************************************************/
		...
		***********************************************************************************************************************/
			...
			EXEC master.dbo.oo_TimerMessagev2 '5.1. Fetch CCs', @Time OUTPUT, @SSMS OUTPUT;
		...
		***********************************************************************************************************************/
			...
			EXEC master.dbo.oo_TimerMessagev2 '5.2. Fetch Spenders', @Time OUTPUT, @SSMS OUTPUT;
		...
		***********************************************************************************************************************/
			...
			EXEC master.dbo.oo_TimerMessagev2 '5.3. Constructing the ranking list', @Time OUTPUT, @SSMS OUTPUT;
		...
		***********************************************************************************************************************/
			...
			group by
			hb.BrandID
			EXEC master.dbo.oo_TimerMessagev2 '5.4. Obtain overall ranking', @Time OUTPUT, @SSMS OUTPUT;
		...
		***********************************************************************************************************************/
			...
			EXEC master.dbo.oo_TimerMessagev2 '5.5. Obtain heatmap ranking', @Time OUTPUT, @SSMS OUTPUT;
		...
		***********************************************************************************************************************/
			...
			EXEC master.dbo.oo_TimerMessagev2 '5.6. Merge', @Time OUTPUT, @SSMS OUTPUT;
	...
	*******************************************************************************************************************************************/
		...
		***********************************************************************************************************************/
			...
			EXEC master.dbo.oo_TimerMessagev2 '6.1. Fetch CCs', @Time OUTPUT, @SSMS OUTPUT;
		...
		***********************************************************************************************************************/
			...
			EXEC master.dbo.oo_TimerMessagev2 '6.2. Fetch Spenders', @Time OUTPUT, @SSMS OUTPUT;
		...
		***********************************************************************************************************************/
			...
			group by
			c.HeatmapID, b.BrandID
			EXEC master.dbo.oo_TimerMessagev2 '6.3. Constructing the ranking list', @Time OUTPUT, @SSMS OUTPUT;
		...
		***********************************************************************************************************************/
			...
			group by
			hb.BrandID
			EXEC master.dbo.oo_TimerMessagev2 '6.4. Obtain overall ranking', @Time OUTPUT, @SSMS OUTPUT;
		...
		***********************************************************************************************************************/
			...
			group by
			hb.BrandID, hb.HeatmapID
			EXEC master.dbo.oo_TimerMessagev2 '6.5. Obtain heatmap ranking', @Time OUTPUT, @SSMS OUTPUT;
		...
		***********************************************************************************************************************/
			...
			EXEC master.dbo.oo_TimerMessagev2 '6.6. Merge', @Time OUTPUT, @SSMS OUTPUT;
	...
	*******************************************************************************************************************************************/
		...
		EXEC master.dbo.oo_TimerMessagev2 '7. Fetch spenders', @Time OUTPUT, @SSMS OUTPUT;
	...
	*******************************************************************************************************************************************/
		...
		EXEC master.dbo.oo_TimerMessagev2 '8. Create propensity table', @Time OUTPUT, @SSMS OUTPUT;
	...
	*******************************************************************************************************************************************/
		...
		EXEC master.dbo.oo_TimerMessagev2 '9. Bespoke module', @Time OUTPUT, @SSMS OUTPUT;
	...
	*******************************************************************************************************************************************/
		...
		SET @Query = '	INSERT INTO [Lion].[OPE_CustomerRanking] (PartnerID, FanID, CompositeID, Segment, CustomerRanking)
						SELECT cb.PartnerID
							 , cb.FanID
							 , cb.CompositeID
							 , cb.Type AS Segment
		...
		CREATE NONCLUSTERED COLUMNSTORE INDEX [CSX_All] ON [Lion].[OPE_CustomerRanking] ([PartnerID]
																						...
																						,[CompositeID]
																						,[CustomerRanking])
		EXEC master.dbo.oo_TimerMessagev2 '10. Insert to final table', @Time OUTPUT, @SSMS OUTPUT;
