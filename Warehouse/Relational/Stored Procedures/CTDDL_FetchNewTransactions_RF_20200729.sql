...
CREATE PROCEDURE [Relational].[CTDDL_FetchNewTransactions_RF_20200729]
AS
BEGIN
	...
	*******************************************************************************************************************************************/
		...
		/***********************************************************************************************************************
			6.1. Select next FileID to extract
		***********************************************************************************************************************/
		...
		/***********************************************************************************************************************
			6.2. Fetch all transactions for the looped FileID
		***********************************************************************************************************************/
		...
		***********************************************************************************************************************/
		...
		/***********************************************************************************************************************
			6.4. Find all new ConsumerCombinations
		***********************************************************************************************************************/
					
			/*******************************************************************************************************************
				6.4.1. Fetch all unique OIN, Narrative combinations from the fetched transactions
			*******************************************************************************************************************/
			...
			/*******************************************************************************************************************
				6.4.2. Fetch all Voca File entries
			*******************************************************************************************************************/
			...
			/*******************************************************************************************************************
				6.4.3. Fetch all unique OIN, Narrative combinations from the fetched transactions & Voca File
			*******************************************************************************************************************/
			...
			/*******************************************************************************************************************
				6.4.4. Insert new combinations to the ConumberCombination_DD table as unbranded
			*******************************************************************************************************************/
			...
			/*******************************************************************************************************************
				6.4.6. Fetch all the consumer combination IDs for each combination in the transaction file
			*******************************************************************************************************************/
		...
		/***********************************************************************************************************************
			6.5. Update the ConsumerCombinationIDs in the transaction file
		***********************************************************************************************************************/
		...
		/***********************************************************************************************************************
			6.6. Insert the entries into [Staging].[ConsumerTransaction_DD_Holding]
		***********************************************************************************************************************/
		...
		/***********************************************************************************************************************
			6.7. Update the #FileID table to show insert is completed
		***********************************************************************************************************************/
	...
	/*******************************************************************************************************************************************
		7. Fetch existing entries from [Relational].[ConsumerTransaction_DD] where the FanID can be backpopulated
	*******************************************************************************************************************************************/
		...
		/***********************************************************************************************************************
			7.1. Update accounts with only one customer
		***********************************************************************************************************************/
		...
		/***********************************************************************************************************************
			7.2. Update joint accounts with the first customer to join
		***********************************************************************************************************************/
	...
	/*******************************************************************************************************************************************
		8. Insert to [Relational].[ConsumerTransaction_DD]
	*******************************************************************************************************************************************/

		IF (SELECT COUNT(*) FROM [Staging].[ConsumerTransaction_DD_Holding]) > 0
			BEGIN
			...
			END	--	IF (SELECT COUNT(*) FROM [Staging].[ConsumerTransaction_DD_Holding]) > 0
	...
	/*******************************************************************************************************************************************
		9. Insert new transactions to [AWSFile].[ConsumerTransaction_DDForFile]
	*******************************************************************************************************************************************/
	...
	/*******************************************************************************************************************************************
		10. Insert new CCs to [Staging].[ConsumerCombination_DD_OINI]
	*******************************************************************************************************************************************/
	...
	/*******************************************************************************************************************************************
		11. Insert to [Relational].[ConsumerTransaction_DD_MyRewards] on Mondays
	*******************************************************************************************************************************************/

		IF (SELECT DATENAME(dw, GETDATE())) IN ('Monday')
			BEGIN

		/***********************************************************************************************************************
			11.1. Fetch all transactions 
		***********************************************************************************************************************/
		...
		/***********************************************************************************************************************
			11.2. Add all new transactions to [Relational].[ConsumerTransaction_DD_MyRewards]
		***********************************************************************************************************************/
			...
			END	--	IF (SELECT DATENAME(dw, GETDATE())) IN ('Monday')
