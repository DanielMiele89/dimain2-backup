CREATE PROCEDURE [Processing].[Execute_UploadDone]
(
...
BEGIN
	...
	SET @sql = 'break | aws s3 cp - "' + @S3Location + '/' + @FileName + '" --acl bucket-owner-full-control --profile trusted-analytics-insight-etl-role'
