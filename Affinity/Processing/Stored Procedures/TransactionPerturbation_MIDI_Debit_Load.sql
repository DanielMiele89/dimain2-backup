...
-- Description: Perturbates and loads the MyRewards MIDI Holding Debit Transactions
...
******************************************************************************/
CREATE PROCEDURE [Processing].[TransactionPerturbation_MIDI_Debit_Load](
...
BEGIN
	...
	(
	 ...
	 SELECT
	   ...
	   , @Prefix
	 FROM Processing.ConsumerTransactionHolding_MIDI_Debit ct
	...
	BEGIN TRAN
		...
		-- Perform transformations according to spec and insert
		...
		(
		 ...
		 JOIN Processing.ConsumerTransactionHolding_MIDI_Debit cthmd
