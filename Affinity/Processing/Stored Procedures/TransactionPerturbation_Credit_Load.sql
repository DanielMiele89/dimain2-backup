...
-- Description: Perturbates and loads the MyRewards Credit Card transactions
...
******************************************************************************/
CREATE PROCEDURE [Processing].[TransactionPerturbation_Credit_Load]  
(
...
BEGIN
	...
	SELECT
		...
		, @Prefix
	FROM Processing.ConsumerTransactionHolding_Credit ct 
