...
******************************************************************************/
CREATE PROCEDURE [Processing].[PackageLog_Insert] (
...
BEGIN
	...
	BEGIN
		SELECT
			@RunID = NEXT VALUE FOR Processing.Package_Log_RunID
	...
	BEGIN
		...
		FROM Processing.Package_SourceType
	...
	-- Insert
	----------------------------------------------------------------------
	INSERT INTO Processing.Package_Log
	(
		RunID
	  , PackageID
	  , SourceID
