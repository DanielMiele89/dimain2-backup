...
create PROC [Processing].[SLABreachCheck_20211221] 
AS
SET NOCOUNT ON;
   /* Variables*/
...
BEGIN	
	EXEC msdb.dbo.sp_send_dbmail
			...
			@recipients = 'kevin.corbett@rewardinsight.com;hayden.reid@rewardinsight.com;dataoperations@rewardinsight.com',
			@body = @EmailMessageDOPS,
			@subject = 'Affinity SQL breach email';
END
...
BEGIN	
	EXEC msdb.dbo.sp_send_dbmail
			@profile_name = 'Administrator',
			@recipients = 'kevin.corbett@rewardinsight.com;zoe.taylor@rewardinsight.com;peter.west@rewardinsight.com;mark.murray@rewardinsight.com',
