CREATE PROCEDURE [Processing].[Execute_Uploader]
(
	@SourceFolder VARCHAR(MAX)
...
BEGIN
	...
	SET @sql = 'aws s3 cp "' + @SourceFolder + '" "' + @S3Location + '" --recursive --acl bucket-owner-full-control --profile trusted-analytics-insight-etl-role'
