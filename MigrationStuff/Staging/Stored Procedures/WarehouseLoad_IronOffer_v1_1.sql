...
-- Updates:		Amended to include table to pull through OfferIDs

-- ***************************************************************
CREATE PROCEDURE [Staging].[WarehouseLoad_IronOffer_v1_1]
...
SELECT	StoredProcedureName = 'WarehouseLoad_IronOffer_v1_1',
...
INNER JOIN #Clubs cl
	...
	AND cl.RowNo = @RowNo
LEFT OUTER JOIN Staging.IronOffer_to_Offer as a
	ON io.ID = a.IronOfferID
...
SET EndDate = GETDATE()
WHERE	StoredProcedureName = 'WarehouseLoad_IronOffer_v1_1' 
