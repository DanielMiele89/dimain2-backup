...
CREATE PROCEDURE WHB._PartitionMaintenance_PartitionInfo_Reload
AS
BEGIN

	TRUNCATE TABLE dbo.PartitionInfo

	INSERT INTO dbo.PartitionInfo
	(
		object_id
		, SchemaName
		, TableName
		, PartitionSchemeName
		, PartitionFilegroupName
		, PartitionFunctionName
		, PartitionBoundaryValue
		, PartitionKey
		, StartDate
		, EndDate
		, PartitionNumber
