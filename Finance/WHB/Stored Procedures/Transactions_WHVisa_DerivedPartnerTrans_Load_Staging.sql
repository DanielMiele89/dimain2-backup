CREATE PROCEDURE [WHB].[Transactions_WHVisa_DerivedPartnerTrans_Load_Staging]
		@RunID INT = NULL
...
BEGIN
	...
	DECLARE @CheckpointTable VARCHAR(30) = 'WH_Visa.' + @SourceTable
	...
	INTO #PartnerTrans
	from WH_Visa.Derived.PartnerTrans p
	JOIN WH_Visa.Derived.Customer c
		ON p.FanID = c.FanID
	JOIN WH_Visa.Derived.IronOffer o
