...
CREATE PROCEDURE [SamW].[ForecastTool_ForecastDetails_Import] (					@PublisherID VARCHAR(50)
																			,	@BrandID VARCHAR(50)
...
AS
	...
	DECLARE	@RetailerName VARCHAR(50)
		...
		INSERT INTO [SamW].[ForecastingBudgetTracking_Import] (	PublisherID
															,	BrandID
															,	RetailerName
															,	PublisherName
															,	Segment
...
GO
GRANT EXECUTE
    ON OBJECT::[SamW].[ForecastTool_ForecastDetails_Import] TO [ExcelQuery_DataOps]
    AS [SamW];
