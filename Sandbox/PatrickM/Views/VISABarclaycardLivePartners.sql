create view patrickm.VISABarclaycardLivePartners  as
...
FROM WH_Visa.[Segmentation].[OfferMemberAddition] --where  getdate() - startdate < 0
group by ironofferid, startdate, enddate
having count(*) >= 2000
) as a --all live offers this selection
left join WH_Visa.[Derived].[IronOffer] as b
