CREATE TABLE [Trans].[__ConsumerTransaction_shadow_Archived] (
    ...
    CONSTRAINT [PK_ConsumerTrans_shadow_Archived] PRIMARY KEY CLUSTERED ([FileID] ASC, [RowNum] ASC, [TranDate] ASC) WITH (FILLFACTOR = 95),
    CONSTRAINT [CheckTranDate_shadow_Archived] CHECK ([TranDate]>='20201101' AND [TranDate]<'20201201'),
