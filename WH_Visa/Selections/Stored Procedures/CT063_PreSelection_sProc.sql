...
BEGIN
	...
	IF OBJECT_ID('[WH_Visa].[Selections].[CT063_PreSelection]') IS NOT NULL DROP TABLE [WH_Visa].[Selections].[CT063_PreSelection]
	SELECT FanID
	INTO [WH_Visa].[Selections].[CT063_PreSelection]
	FROM #FB fb
