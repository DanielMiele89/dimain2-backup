...
IF OBJECT_ID('[WH_Visa].[Selections].[BHO004_PreSelection]') IS NOT NULL DROP TABLE [WH_Visa].[Selections].[BHO004_PreSelection]
SELECT	fb.FanID
INTO [WH_Visa].[Selections].[BHO004_PreSelection]
FROM #FB fb
