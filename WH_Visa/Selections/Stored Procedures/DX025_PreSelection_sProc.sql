...
IF OBJECT_ID('[WH_Visa].[Selections].[DX025_PreSelection]') IS NOT NULL DROP TABLE [WH_Visa].[Selections].[DX025_PreSelection]
SELECT	fb.FanID
INTO [WH_Visa].[Selections].[DX025_PreSelection]
FROM #FB_bc fb
WHERE EXISTS (	SELECT 1
				FROM Sandbox.RukanK.BC_currys_acquire sb
