...
IF OBJECT_ID('[WH_Visa].[Selections].[SIC010_PreSelection]') IS NOT NULL DROP TABLE [WH_Visa].[Selections].[SIC010_PreSelection]
SELECT	fb.FanID
INTO [WH_Visa].[Selections].[SIC010_PreSelection]
FROM #FB_bc fb
WHERE EXISTS (	SELECT 1
				FROM Sandbox.RukanK.BC_simply_cook sb
