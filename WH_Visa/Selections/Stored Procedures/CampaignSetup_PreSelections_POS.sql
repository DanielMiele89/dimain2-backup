...
BEGIN
	...
	--	DECLARE @EmailDate DATE = '2022-05-19'
			...
			WHILE @RunID <= @MaxRunID 
				BEGIN
					...
					SELECT @TableName = CASE
											WHEN LEN(MustBeIn_TableName1) < LEN(NotIn_TableName1) AND NotIn_TableName1 NOT LIKE '%dedupe%' THEN NotIn_TableName1
	...
	*******************************************************************************************************************************************/
		...
		***********************************************************************************************************************/
			...
			FROM [Derived].[IronOffer_Campaign_HTM] htm
