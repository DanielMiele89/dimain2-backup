...
BEGIN
	...
	-- shoppers - SOW - >= 33% & < 66%
	IF OBJECT_ID('Sandbox.samh.superdry_sow33_66_BC_25012021') IS NOT NULL DROP TABLE Sandbox.samh.superdry_sow33_66_BC_25012021
	SELECT	F.CINID, FanID
	INTO	Sandbox.samh.superdry_sow33_66_BC_25012021
	FROM	#shoppper_sow F
	...
	IF OBJECT_ID('[WH_Visa].[Selections].[SDY017_PreSelection]') IS NOT NULL DROP TABLE [WH_Visa].[Selections].[SDY017_PreSelection]
	SELECT FanID
	INTO [WH_Visa].[Selections].[SDY017_PreSelection]
	FROM Sandbox.samh.superdry_sow33_66_BC_25012021
