...
BEGIN
	...
	IF OBJECT_ID('Sandbox.rukank.Barclays_Morrisons_LoW_SoW_30112021') IS NOT NULL DROP TABLE Sandbox.rukank.Barclays_Morrisons_LoW_SoW_30112021
	SELECT	CINID
	INTO Sandbox.rukank.Barclays_Morrisons_LoW_SoW_30112021
	FROM	#Trans
