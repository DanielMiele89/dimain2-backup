...
GROUP BY CINID
	...
	IF OBJECT_ID('[WH_Visa].[Selections].[SDY020_PreSelection]') IS NOT NULL DROP TABLE [WH_Visa].[Selections].[SDY020_PreSelection]
	SELECT FanID
	INTO [WH_Visa].[Selections].[SDY020_PreSelection]
	FROM #FB fb
