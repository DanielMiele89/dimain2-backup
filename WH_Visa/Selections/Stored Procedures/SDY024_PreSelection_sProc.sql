...
BEGIN
	...
	IF OBJECT_ID('Sandbox.samh.superdryLapsedGroup3_BC_04022022') IS NOT NULL DROP TABLE Sandbox.samh.superdryLapsedGroup3_BC_04022022
	SELECT	CINID
	...
	IF OBJECT_ID('[WH_Visa].[Selections].[SDY024_PreSelection]') IS NOT NULL DROP TABLE [WH_Visa].[Selections].[SDY024_PreSelection]
	SELECT	FanID
	INTO [WH_Visa].[Selections].[SDY024_PreSelection]
	FROM #FB fb
