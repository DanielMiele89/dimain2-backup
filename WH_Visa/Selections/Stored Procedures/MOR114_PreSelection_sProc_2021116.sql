-- =============================================-- Author:  <Rory Francis>-- Create date: <2021-07-24>-- Description: < sProc to run preselection code per camapign >-- =============================================CREATE PROCEDURE [Selections].[MOR114_PreSelection_sProc_2021116]ASBEGIN
...
IF OBJECT_ID('Sandbox.rukank.Barclays_Morrisons_LoW_SoW_14102021') IS NOT NULL DROP TABLE Sandbox.rukank.Barclays_Morrisons_LoW_SoW_14102021
SELECT	CINID
INTO Sandbox.rukank.Barclays_Morrisons_LoW_SoW_14102021
FROM	#Trans
WHERE BrandShopper = 1
	  AND SoW < 0.60
	  AND Transactions >= 45
GROUP BY CINID
If Object_ID('WH_Visa.Selections.MOR114_PreSelection') Is Not Null Drop Table WH_Visa.Selections.MOR114_PreSelectionSelect FanIDInto WH_Visa.Selections.MOR114_PreSelectionFROM  #FB fbWHERE EXISTS (	SELECT 1				FROM Sandbox.rukank.Barclays_Morrisons_LoW_SoW_14102021 st				WHERE fb.CINID = st.CINID)END
