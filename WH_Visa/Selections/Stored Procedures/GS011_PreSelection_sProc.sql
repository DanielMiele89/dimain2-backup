...
GROUP BY CINID
	...
	IF OBJECT_ID('[WH_Visa].[Selections].[GS011_PreSelection]') IS NOT NULL DROP TABLE [WH_Visa].[Selections].[GS011_PreSelection]
	SELECT FanID
	INTO [WH_Visa].[Selections].[GS011_PreSelection]
	FROM #FB_VM fb
