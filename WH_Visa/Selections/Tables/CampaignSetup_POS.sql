CREATE TABLE [Selections].[CampaignSetup_POS] (
...
CREATE NONCLUSTERED INDEX [IX_EmailDate]
    ON [Selections].[CampaignSetup_POS]([EmailDate] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_OfferID]
    ON [Selections].[CampaignSetup_POS]([OfferID] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_StartDate_IncEmailDate]
    ON [Selections].[CampaignSetup_POS]([StartDate] ASC)
    INCLUDE([EmailDate]);
