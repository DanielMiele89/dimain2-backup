CREATE TABLE [Email].[__DailyData_PreviousDay_Archived] (
    [FanID]                   INT            NOT NULL,
    ...
    CONSTRAINT [PK_DailyData_PreviousDay] PRIMARY KEY CLUSTERED ([FanID] ASC)
);


GO
DENY SELECT
    ON OBJECT::[Email].[__DailyData_PreviousDay_Archived] TO [New_Insight]
    AS [New_DataOps];
