CREATE TABLE [dbo].[CBP_Credit_TransactionHistory] (
    [FileID]                                  INT           NOT NULL,
    [RowNum]                                  INT           NOT NULL,
    ...
    CONSTRAINT [PK_CBP_Credit_TransactionHistory] PRIMARY KEY CLUSTERED ([FileID] ASC, [RowNum] ASC) WITH (DATA_COMPRESSION = PAGE)
);


GO
GRANT INSERT
    ON OBJECT::[dbo].[CBP_Credit_TransactionHistory] TO [crtimport]
    AS [dbo];
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[CBP_Credit_TransactionHistory] TO [Beyers]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[CBP_Credit_TransactionHistory] TO [Matt]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[CBP_Credit_TransactionHistory] TO [Insight]
    AS [dbo];
