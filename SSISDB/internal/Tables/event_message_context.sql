...
CREATE NONCLUSTERED INDEX [IX_EventMessageContext_Operation_id]
    ...
    INCLUDE([context_id]) WITH (FILLFACTOR = 90);


GO
CREATE NONCLUSTERED INDEX [IX_EventMessageContext_EventMessageId]
    ON [internal].[event_message_context]([event_message_id] ASC) WITH (FILLFACTOR = 90);
