...
GO
CREATE NONCLUSTERED INDEX [IX_ExecutionPropertyOverrideValues_ExecutionId]
    ON [internal].[execution_property_override_values]([execution_id] ASC) WITH (FILLFACTOR = 90);
