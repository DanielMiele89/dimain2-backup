CREATE TABLE [internal].[executable_statistics] (
    ...
    CONSTRAINT [FK_ExecutableStatistics_ExecutableId_Executables] FOREIGN KEY ([executable_id]) REFERENCES [internal].[executables] ([executable_id]),
...
CREATE NONCLUSTERED INDEX [IX_ExecutableStatistics_Execution_id]
    ...
    INCLUDE([statistics_id]) WITH (FILLFACTOR = 90);
