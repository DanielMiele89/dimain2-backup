CREATE TABLE [Email].[DailyData_WithSlots] (
    ...
    CONSTRAINT [PK_DailyData_WithOfferSlot] PRIMARY KEY CLUSTERED ([FanID] ASC)
);
...
GO
DENY SELECT
    ON OBJECT::[Email].[DailyData_WithSlots] TO [New_Insight]
    AS [dbo];
