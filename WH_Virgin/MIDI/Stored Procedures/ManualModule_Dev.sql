...
*******************************************************************************************************************************************/
	...
	INSERT INTO [MIDI].[CTLoad_MIDINewCombo_Dev] (ID, MID, LocationCountry, MCCID, IsUKSpend, MatchType, MatchCount, BrandProbability, OriginalBrand_FirstMostCommonMCCID, OriginalBrand_SecondMostCommonMCCID, OriginalBrand_ThirdMostCommonMCCID, DoMCCsMatch, OriginalBrandID, UpdatedBrandID, Narrative_Cleaned, OriginalNarrative, UpdatedNarrative, IsHighVariance, NarrativeCount, NarrativeCount_PartialLeft, NarrativeCount_PartialRight, BrandCount)
	SELECT	*
...
*******************************************************************************************************************************************/
	...
	***********************************************************************************************************************/
		...
		INSERT INTO [MIDI].[CTLoad_MIDINewCombo_PossibleBrands_Dev] (	ComboID
																,	SuggestedBrandID
																,	MatchTypeID)
		SELECT	DISTINCT 
				mnc.ID
