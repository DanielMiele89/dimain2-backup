...
create PROCEDURE [WHB].[__IronOfferPartnerTrans_IronOfferMembers_DailySmallLoad_V2_Archived]
...
BEGIN TRY
	...
	Begin
		...
		Declare @Yesterday Date = DateAdd(Day, -1 , GetDate())<br>
			  , @Today DATE = GETDATE()<br>

		Select @Yesterday<br>
			 , @Today<br><br>

		Exec warehouse.Staging.WarehouseLoad_IronOfferMembers_DailyBulkLoad_V3 @Yesterday, @Today <br><br></b></i>
