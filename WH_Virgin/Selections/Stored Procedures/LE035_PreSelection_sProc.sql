...
IF OBJECT_ID('[WH_Virgin].[Selections].[LE035_PreSelection]') IS NOT NULL DROP TABLE [WH_Virgin].[Selections].[LE035_PreSelection]
SELECT	fb.FanID
INTO [WH_Virgin].[Selections].[LE035_PreSelection]
FROM #FB fb
