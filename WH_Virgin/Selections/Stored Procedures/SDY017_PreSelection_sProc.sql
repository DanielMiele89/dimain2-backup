...
CREATE PROCEDURE [Selections].[SDY017_PreSelection_sProc]
AS
BEGIN
	...
	-- shoppers - SOW - >= 33% & < 66%
	IF OBJECT_ID('Sandbox.samh.superdry_sow33_66_VM_25012021') IS NOT NULL DROP TABLE Sandbox.samh.superdry_sow33_66_VM_25012021
	SELECT	F.CINID, [F].[FanID]
	INTO	Sandbox.samh.superdry_sow33_66_VM_25012021
	FROM	#shoppper_sow F
	...
	IF OBJECT_ID('[WH_Virgin].[Selections].[SDY017_PreSelection]') IS NOT NULL DROP TABLE [WH_Virgin].[Selections].[SDY017_PreSelection]
	SELECT [Sandbox].[samh].[superdry_sow33_66_VM_25012021].[FanID]
	INTO [WH_Virgin].[Selections].[SDY017_PreSelection]
	FROM Sandbox.samh.superdry_sow33_66_VM_25012021
