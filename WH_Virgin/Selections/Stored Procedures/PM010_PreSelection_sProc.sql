...
CREATE PROCEDURE [Selections].[PM010_PreSelection_sProc]
AS
BEGIN
...
SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED
	...
	*******************************************************************************************************************************************/
		...
		***********************************************************************************************************************/
			...
			INNER JOIN WH_Virgin.derived.CINList cl WITH (NOLOCK)
				ON cu.SourceUID = cl.CIN
			WHERE cu.CurrentlyActive = 1
...
IF OBJECT_ID('[WH_Virgin].[Selections].[PM010_PreSelection]') IS NOT NULL DROP TABLE [WH_Virgin].[Selections].[PM010_PreSelection]
SELECT	FanID
INTO [WH_Virgin].[Selections].[PM010_PreSelection]
