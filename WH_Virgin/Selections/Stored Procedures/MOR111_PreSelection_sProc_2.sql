...
GROUP BY F.CINID
If Object_ID('WH_Virgin.Selections.MOR111_PreSelection_2') Is Not Null Drop Table WH_Virgin.Selections.MOR111_PreSelection_2Select [fb].[FanID]Into WH_Virgin.Selections.MOR111_PreSelection_2FROM  #FB fbWHERE EXISTS (	SELECT 1				FROM Sandbox.rukank.Morrisons_LoW_SoW_17082021 st				WHERE fb.CINID = #FB.[st].CINID)END
