...
FROM	#Trans 
GROUP BY CINIDIf Object_ID('WH_Virgin.Selections.FFX007_PreSelection') Is Not Null Drop Table WH_Virgin.Selections.FFX007_PreSelectionSelect FanIDInto WH_Virgin.Selections.FFX007_PreSelectionFROM #FB fbWHERE EXISTS (	SELECT 1				FROM Sandbox.SamH.VM_FFXTools_CompSteal06072021 cs				WHERE fb.CINID = cs.CINID)END