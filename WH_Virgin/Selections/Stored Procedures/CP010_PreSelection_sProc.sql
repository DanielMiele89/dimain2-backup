...
AND 1 = 2If Object_ID('WH_Virgin.Selections.CP010_PreSelection') Is Not Null Drop Table WH_Virgin.Selections.CP010_PreSelectionSelect [fb].[FANID]Into WH_Virgin.Selections.CP010_PreSelectionFROM #FB fbWHERE EXISTS (	SELECT 1				FROM Derived.Customer cu				INNER JOIN Derived.CINList cl					ON cu.SourceUID = cl.CIN				WHERE fb.CINID = cl.CINID)END