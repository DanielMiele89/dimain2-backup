...
IF OBJECT_ID('[WH_Virgin].[Selections].[CT059_PreSelection]') IS NOT NULL DROP TABLE [WH_Virgin].[Selections].[CT059_PreSelection]
SELECT	fb.FanID
INTO [WH_Virgin].[Selections].[CT059_PreSelection]
FROM #FB fb
WHERE EXISTS (	SELECT 1
				FROM Sandbox.SamH.VM_CharlesTyrwhitt_CS_210921 sb
