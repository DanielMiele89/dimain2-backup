CREATE PROCEDURE [Selections].[BHO004_PreSelection_sProc]
AS
BEGIN
...
IF OBJECT_ID('[WH_Virgin].[Selections].[BHO004_PreSelection]') IS NOT NULL DROP TABLE [WH_Virgin].[Selections].[BHO004_PreSelection]
SELECT	fb.FanID
INTO [WH_Virgin].[Selections].[BHO004_PreSelection]
FROM #FB fb
