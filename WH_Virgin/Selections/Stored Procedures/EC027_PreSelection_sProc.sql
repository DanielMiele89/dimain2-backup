...
WHERE	[WH_Virgin].[trans].[ConsumerCombination].[BrandID] IN (2765,1597,27,673,1547,1550,1548,1549,2684,1768,1767,2852,2624,1528)			-- Competitors: Enterprise Car Club, Rentalcars.com, Avis, Hertz, Sixt Car Rental, Budget Rent-a-car, Thrifty Car Rental, 
