CREATE PROCEDURE [Selections].[LE031_PreSelection_sProc]
AS
BEGIN
...
IF OBJECT_ID('[WH_Virgin].[Selections].[LE031_PreSelection]') IS NOT NULL DROP TABLE [WH_Virgin].[Selections].[LE031_PreSelection]
SELECT	fb.FanID
INTO [WH_Virgin].[Selections].[LE031_PreSelection]
FROM #FB fb
