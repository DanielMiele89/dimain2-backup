...
SELECT	CC.BrandID	,[WH_Virgin].[trans].[ConsumerCombination].[ConsumerCombinationID]
INTO	#CC
...
-- shoppers - SOW - < 30%
IF OBJECT_ID('Sandbox.GunayS.VC_BAU__LowSoW30_excl_LunchtimeSpenders_07042022') IS NOT NULL DROP TABLE Sandbox.GunayS.VC_BAU__LowSoW30_excl_LunchtimeSpenders_07042022		
SELECT	F.CINID
INTO	Sandbox.GunayS.VC_BAU__LowSoW30_excl_LunchtimeSpenders_07042022
FROM	#shoppper_sow F
...
WHERE EXISTS (	SELECT 1
				FROM Sandbox.GunayS.VC_BAU__LowSoW30_excl_LunchtimeSpenders_07042022 cs
...
If Object_ID('WH_Virgin.Selections.CTA030_PreSelection') Is Not Null Drop Table WH_Virgin.Selections.CTA030_PreSelection
Select *
Into WH_Virgin.Selections.CTA030_PreSelection
