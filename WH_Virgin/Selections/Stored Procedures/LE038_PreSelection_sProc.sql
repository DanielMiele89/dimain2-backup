...
IF OBJECT_ID('[WH_Virgin].[Selections].[LE038_PreSelection]') IS NOT NULL DROP TABLE [WH_Virgin].[Selections].[LE038_PreSelection]
SELECT	fb.FanID
INTO [WH_Virgin].[Selections].[LE038_PreSelection]
FROM #FB fb
