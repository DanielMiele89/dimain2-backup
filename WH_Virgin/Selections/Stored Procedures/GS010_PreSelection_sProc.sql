...
GROUP BY #FB_VM.[CINID]
	...
	IF OBJECT_ID('[WH_Virgin].[Selections].[GS010_PreSelection]') IS NOT NULL DROP TABLE [WH_Virgin].[Selections].[GS010_PreSelection]
	SELECT [fb].[FanID]
	INTO [WH_Virgin].[Selections].[GS010_PreSelection]
	FROM #FB_VM fb
