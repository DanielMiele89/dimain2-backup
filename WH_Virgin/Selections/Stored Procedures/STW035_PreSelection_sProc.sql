...
on	cl.CINID = b.CINID
	...
	AND EndDate IS NULL
	AND ShopperSegmentTypeID IN(7, 8)If Object_ID('WH_Virgin.Selections.STW035_PreSelection') Is Not Null Drop Table WH_Virgin.Selections.STW035_PreSelectionSelect FanIDInto WH_Virgin.Selections.STW035_PreSelectionFROM  sandbox.vernon.VM_STWC_single_trans_150420END