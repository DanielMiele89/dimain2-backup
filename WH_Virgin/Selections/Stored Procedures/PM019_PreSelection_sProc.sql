...
IF OBJECT_ID('[WH_Virgin].[Selections].[PM019_PreSelection]') IS NOT NULL DROP TABLE [WH_Virgin].[Selections].[PM019_PreSelection]
SELECT	FanID
INTO [WH_Virgin].[Selections].[PM019_PreSelection]
