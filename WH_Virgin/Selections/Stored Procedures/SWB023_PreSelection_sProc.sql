...
IF OBJECT_ID('[WH_Virgin].[Selections].[SWB023_PreSelection]') IS NOT NULL DROP TABLE [WH_Virgin].[Selections].[SWB023_PreSelection]   
SELECT fb.FanID
INTO [WH_Virgin].[Selections].[SWB023_PreSelection]   
FROM #FB_VM fb
