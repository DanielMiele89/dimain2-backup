...
-- =======================================================================================================================
CREATE PROCEDURE [dbo].[MemberOffer_GatherClubData]
 @ClubID INT
...
BEGIN
	...
	inner join SLC_Repl.dbo.IronOfferMember iom on iom.CompositeID = f.compositeid and iom.IronOfferID = io.ID
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[MemberOffer_GatherClubData] TO [GAS]
    AS [dbo];
