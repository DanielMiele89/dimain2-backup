...
BEGIN
	CREATE INDEX [sn_Stuff01] ON [$(dacpac_SLC_Snapshot)].[dbo].[IronOfferMember] ([ImportDate], [CompositeID]) INCLUDE ([IronOfferID], [StartDate], [EndDate], [IsControl]) WITH (DATA_COMPRESSION = PAGE, SORT_IN_TEMPDB = ON, FILLFACTOR = 80)  ON [SLC_REPL_FastIndexes]
END
